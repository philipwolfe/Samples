...
namespace Microsoft.Samples.WinForms.Cs.Grid.Data {
    ...
    public class CustomersDataSet : DataSet {
        ...
        private Order_Details tableOrder_Details;
        private DataRelation relationCustomersOrders;
        private DataRelation relationOrdersOrder_Details;
        ...
        [System.ComponentModel.PersistContentsAttribute(true)]
        public virtual Order_Details Order_Details {
            get {
        ...
        private void InitClass() {
            ...
            this.tableOrder_Details = new Order_Details("Order_Details");
            ...
            this.Order_Details.Constraints.Add(new System.Data.ForeignKeyConstraint("OrdersOrder_Details", new System.Data.DataColumn[] {this.tableOrders.OrderIDColumn}, new System.Data.DataColumn[] {this.tableOrder_Details.OrderIDColumn}));
            ...
            this.relationOrdersOrder_Details = new DataRelation("OrdersOrder_Details", new System.Data.DataColumn[] {this.tableOrders.OrderIDColumn}, new System.Data.DataColumn[] {this.tableOrder_Details.OrderIDColumn}, false);
        ...
        protected override void OnRemoveRelation(DataRelation relation) {
            if (((((relation) == (this.relationOrdersOrder_Details))) || (((relation) == (this.relationCustomersOrders))))) {
        ...
        public override void ResetTables() {
            for (int i = 0; ((i) < (this.Tables.Count)); i = ((i) + (1))) {
                if (((((this.Tables[i]) == (this.tableOrder_Details))) || (((((this.Tables[i]) == (this.tableOrders))) || (((this.Tables[i]) == (this.tableCustomers))))))) {
                }
                else {
        ...
        public override void ResetRelations() {
            for (int i = 0; ((i) < (this.Relations.Count)); i = ((i) + (1))) {
                if (((((this.Relations[i]) == (this.relationOrdersOrder_Details))) || (((this.Relations[i]) == (this.relationCustomersOrders))))) {
                }
                else {
        ...
        protected override void OnRemoveTable(DataTable table) {
            if (((((table) == (this.tableOrder_Details))) || (((((table) == (this.tableOrders))) || (((table) == (this.tableCustomers))))))) {
                throw new ArgumentException("Can't remove relation since it it built in to this dataSet");
            }
        }
    ...
    public class Order_Details : DataTable, System.Collections.ICollection {
        private int columnCount;
        private int constraintCount;
        private Order_Details_OrderID columnOrderID;
        private Order_Details_ProductID columnProductID;
        private Order_Details_UnitPrice columnUnitPrice;
        private Order_Details_Quantity columnQuantity;
        private Order_Details_Discount columnDiscount;
        public Order_DetailsRowChangeEventHandler Order_DetailsRowChanged;
        public Order_DetailsRowChangeEventHandler Order_DetailsRowChanging;
        public DataColumnChangeEventHandler OrderIDColumnChanging;
        public DataColumnChangeEventHandler ProductIDColumnChanging;
        public DataColumnChangeEventHandler UnitPriceColumnChanging;
        public DataColumnChangeEventHandler QuantityColumnChanging;
        public DataColumnChangeEventHandler DiscountColumnChanging;
        
        public Order_Details(string name) : 
                base(name) {
            this.InitClass();
        }
        ...
        public virtual Order_Details_OrderID OrderIDColumn {
            get {
                return this.columnOrderID;
            }
        }
        public virtual Order_Details_ProductID ProductIDColumn {
            get {
                return this.columnProductID;
            }
        }
        public virtual Order_Details_UnitPrice UnitPriceColumn {
            get {
                return this.columnUnitPrice;
            }
        }
        public virtual Order_Details_Quantity QuantityColumn {
            get {
                return this.columnQuantity;
            }
        }
        public virtual Order_Details_Discount DiscountColumn {
            get {
                return this.columnDiscount;
            }
        }
        public virtual Order_DetailsRow this[int index] {
            get {
                return (Order_DetailsRow)(this.Rows[index]);
            }
        }
        
        public virtual void AddOrder_DetailsRow(Order_DetailsRow rowOrder_DetailsRow) {
            this.Rows.Add(rowOrder_DetailsRow);
        }
        public virtual Order_DetailsRow AddOrder_DetailsRow(OrdersRow parentOrdersRowByOrdersOrder_Details, int columnProductID, System.Decimal columnUnitPrice, short columnQuantity, System.Single columnDiscount) {
            Order_DetailsRow rowOrder_DetailsRow;
            rowOrder_DetailsRow = (Order_DetailsRow)(this.NewRow());
            rowOrder_DetailsRow.ItemArray = new Object[] {parentOrdersRowByOrdersOrder_Details.OrderID,
                    columnProductID,
                    columnUnitPrice,
                    columnQuantity,
                    columnDiscount};
        ...
        public virtual Order_DetailsRow FindByOrderIDProductID(int columnOrderID, int columnProductID) {
            return (Order_DetailsRow)(this.Rows.Find(new Object[] {columnOrderID,
                        columnProductID}));
        }
        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator() {
            return this.Rows.All.GetEnumerator();
        ...
        private void InitClass() {
            this.columnCount = 5;
            this.constraintCount = 2;
            this.columnOrderID = new Order_Details_OrderID();
            this.Columns.Add(this.columnOrderID);
            this.columnProductID = new Order_Details_ProductID();
            this.Columns.Add(this.columnProductID);
            this.columnUnitPrice = new Order_Details_UnitPrice();
            this.Columns.Add(this.columnUnitPrice);
            this.columnQuantity = new Order_Details_Quantity();
            this.Columns.Add(this.columnQuantity);
            this.columnDiscount = new Order_Details_Discount();
            this.Columns.Add(this.columnDiscount);
            this.PrimaryKey = new System.Data.DataColumn[] {this.columnOrderID,
                    this.columnProductID};
        }
        public virtual Order_DetailsRow NewOrder_DetailsRow() {
        ...
        protected override void OnRemoveColumn(DataColumn column) {
            if (((((((((((column) == (this.columnOrderID))) || (((column) == (this.columnProductID))))) || (((column) == (this.columnUnitPrice))))) || (((column) == (this.columnQuantity))))) || (((column) == (this.columnDiscount))))) {
                throw new ArgumentException("Can't remove column since it it built in to this dataSet");
            }
        }
        protected override void OnRowChanged(DataRowChangeEventArgs e) {
        ...
        protected virtual void OnProductIDColumnChanging(DataColumnChangeEventArgs e) {
            if (((this.ProductIDColumnChanging) != (null))) {
                this.ProductIDColumnChanging(this, e);
            }
        }
        protected virtual void OnUnitPriceColumnChanging(DataColumnChangeEventArgs e) {
            if (((this.UnitPriceColumnChanging) != (null))) {
                this.UnitPriceColumnChanging(this, e);
            }
        }
        protected virtual void OnQuantityColumnChanging(DataColumnChangeEventArgs e) {
            if (((this.QuantityColumnChanging) != (null))) {
                this.QuantityColumnChanging(this, e);
            }
        }
        protected virtual void OnDiscountColumnChanging(DataColumnChangeEventArgs e) {
            if (((this.DiscountColumnChanging) != (null))) {
                this.DiscountColumnChanging(this, e);
            }
        }
        protected override void OnColumnChanging(DataColumnChangeEventArgs e) {
            base.OnColumnChanging(e);
            if (((e.Column) == (this.columnOrderID))) {
                ...
                if (((e.Column) == (this.columnProductID))) {
                    this.OnProductIDColumnChanging(e);
                }
                else {
                    if (((e.Column) == (this.columnUnitPrice))) {
                        this.OnUnitPriceColumnChanging(e);
                    }
                    else {
                        if (((e.Column) == (this.columnQuantity))) {
                            this.OnQuantityColumnChanging(e);
                        }
                        else {
                            if (((e.Column) == (this.columnDiscount))) {
                                this.OnDiscountColumnChanging(e);
                            }
                        }
                    }
                }
        ...
        public virtual void RemoveOrder_DetailsRow(Order_DetailsRow rowOrder_DetailsRow) {
            this.Rows.Remove(rowOrder_DetailsRow);
        }
        public override bool ShouldPersistPrimaryKey() {
            return false;
        }
        ...
        public override void ResetColumns() {
            for (int i = 0; ((i) < (this.Columns.Count)); i = ((i) + (1))) {
                if (((((this.Columns[i]) == (this.columnDiscount))) || (((((this.Columns[i]) == (this.columnQuantity))) || (((((this.Columns[i]) == (this.columnUnitPrice))) || (((((this.Columns[i]) == (this.columnProductID))) || (((this.Columns[i]) == (this.columnOrderID))))))))))) {
                }
                else {
                    this.Columns.Remove(this.Columns[i]);
                }
    ...
    public class Order_Details_OrderID : System.Data.DataColumn {
        public Order_Details_OrderID() : 
                base("OrderID", typeof(int)) {
            this.InitClass();
        }
    ...
    public class Order_Details_ProductID : System.Data.DataColumn {
        public Order_Details_ProductID() : 
                base("ProductID", typeof(int)) {
            this.InitClass();
        }
    ...
    public class Order_Details_UnitPrice : System.Data.DataColumn {
        public Order_Details_UnitPrice() : 
                base("UnitPrice", typeof(System.Decimal)) {
            this.InitClass();
        }
    ...
    public class Order_Details_Quantity : System.Data.DataColumn {
        public Order_Details_Quantity() : 
                base("Quantity", typeof(short)) {
            this.InitClass();
        }
    ...
    public class Order_Details_Discount : System.Data.DataColumn {
        public Order_Details_Discount() : 
                base("Discount", typeof(System.Single)) {
            this.InitClass();
        }
    ...
    public class OrdersRow : DataRow {
        ...
        public virtual Order_DetailsRow[] Order_DetailsByOrdersOrder_Details {
            get {
                return (Order_DetailsRow[])(this.GetChildRows(this.Table.ChildRelations["OrdersOrder_Details"]));
            }
        }
    ...
    public class Order_DetailsRow : DataRow {
        ...
        public Order_DetailsRow(DataRowBuilder rb) : 
                base(rb) {
            this.tableOrder_Details = (Order_Details)(this.Table);
        }
        ...
        public virtual OrdersRow OrdersRowByOrdersOrder_Details {
            get {
                return (OrdersRow)(this.GetParentRow(this.Table.ParentRelations["OrdersOrder_Details"]));
            }
            set {
                this.Table.ParentRelations["OrdersOrder_Details"].SetParentRow(this, value);
            }
        }
    ...
    public class Order_DetailsRowChangeEvent : EventArgs {
        private Order_DetailsRow rowOrder_DetailsRow;
        private System.Data.DataRowAction actionValue;
        
        public Order_DetailsRowChangeEvent(Order_DetailsRow rowOrder_DetailsRowArg, DataRowAction actionArg) {
            this.rowOrder_DetailsRow = rowOrder_DetailsRowArg;
            this.actionValue = actionArg;
        }
        
        public virtual Order_DetailsRow Order_DetailsRow {
            get {
                return this.rowOrder_DetailsRow;
            }
        }
        public virtual DataRowAction Action {
            get {
