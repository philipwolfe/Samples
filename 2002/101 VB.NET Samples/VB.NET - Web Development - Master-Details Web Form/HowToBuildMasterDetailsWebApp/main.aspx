<%@ Page Language="vb" AutoEventWireup="false" Codebehind="main.aspx.vb" Inherits="HowToBuildMasterDetailsWebApp.Main"%>
	...
	<body>
		<form id="frmMain" method="post" runat="server">
			...
			<TABLE id="Table1" width="100%" border="0">
				<TR>
					<TD valign="top"><asp:datagrid id="grdCustomers" runat="server" AllowSorting="True" AutoGenerateColumns="False" AllowPaging="True">
				...
				<TR>
					<TD class="details" valign="top" colSpan="2"><asp:datagrid id="grdOrderDetails" runat="server" AutoGenerateColumns="False" AllowPaging="False" Visible="False">
							<SelectedItemStyle CssClass="DataGrid_SelectedItemStyle" />
							<ItemStyle CssClass="DataGrid_ItemStyle" />
							<HeaderStyle CssClass="DataGrid_HeaderStyle" />
							<FooterStyle CssClass="DataGrid_FooterStyle" />
