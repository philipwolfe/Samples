<%@ Page Language="vb" AutoEventWireup="false" Codebehind="main.aspx.vb" Inherits="HowToDoDataGridPaging.Main"%>
	...
	<body>
		<form id="frmMain" method="post" runat="server">
			...
			<table align="center">
				...
				<tr>
					<td>
						<asp:datagrid id="grdOrderDetails" runat="server" AllowSorting="True" AutoGenerateColumns="False" AllowPaging="True" PageSize="20">
				...
				<tr>
					<td>
						...
						<asp:Panel id="pnlCustomPaging" Runat="server" CssClass="CustomPaging">
							...
							<P>
								<asp:LinkButton id="lbtnFirstPage" runat="server" Text="[First Page]" CommandName="First" OnCommand="NavigationLink_Click"></asp:LinkButton>
								<asp:LinkButton id="lbtnPreviousPage" runat="server" Text="[Previous Page]" CommandName="Prev" OnCommand="NavigationLink_Click"></asp:LinkButton>
								<asp:LinkButton id="lbtnNextPage" runat="server" Text="[Next Page]" CommandName="Next" OnCommand="NavigationLink_Click"></asp:LinkButton>
								<asp:LinkButton id="lbtnLastPage" runat="server" Text="[Last Page]" CommandName="Last" OnCommand="NavigationLink_Click"></asp:LinkButton></P>
						</asp:Panel>
					</td>
				</tr>
			</table>
