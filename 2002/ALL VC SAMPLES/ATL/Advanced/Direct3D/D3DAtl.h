...
class CDirect3D :
	...
	public CComCoClass<CDirect3D, &CLSID_CDirect3DCtl>,
	public IDispatchImpl<IDirect3DCtl, &IID_IDirect3DCtl, &LIBID_DIRECT3DLib, /*wMajor =*/ 1, /*wMinor =*/ 0>,
	public CComControl<CDirect3D>,
	public CTimer<CDirect3D, IDirect3DCtl, &IID_IDirect3DCtl>,
	public IPersistStreamInitImpl<CDirect3D>,
	public IPersistStorageImpl<CDirect3D>,
	public IQuickActivateImpl<CDirect3D>,
	public IProvideClassInfo2Impl<&CLSID_CDirect3DCtl, NULL, &LIBID_DIRECT3DLib>,
...
DECLARE_REGISTRY_RESOURCEID(IDR_Direct3D)
DECLARE_GET_CONTROLLING_UNKNOWN()

BEGIN_COM_MAP(CDirect3D)
	COM_INTERFACE_ENTRY(IDirect3DCtl)
...
public:
	...
	STDMETHOD(Start3D)()
	{
		...
		HRESULT hr = (HRESULT)m_p3DWindow->OnCreate(m_hOurWnd, rcInitialPos);
...
OBJECT_ENTRY_AUTO(__uuidof(CDirect3DCtl), CDirect3D)