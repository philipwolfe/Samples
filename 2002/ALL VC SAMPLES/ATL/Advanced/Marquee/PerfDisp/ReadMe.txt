========================================================================
    ACTIVE TEMPLATE LIBRARY : PerfDisp Project Overview
========================================================================

AppWizard has created this PerfDisp project for you to use as the starting point for
...
_PerfDisp.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_PerfDisp.h)
        GUID definitions                                (_PerfDisp_i.c)
        A type library                                  (_PerfDisp.tlb)
        Marshaling code                                 (_PerfDisp_p.c and dlldata.c)
PerfDisp.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named PerfDisp.pch and a precompiled types file named StdAfx.obj.
...
PerfDispps.vcproj
	...
	dlldata.c, PerfDisp_i.c and PerfDisp_p.c which are required
