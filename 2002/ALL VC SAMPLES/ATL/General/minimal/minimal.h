...
interface __declspec(uuid("A4E6EAE8-E19A-11CF-9203-00A0C903976F")) IMinObj : public IUnknown
{
public:
	STDMETHOD(Hello)() = 0 ;
};
...
class __declspec(uuid("A4E6EAEC-E19A-11CF-9203-00A0C903976F")) CMinObj;
