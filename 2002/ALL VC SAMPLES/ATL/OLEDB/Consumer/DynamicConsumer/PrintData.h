			...
			else if( status == DBSTATUS_S_OK || status == DBSTATUS_S_TRUNCATED )
			{
				...
				else
				{
					...
					case DBTYPE_UI4:
						...
						break;
					case DBTYPE_I8:
						printf( "%d", *(__int64*)rs.GetValue( col ) );
						break;
					case DBTYPE_UI8:
						printf( "%ud", *(unsigned __int64*)rs.GetValue( col ) );
						break;
					case DBTYPE_R4:
					...
					case DBTYPE_R8:
						...
						break;
					case DBTYPE_CY:
						printf( "%d", *(CURRENCY*)rs.GetValue( col ) );
						break;
					case DBTYPE_BSTR:
						printf( "%f", *(DBTIME*)rs.GetValue( col ) );
						break;
					case DBTYPE_IDISPATCH:
						printf( "%p", *(void**)rs.GetValue( col ) );
						break;
					case DBTYPE_BOOL:
						printf( "%f", *(BOOL*)rs.GetValue( col ) );
						break;
					case DBTYPE_VARIANT:
						printf( "%f", *(VARIANT*)rs.GetValue( col ) );
						break;
					case DBTYPE_DECIMAL:
						printf( "%f", *(DECIMAL*)rs.GetValue( col ) );
						break;
					case DBTYPE_UI1:
