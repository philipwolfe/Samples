...
//	hr = db.OpenFromInitializationString( L"Provider=Microsoft.Jet.OLEDB.4.0;Data Source=D:\\vc7libs\\Ship\\Samples\\C++\\ATLMFC\\ATL\\OLEDB\\Consumer\\MultiRead\\MultiRead.mdb" );
