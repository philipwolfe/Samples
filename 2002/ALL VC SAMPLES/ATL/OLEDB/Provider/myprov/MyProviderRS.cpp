...
ATLCOLUMNINFO* CommonGetColInfo(IUnknown* pPropsUnk, DBORDINAL* pcCols)
{
...
ATLCOLUMNINFO* CAgentMan::GetColumnInfo(CMyProviderCommand* pThis, DBORDINAL* pcCols)
{
	return CommonGetColInfo<ICommandProperties>(pThis->GetUnknown(), pcCols);
}


ATLCOLUMNINFO* CAgentMan::GetColumnInfo(CAgentRowset* pThis, DBORDINAL* pcCols)
{
