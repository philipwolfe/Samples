...
public:
	...
	static ATLCOLUMNINFO* GetColumnInfo(CAgentRowset* pThis, DBORDINAL* pcCols);
	static ATLCOLUMNINFO* GetColumnInfo(CMyProviderCommand* pThis, DBORDINAL* pcCols);
...
public:
	...
	static ATLCOLUMNINFO* GetColumnInfo(CMyProviderCommand* pv, DBORDINAL* pcInfo)
	{
...
public:
	...
	virtual DBSTATUS GetDBStatus(CSimpleRow* , ATLCOLUMNINFO* /*HACCESSOR*/)
	{
