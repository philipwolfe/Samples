========================================================================
    ACTIVE TEMPLATE LIBRARY : PerfServ Project Overview
========================================================================

AppWizard has created this PerfServ project for you to use as the starting point for
...
_PerfServ.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_PerfServ.h)
        GUID definitions                                (_PerfServ_i.c)
        A type library                                  (_PerfServ.tlb)
        Marshaling code                                 (_PerfServ_p.c and dlldata.c)
PerfServ.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named PerfServ.pch and a precompiled types file named StdAfx.obj.
...
PerfServps.vcproj
	...
	dlldata.c, PerfServ_i.c and PerfServ_p.c which are required
