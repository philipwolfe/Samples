========================================================================
       ATL SERVER : OnlineAddressBookWSIsapi Project Overview
========================================================================

AppWizard has created this OnlineAddressBookWSIsapi application for you.  This application
not only demonstrates the basics of using the ATL Server Classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your OnlineAddressBookWSIsapi application.

OnlineAddressBookWSIsapi.vcproj
...
OnlineAddressBookWSIsapi.def
	...
	COnlineAddressBookWSExtension class.
	The DLL also exports functions needed for perfmormance monitoring 
	support, however these do not appear in the OnlineAddressBookWSIsapi.def file.
OnlineAddressBookWSextension.h
	This file contains your CIsapiExtension derived ISAPI Extension class:
	 COnlineAddressBookWSExtension that is customized based on the options you chose 
	in the AppWizard.
OnlineAddressBookWSIsapi.disco
