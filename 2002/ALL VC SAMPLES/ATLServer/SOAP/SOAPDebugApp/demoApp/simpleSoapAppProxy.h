...
public:
	...
	CSimpleSoapAppServiceT(ISAXXMLReader *pReader = NULL)
		:TClient(_T("http://localhost/SimpleSoapApp/SimpleSoapApp.dll?Handler=Default"))
	{
		SetClient(true);
		SetReader(pReader);
	}
...
{
	return L"urn:SimpleSoapAppService";
}
...
{
	return "urn:SimpleSoapAppService";
}
