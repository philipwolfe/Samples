// SecureValidation.cpp : Defines the entry point for the DLL application.
//
...
#include "SecureValidation.h"
#include "WSValidation.h"




[ module(name="SecureValidation", type="dll") ]
