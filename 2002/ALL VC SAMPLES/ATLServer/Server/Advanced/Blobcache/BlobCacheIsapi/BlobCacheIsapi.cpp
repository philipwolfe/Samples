// BlobCacheIsapi.cpp : Defines the entry point for the DLL application.
//
...
#endif
[ module(name="BlobCacheIsapi", type="dll") ];
[ emitidl(restricted) ];

#include "BlobCacheextension.h"

typedef CBlobCacheExtension<> ExtensionType;
