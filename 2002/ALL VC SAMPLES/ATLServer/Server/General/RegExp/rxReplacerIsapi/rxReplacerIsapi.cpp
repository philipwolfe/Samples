...
// rxReplacerIsapi.cpp : Defines the entry point for the DLL application.
//
...
#endif
[ module(name="rxReplacerIsapi", type="dll") ];
[ emitidl(restricted) ];
...
typedef CIsapiExtension<CThreadPool<CIsapiWorker>, CPerfMonRequestStats > ExtensionType;
