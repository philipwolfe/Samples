========================================================================
       ATL SERVER : tutorialIsapi Project Overview
========================================================================

AppWizard has created this tutorialIsapi application for you.  This application
not only demonstrates the basics of using the ATL Server Classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your tutorialIsapi application.

tutorialIsapi.vcproj
    This is the main project file for VC++ projects generated using an Application Wizard. 
    It contains information about the version of Visual C++ that generated the file, and 
    information about the platforms, configurations, and project features selected with the
    Application Wizard.
tutorialDeploy.vdproj
...
tutorialIsapi.def
	...
	CtutorialExtension class.
	The DLL also exports functions needed for perfmormance monitoring 
	support, however these do not appear in the tutorialIsapi.def file.
tutorialextension.h
	This file contains your CIsapiExtension derived ISAPI Extension class:
	 CtutorialExtension that is customized based on the options you chose 
	in the AppWizard.
