// TutorialIsapi.cpp : Defines the entry point for the DLL application.
//
...
#endif
[ module(name="TutorialIsapi", type="dll") ];
[ emitidl(restricted) ];

#include "tutorialextension.h"

BEGIN_PERFREG_MAP()
	PERFREG_ENTRY(CRequestPerfMon)
END_PERFREG_MAP()

typedef CTutorialExtension<CThreadPool<CTutorialExtensionWorker>, CPerfMonRequestStats > ExtensionType;
