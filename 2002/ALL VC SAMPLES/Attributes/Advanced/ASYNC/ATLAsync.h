...
class ATL_NO_VTABLE CATLAsyncAttrib :
	...
	public IProvideClassInfo2Impl<&__uuidof(CATLAsyncAttrib), NULL, &_AtlModule.m_libid>,
...
public:
	...
	STDMETHOD(put_URL)(BSTR strURL)
	{
		...
		if (::IsWindow(m_EditCtrl.m_hWnd))
		{
			...
			CBindStatusCallback<CATLAsyncAttrib>::Download(this, OnData, m_bstrURL, m_spClientSite, FALSE);
		}
		return S_OK;
	}
