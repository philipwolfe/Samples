...
// CATLTangramModel
[ coclass,
  uuid(0AEE8E6E-8C99-4ADE-A94A-219D9F100EBA),
  helpstring("ATLTangramModel Attrib Class"),
  progid("AtlTangram.AtlTangramModelAttrib.1"),
  default("IATLTangramModel"),
  event_source(com)
]
...
__event __interface IATLTangramModelEvent;
