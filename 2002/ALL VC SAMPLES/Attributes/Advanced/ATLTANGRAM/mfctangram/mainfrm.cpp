...
CLSID CLSID_CATLTangramModel ={0x0AEE8E6E,0x8C99,0x4ADE,{0xA9,0x4A,0x21,0x9D,0x9F,0x10,0x0E,0xBA}};
...
BOOL CMFCMainFrame::Initialize(int cx, int cy)
{
	...
	{
		hr = ::CoCreateInstance(CLSID_CATLTangramModel,
								NULL,
								clsctx ,
		...
		hr = pITangramModel->SetVertices(polygons[i].iSides, (tagTangramPoint2d_ *)polygons[i].points) ;
		ASSERT_HRESULT(hr) ;
