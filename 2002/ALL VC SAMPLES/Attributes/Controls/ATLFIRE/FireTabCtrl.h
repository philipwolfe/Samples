...
[
	...
	progid("AtlFireCtl.AtlFireCtlAttrib"),
...
class ATL_NO_VTABLE CFireTabCtrl :
	...
	public IProvideClassInfo2Impl<&__uuidof(CFireTabCtrl), NULL>,
...
BEGIN_PROPERTY_MAP(CFireTabCtrl)
	...
	PROP_ENTRY("FireDecay", 1, __uuidof(CFireTabCtrl))
	PROP_ENTRY("FireFlammability", 2, __uuidof(CFireTabCtrl))
	PROP_ENTRY("FireMaxHeat", 3, __uuidof(CFireTabCtrl))
	PROP_ENTRY("FireSpreadRate", 4, __uuidof(CFireTabCtrl))
	PROP_ENTRY("FireSize", 5, __uuidof(CFireTabCtrl))
	PROP_ENTRY("RenderSmoothness", 6, __uuidof(CFireTabCtrl))
	PROP_ENTRY("RenderDistribution", 7, __uuidof(CFireTabCtrl))
	PROP_ENTRY("RenderChaos", 8, __uuidof(CFireTabCtrl))
	PROP_ENTRY("StartTab", 9, __uuidof(CFireTabCtrl))
END_PROPERTY_MAP()
