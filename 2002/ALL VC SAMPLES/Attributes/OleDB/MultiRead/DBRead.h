...
[
	db_source(L"Provider=Microsoft.Jet.OLEDB.4.0;Data Source=MultiRead.mdb"),
	db_table("Products")
]
class CProduct
{
public:
	[db_column(1)] long		nProductID;
	[db_column(2)] TCHAR    pName[80];
	[db_column(3)] TCHAR    PhoneNumber[50];
	[db_column(4)] TCHAR	Location[50];
	[db_column(5)] TCHAR	Title[50];
	[db_column(6)] TCHAR	Company[50];
	[db_column(7)] TCHAR    Email[50];
