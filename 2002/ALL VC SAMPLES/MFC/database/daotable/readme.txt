...
The information in this article applies to:
  ...
  - The Microsoft Foundation Classes (MFC), included with:
	  - Microsoft Visual C++ .NET, 32-bit Edition
-----------------------------------------------------------------------
...
help for Visual C++ .NET.  For additional documentation on DAO, refer to
the help files in the DAO SDK which is provided on the Visual C++ .NET CD-ROM.
