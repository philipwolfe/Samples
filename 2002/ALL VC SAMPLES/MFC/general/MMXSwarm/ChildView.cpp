...
void CChildView::OnFileSave()
{
	...
	GUID &guid = m_nFilterSave > 0 ? aguidFileTypes[m_nFilterSave-1] : GUID_NULL;
...
void CChildView::OnSize(UINT nType, int cx, int cy) 
{
    ...
    if (m_hWnd && cx && cy) {
		...
		if (m_eSurf == eNone) {
			...
			switch (pixels) {
				case 16:
					m_eSurf = IsMMX() ? e16BitMMXIntrin : e16BitGeneric;
					break;
				case 24:
					m_eSurf = IsMMX() ? e24BitMMXIntrin : e24BitGeneric;
					break;
				case 32:
					m_eSurf = IsMMX() ? e32BitMMXIntrin : e32BitGeneric;
					break;
				default:
					bWarnDepth = true;
					m_eSurf = IsMMX() ? e32BitMMXIntrin : e32BitGeneric;
