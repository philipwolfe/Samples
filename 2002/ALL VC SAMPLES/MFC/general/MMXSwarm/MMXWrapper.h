...
public:
	...
	{
		return( _m_to_int( _mm_packs_pu16( m_m64, _m_from_int( 0 ) ) ) );
	}
	...
	{
		m_m64 = _mm_unpacklo_pi8( _m_from_int( dw ), _m_from_int( 0 ) );
	}
	void UnpackBytesHi( DWORD dw )
	{
		m_m64 = _mm_unpacklo_pi8( _m_from_int( 0 ), _m_from_int( dw ) );
	}

	void UnpackBytes(CMMXUnsigned16Saturated &mmLeft)
	{
		mmLeft = _mm_unpackhi_pi8( m_m64, _m_from_int( 0 ) );
		m_m64 = _mm_unpacklo_pi8( m_m64, _m_from_int( 0 ) );
	}
