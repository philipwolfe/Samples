...
BEGIN_MESSAGE_MAP(CInPlaceFrame, COleDocIPFrameWnd)
	...
	ON_COMMAND(ID_HELP_INDEX, COleDocIPFrameWnd::OnHelpIndex)
	ON_COMMAND(ID_HELP_USING, COleDocIPFrameWnd::OnHelpUsing)
	ON_COMMAND(ID_HELP, COleDocIPFrameWnd::OnHelp)
	ON_COMMAND(ID_DEFAULT_HELP, COleDocIPFrameWnd::OnHelpIndex)
