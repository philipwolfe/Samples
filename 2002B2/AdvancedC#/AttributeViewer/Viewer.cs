namespace AttributeViewer
{
	...
	public class Viewer: System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.Button displayPB;
		...
		private void InitializeComponent()
		{
			...
			this.displayPB = new System.Windows.Forms.Button();
			...
			displayPB.Dock = System.Windows.Forms.DockStyle.Right;
			...
			notesLB.Anchor = System.Windows.Forms.AnchorStyles.Top |
			...
			linkLabel1.Text = "";
			linkLabel1.Anchor = System.Windows.Forms.AnchorStyles.Top |
								System.Windows.Forms.AnchorStyles.Left |
								System.Windows.Forms.AnchorStyles.Right;
			...
			AxWebBrowser1.Anchor =  System.Windows.Forms.AnchorStyles.Top |
			...
			else
			{
				...
				foreach (object attribute in type.GetCustomAttributes(false) )
				{
					if ( attribute is HelpUrlAttribute )
					{
						...
						linkLabel1.LinkArea = new LinkArea(0, ha.Url.Length);
					}
