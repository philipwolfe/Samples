<%@ Page language="c#" Codebehind="WebForm1.aspx.cs" AutoEventWireup="false" Inherits="WebFormDHTMLDemo.WebForm1" %>
			...
			<tr valign=top>
				...
				<td>
					<form id=WebForm1 method=post runat="server">
						<table height=207 cellspacing=0 cellpadding=0 width=580 border=0 ms_2d_layout="TRUE">
							<tr>
								<td width=0 height=0>
								</td>
								<td width=1 height=0>
							...
							<tr valign=top>
								...
								<td colspan=4 rowspan=2>
									<asp:label id=Label1 runat="server" Width="564" Height="37" Font-Names="Verdana">
										When you choose an Item, the Size combo is populated with the available sizes 
										using client-side script and DHTML
									</asp:label>
								</td>
							</tr>
							<tr valign=top>
							...
							<tr valign=top>
								...
								<td colspan=3>
									<asp:Label id=Label2 runat="server" Width="560" Height="38" Font-Names="Verdana">
										When you choose a Size, the Color combo is populated with the available sizes 
										using client-side script and DHTML
									</asp:Label>
								</td>
							</tr>
							<tr valign=top>
								...
								<td>
									<asp:Label id=Label3 runat="server" Width="554" Height="36" Font-Names="Verdana">
										The Buy Item button displays the current selection using an Alert Dialog
									</asp:Label>
								</td>
							</tr>
							<tr valign=top>
								<td width=0 height=87>
								</td>
								<td colspan=4>
									<asp:table id="Table1" runat="server" Height="71" Width="571" font-names="Verdana">
										<asp:TableRow>
											<asp:TableCell Text="Item:">
											</asp:TableCell>
											<asp:TableCell Text="<select id=cboItem onchange=fillSize(); size=1 name=cboItem></select>">
											</asp:TableCell>
											<asp:TableCell Text="Size:">
											</asp:TableCell>
											<asp:TableCell Text="
<select id=cboSize name=cboSize onchange=fillColor();></select>">
											</asp:TableCell>
											<asp:TableCell Text="Color:">
											</asp:TableCell>
											<asp:TableCell Text="<select id=cboColor name=cboColor></select>">
											</asp:TableCell>
										</asp:TableRow>
										<asp:TableRow>
											<asp:TableCell>
											</asp:TableCell>
											<asp:TableCell Text="<input id=btnBuy onclick=showItem(); type=submit value='Buy Item' name=btnBuy>">
											</asp:TableCell>
											<asp:TableCell>
											</asp:TableCell>
											<asp:TableCell>
