...
'Commented out message box
'SLUtilLogMessage 0, WScript.ScriptFullName & " - Begin"
...
Const SESSION_PATH = "C:\FieldContent\Experience VS.NET"
...
WshShell.RegWrite _
    "HKCU\Software\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\3\1A03", _
    "0", _
    "REG_DWORD"
    
IISCreateVirtualDirectory "Lab3", SESSION_PATH & "\Lab3"
IISCreateVirtualDirectory "Lab4", SESSION_PATH & "\Lab4"

Dim sStartMenu
sStartMenu = WshShell.SpecialFolders("StartMenu")

Dim fldr
Set fldr = fso.GetFolder (sStartMenu & "\Programs\Experience VS.NET Content\Lab 3")
if IsObject(fldr) then
	SLUtilCreateShortcut sStartMenu & "\Programs\Experience VS.NET Content\Lab 3\ASP.lnk", "http://localhost/Lab3/Authors.asp", "", "", ""
	SLUtilCreateShortcut sStartMenu & "\Programs\Experience VS.NET Content\Lab 3\ASP.NET-VB.lnk", "http://localhost/Lab3/Authors%20VB.aspx", "", "", ""
	SLUtilCreateShortcut sStartMenu & "\Programs\Experience VS.NET Content\Lab 3\ASP.NET-C#.lnk", "http://localhost/Lab3/Authors%20C.aspx", "", "", ""
end if

Set fldr = fso.GetFolder (sStartMenu & "\Programs\Experience VS.NET Content\Lab 4")
if IsObject(fldr) then
	SLUtilCreateShortcut sStartMenu & "\Programs\Experience VS.NET Content\Lab 4\Server Controls C#.lnk", "http://localhost/quickstart/util/srcview.aspx?path=/quickstart/aspplus/samples/webforms/intro/intro6.src&file=cs/Intro6.aspx", "", "", ""
	SLUtilCreateShortcut sStartMenu & "\Programs\Experience VS.NET Content\Lab 4\Server Controls VB.lnk", "http://localhost/quickstart/util/srcview.aspx?path=/quickstart/aspplus/samples/webforms/intro/intro6.src&file=vb/Intro6.aspx", "", "", ""
	SLUtilCreateShortcut sStartMenu & "\Programs\Experience VS.NET Content\Lab 4\Server Controls.lnk", "http://localhost/quickstart/aspplus/samples/webforms/intro/vb/Intro6.aspx", "", "", ""
end if
...
'******************************************************************************
Wscript.Echo "Setup Script is complete"
'******************************************************************************
