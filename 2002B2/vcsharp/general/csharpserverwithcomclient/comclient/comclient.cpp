...
//In order to use managed-code servers like the C# server, we have to import the
...
int main(int argc, char* argv[])
{
	...
	else
	{
		if (argc > 1)
		{
			...
			//If you are on an OS that uses ASCII characters at the command prompt,
			//notice that the ASCII characters are automatically marshalled to Unicode
			//for the C# code
