...
namespace PerfMon
{
	...
	public class DisplayPanel : System.Windows.Forms.Panel
	{
		...
		public void Draw()
		{
			...
			PCValues[CurrentIndex]=NewValue;
			
			if (MaxVal<NewValue)MaxVal = NewValue;
		...
		private void DrawScale(DisplayPanel DP,double[] CorrectedValues,int HeightOffset, int VisibleHeight, System.Drawing.Color color)
		{
			...
			ValueLabel.Text=CorrectedValues[NoOfPoints-1].ToString();
		...
		// 2. See the MenuItems list to switch displays
