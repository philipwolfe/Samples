...
class AutoExcel
	public shared sub Main()	
		...
		workbook = workbooks.Add(XlWBATemplate.xlWBATWorksheet, 0) ' LCID = 0 here
		...
		chartobjects = worksheet.ChartObjects(Missing.Value, 0)
