...
options = {
    ...
    'source-file':      ("The name of the source file to report", None, OT_STRING),
    'verbose-level':    ("The verbosity of the compiler output", 1, OT_INT),
    'module-name':      ("The name of the COM+ module generated", None, OT_STRING),
    'profile-compiler': ("Profiles the compiler over the given source file", None, OT_INT),
    'assembly-title':   ("Title for the generated assembly", None, OT_STRING),
