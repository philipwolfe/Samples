...
namespace HowTo 
{
    ...
    public class Northwind : DataSet {
        ...
        private ProductsTDSDataTable tableProductsTDS;
        ...
        protected Northwind(SerializationInfo info, StreamingContext context) {
            string strSchema = ((string)(info.GetValue("XmlSchema", typeof(string))));
            if ((strSchema != null)) {
                DataSet ds = new DataSet();
                ds.ReadXmlSchema(new XmlTextReader(new System.IO.StringReader(strSchema)));
                if ((ds.Tables["ProductsTDS"] != null)) {
                    this.Tables.Add(new ProductsTDSDataTable(ds.Tables["ProductsTDS"]));
                }
        ...
        public ProductsTDSDataTable ProductsTDS {
            get {
                return this.tableProductsTDS;
            }
        }
        ...
        private bool ShouldSerializeProductsTDS() {
            return false;
        }
        ...
        public delegate void ProductsTDSRowChangeEventHandler(object sender, ProductsTDSRowChangeEvent e);
        
        [System.Diagnostics.DebuggerStepThrough()]
        public class ProductsTDSDataTable : DataTable, System.Collections.IEnumerable {
            ...
            internal ProductsTDSDataTable() : 
                    base("ProductsTDS") {
                this.InitClass();
            }
            
            internal ProductsTDSDataTable(DataTable table) : 
            ...
            public ProductsTDSRow this[int index] {
                get {
                    return ((ProductsTDSRow)(this.Rows[index]));
                }
            }
            
            public event ProductsTDSRowChangeEventHandler ProductsTDSRowChanged;
            
            public event ProductsTDSRowChangeEventHandler ProductsTDSRowChanging;
            
            public event ProductsTDSRowChangeEventHandler ProductsTDSRowDeleted;
            
            public event ProductsTDSRowChangeEventHandler ProductsTDSRowDeleting;
            ...
            public ProductsTDSRow FindByProductID(int ProductID) {
                return ((ProductsTDSRow)(this.Rows.Find(new object[] {
                            ProductID})));
            }
            ...
            private void InitClass() {
                ...
                this.Constraints.Add(new UniqueConstraint("NorthwindKey1", new DataColumn[] {
            ...
            public ProductsTDSRow NewProductsTDSRow() {
                return ((ProductsTDSRow)(this.NewRow()));
            }
            ...
            protected override System.Type GetRowType() {
                return typeof(ProductsTDSRow);
            }
            
            protected override void OnRowChanged(DataRowChangeEventArgs e) {
                base.OnRowChanged(e);
                if ((this.ProductsTDSRowChanged != null)) {
                    this.ProductsTDSRowChanged(this, new ProductsTDSRowChangeEvent(((ProductsTDSRow)(e.Row)), e.Action));
                }
            }
            
            protected override void OnRowChanging(DataRowChangeEventArgs e) {
                base.OnRowChanging(e);
                if ((this.ProductsTDSRowChanging != null)) {
                    this.ProductsTDSRowChanging(this, new ProductsTDSRowChangeEvent(((ProductsTDSRow)(e.Row)), e.Action));
                }
            }
            
            protected override void OnRowDeleted(DataRowChangeEventArgs e) {
                base.OnRowDeleted(e);
                if ((this.ProductsTDSRowDeleted != null)) {
                    this.ProductsTDSRowDeleted(this, new ProductsTDSRowChangeEvent(((ProductsTDSRow)(e.Row)), e.Action));
                }
            }
            
            protected override void OnRowDeleting(DataRowChangeEventArgs e) {
                base.OnRowDeleting(e);
                if ((this.ProductsTDSRowDeleting != null)) {
                    this.ProductsTDSRowDeleting(this, new ProductsTDSRowChangeEvent(((ProductsTDSRow)(e.Row)), e.Action));
                }
            }
        ...
        [System.Diagnostics.DebuggerStepThrough()]
        public class ProductsTDSRow : DataRow {
            ...
            public int ProductID {
                get {
                    return ((int)(this[this.tableProductsTDS.ProductIDColumn]));
                }
                set {
                    this[this.tableProductsTDS.ProductIDColumn] = value;
                }
            }
            
            public string ProductName {
                get {
                    return ((string)(this[this.tableProductsTDS.ProductNameColumn]));
                }
                set {
                    this[this.tableProductsTDS.ProductNameColumn] = value;
                }
            }
            ...
            public int SupplierID {
                get {
                    try {
                        return ((int)(this[this.tableProductsTDS.SupplierIDColumn]));
                    }
                ...
                set {
                    this[this.tableProductsTDS.SupplierIDColumn] = value;
                }
            }
            ...
            public int CategoryID {
                get {
                    try {
                        return ((int)(this[this.tableProductsTDS.CategoryIDColumn]));
                    }
                    catch (InvalidCastException e) {
                        throw new StrongTypingException("Cannot get value because it is DBNull.", e);
                    }
                ...
                set {
                    this[this.tableProductsTDS.CategoryIDColumn] = value;
                }
            }
            ...
            public string QuantityPerUnit {
                get {
                    try {
                        return ((string)(this[this.tableProductsTDS.QuantityPerUnitColumn]));
                    }
                    catch (InvalidCastException e) {
                        throw new StrongTypingException("Cannot get value because it is DBNull.", e);
                    }
                ...
                set {
                    this[this.tableProductsTDS.QuantityPerUnitColumn] = value;
                }
            }
            ...
            public System.Decimal UnitPrice {
                get {
                    try {
                        return ((System.Decimal)(this[this.tableProductsTDS.UnitPriceColumn]));
                    }
                    catch (InvalidCastException e) {
                        throw new StrongTypingException("Cannot get value because it is DBNull.", e);
                    }
                ...
                set {
                    this[this.tableProductsTDS.UnitPriceColumn] = value;
                }
            }
            ...
            public short UnitsInStock {
                get {
                    try {
                        return ((short)(this[this.tableProductsTDS.UnitsInStockColumn]));
                    }
                    catch (InvalidCastException e) {
                        throw new StrongTypingException("Cannot get value because it is DBNull.", e);
                    }
                ...
                set {
                    this[this.tableProductsTDS.UnitsInStockColumn] = value;
                }
            }
            ...
            public short UnitsOnOrder {
                get {
                    try {
                        return ((short)(this[this.tableProductsTDS.UnitsOnOrderColumn]));
                    }
                    catch (InvalidCastException e) {
                        throw new StrongTypingException("Cannot get value because it is DBNull.", e);
                    }
                ...
                set {
                    this[this.tableProductsTDS.UnitsOnOrderColumn] = value;
                }
            }
            ...
            public short ReorderLevel {
                get {
                    try {
                        return ((short)(this[this.tableProductsTDS.ReorderLevelColumn]));
                    }
                    catch (InvalidCastException e) {
                        throw new StrongTypingException("Cannot get value because it is DBNull.", e);
                    }
                ...
                set {
                    this[this.tableProductsTDS.ReorderLevelColumn] = value;
                }
            }
            
            public bool Discontinued {
                get {
                    return ((bool)(this[this.tableProductsTDS.DiscontinuedColumn]));
                }
                set {
                    this[this.tableProductsTDS.DiscontinuedColumn] = value;
                }
            }
            
            public bool IsSupplierIDNull() {
                return this.IsNull(this.tableProductsTDS.SupplierIDColumn);
            }
            
            public void SetSupplierIDNull() {
                this[this.tableProductsTDS.SupplierIDColumn] = System.Convert.DBNull;
            }
            
            public bool IsCategoryIDNull() {
                return this.IsNull(this.tableProductsTDS.CategoryIDColumn);
            }
            
            public void SetCategoryIDNull() {
                this[this.tableProductsTDS.CategoryIDColumn] = System.Convert.DBNull;
            }
            
            public bool IsQuantityPerUnitNull() {
                return this.IsNull(this.tableProductsTDS.QuantityPerUnitColumn);
            }
            
            public void SetQuantityPerUnitNull() {
                this[this.tableProductsTDS.QuantityPerUnitColumn] = System.Convert.DBNull;
            }
            
            public bool IsUnitPriceNull() {
                return this.IsNull(this.tableProductsTDS.UnitPriceColumn);
            }
            
            public void SetUnitPriceNull() {
                this[this.tableProductsTDS.UnitPriceColumn] = System.Convert.DBNull;
            }
            
            public bool IsUnitsInStockNull() {
                return this.IsNull(this.tableProductsTDS.UnitsInStockColumn);
            }
            
            public void SetUnitsInStockNull() {
                this[this.tableProductsTDS.UnitsInStockColumn] = System.Convert.DBNull;
            }
            
            public bool IsUnitsOnOrderNull() {
                return this.IsNull(this.tableProductsTDS.UnitsOnOrderColumn);
            }
            
            public void SetUnitsOnOrderNull() {
                this[this.tableProductsTDS.UnitsOnOrderColumn] = System.Convert.DBNull;
            }
            
            public bool IsReorderLevelNull() {
                return this.IsNull(this.tableProductsTDS.ReorderLevelColumn);
            }
            
            public void SetReorderLevelNull() {
                this[this.tableProductsTDS.ReorderLevelColumn] = System.Convert.DBNull;
            }
        }
        
        [System.Diagnostics.DebuggerStepThrough()]
        public class ProductsTDSRowChangeEvent : EventArgs {
            
            private ProductsTDSRow eventRow;
