...
<Script runat=Server>
	...
	'This method takes content from a file in the local directory
	'and copies the content into the response stream.
		...
		Try
			...
			'Open the XML file in the current directory
			fs = New FileStream(appbase & "myXMLfile.xml", FileMode.Open)
		
			'Copy the content from the file to the response stream
