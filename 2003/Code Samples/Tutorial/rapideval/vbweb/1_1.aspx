											...
											<TR>
												<td colspan="2">
													<TABLE WIDTH="756" BORDER="0" CELLPADDING="0" CELLSPACING="0">
														...
														<TR>
															<TD colspan="2"><script language="JavaScript1.2">mmLoadMenus();</script><img name="navigation" src="../images/navigation/step_1_web.gif" width="756" height="61"
													...
													<TABLE WIDTH="756" BORDER="0" CELLPADDING="0" CELLSPACING="0">
														...
														<tr valign="top">
															<td width="500">
																<p>It's an exciting time to be a Visual Basic Developer, especially if you need to 
																	create cutting-edge applications for the Web. Using Visual Basic .NET 
																	developers can create professional Web applications using the same intuitive 
																	drag and drop techniques that are used to create Windows applications. With an 
																	easy to use integrated development environment (IDE) and ready to assemble 
																	controls like the <a href="javascript:openWindow('../Pops/DatagridControl.htm')" class="poplink">
																		DataGrid</a>, <a href="javascript:openWindow('../Pops/DropDownListControl.htm')" class="poplink">
																		DropDownList</a>, <a href="javascript:openWindow('../Pops/CalendarControl.htm')" class="poplink">
																		Calendar</a> and numerous <a href="javascript:openWindow('../Pops/ValidationControls.htm')" class="poplink">
																		Validation controls</a>, you'll complete your first Web application in no 
																	time.</p>
																<p>In this simple walkthrough, you'll learn how to take advantage of ASP.NET to 
																	build a data-driven Web application. Data will be retrieved from a data source 
																	based on user parameters. You'll even utilize XML within this application.</p>
																<p>Look for the
																	<span class="evalgui">.NET Advantage</span>
																	sidebar on each page to quickly learn ways that Visual Basic .NET can give your 
																	applications that extra edge.</p>
															</td>
															<td>
																...
																<TABLE WIDTH="200" BORDER="0" CELLPADDING="0" CELLSPACING="0">
																	...
																	<TR>
																		...
																		<TD width="100%" valign="top" bgcolor="#e5f2ff" class="maintext"><div class="learn"><p>What 
																					is <a class="vseval" target="_blank" href="http://msdn.microsoft.com/library/default.asp?url=/library/en-us/dndotnet/html/introwebforms.asp?frame=true">
																						ASP.NET</a>?</p>
																				<P>Have an existing ASP application that you'd like to <a class="vseval" target="_blank" href="http://msdn.microsoft.com/library/en-us/dndotnet/html/convertasptoaspnet.asp?">
																						convert</a> to ASP.NET?</P>
																				<P>What is <a class="vseval" target="_blank" href="http://msdn.microsoft.com/library/default.asp?url=/library/en-us/vbcon/html/vbconxmltechnologybackgrounder.asp">
																						XML</a>, and what does it have to do with Web development?</P>
																				<P>Check out some completed VB.NET Web <a class="vseval" target="_blank" href="http://www.asp.net/Default.aspx?tabindex=9&amp;tabid=47">
																						applications</a></P>
																			</div>
																		</TD>
