															...
															<td width="500">
																<p><ol>
																		...
																		<li>
																			...
																			<span class="selection">ASP.NET Web Application</span>.
																		<li>
																			In the
																			<span class="property">Location</span>
																			field, type the name
																			<span class="entry">http://localhost/OrdersWebVB</span>
																			and select
																			<span class="button">OK</span>.
																		<li>
																			In the
																			<span class="heading">Solution Explorer</span>, you will see your new project. 
																			A Web Form named
																			<span class="propvalue">WebForm1.aspx</span>
																			will be created for you.</li>
																	</ol>
																<p align="center">
																	<IMG SRC="Screenshot/NewProjectVBWeb.jpg">
																</p>
															</td>
															<td>
																...
																<TABLE WIDTH="200" BORDER="0" CELLPADDING="0" CELLSPACING="0">
																	...
																	<TR>
																		...
																		<TD width="100%" valign="top" bgcolor="#e5f2ff" class="maintext"><div class="learn">
																				<P>Learn how to migrate ASP applications to ASP.NET quickly and <a class="vseval" target="_blank" href="http://msdn.microsoft.com/library/en-us/Dnaspp/html/aspnetmigrissues.asp?frame=true">
																						efficiently</a></P>
																				<p>
																					<a class="vseval" target="_blank" href="http://msdn.microsoft.com/library/en-us/dndotnet/html/introvisstunet.asp?frame=true">
																						Introduction to Visual Studio .NET</a>
																				</p>
																				<p>
																					<a class="vseval" target="_blank" href="http://msdn.microsoft.com/library/en-us/vsintro7/html/vxoriManagingProjectsSolutions.asp">
																						Managing Solutions, Projects, and Files</a>
																				</p>
																			</div>
																		</TD>
