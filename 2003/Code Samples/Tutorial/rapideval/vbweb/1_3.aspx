...
mm_menu_Step1.addMenuItem("<p class='drop'><a href='1_3.aspx'><img src='../images/arrow_dropdown.gif' border=0>&nbsp;<B>Solution Explorer</B></a></p>");
											...
											<TR>
												<td colspan="2">
														...
														<TR>
															...
															<TD valign="top" class="maintext"><table width="500" border="0" cellspacing="0" cellpadding="0" ID="Table5">
																	<tr>
																		...
																		<td class="status"><strong>Step 3 of 3: Solution Explorer</strong></td>
																	</tr>
																</table>
															</TD>
															<TD valign="top">
																<table width="150" border="0" cellspacing="0" cellpadding="0" ID="Table6">
																	<tr>
																		<td width="89" class="maintext"><a href="1_2.aspx"><img src="../images/navigation/previous.gif" width="89" height="24" border="0" alt="Previous Step"></a></td>
																		<td width="82" class="maintext"><a href="2_1.aspx"><img src="../images/navigation/next.gif" width="89" height="24" border="0" alt="Next Step"></a></td>
																	</tr>
																</table>
															</TD>
													...
													<TABLE WIDTH="756" BORDER="0" CELLPADDING="0" CELLSPACING="0">
														...
														<tr valign="top">
															<td width="500">
																<p>Visual Basic .NET introduces the concept of a solution that is used across all 
																	.NET languages and project types. If you used Visual Interdev to develop web 
																	applications, the concept of a solution is probably familiar to you. A solution 
																	is a collection of the different files associated with a project, ranging from 
																	ASP.NET pages to graphic files to Visual Basic .NET class files.</p>
																<p>In addition, Visual Basic .NET introduces a variety of new project types that 
																	can live in a solution, including an ASP.NET Web Service project, a Windows 
																	Service project and of course an ASP.NET Web Application.</p>
																<P>In the Solution Explorer, you will see the new project that Visual Studio .NET 
																	2003 has created for you. A Web Form named WebForm1.aspx, along with several 
																	other project files, are created for you automatically.</P>
																<P align="center">
																	<IMG src="Screenshot/NewSolutionVBWeb.jpg">
																</P>
															</td>
															<td>
																...
																<TABLE WIDTH="200" BORDER="0" CELLPADDING="0" CELLSPACING="0">
																	...
																	<TR>
																		...
																		<TD width="100%" valign="top" bgcolor="#e5f2ff" class="maintext"><div class="learn">
																				<p>Where did Visual Interdev go? The functionality of Visual Interdev is now part 
																					of <a class="vseval" target="_blank" href="http://msdn.microsoft.com/vinterdev/webdev.asp">
																						Visual Studio .NET</a></p>
																				<p>Looking for ways to prepare your Visual Basic 6.0 applications for the 
																					transition to .NET? Check out the <a class="vseval" target="_blank" href='http://msdn.microsoft.com/vbasic/downloads/codeadvisor/default.asp'>
																						Visual Basic 6.0 Code Advisor</a></p>
																				<p>
																					<a class="vseval" target="_blank" href="http://msdn.microsoft.com/library/en-us/vsintro7/html/vxoriSolutions.asp">
																						Using the Solution Explorer</a>
																				</p>
																			</div>
																		</TD>
