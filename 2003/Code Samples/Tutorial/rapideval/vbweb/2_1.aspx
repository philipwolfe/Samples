...
mm_menu_Step2.addMenuItem("<p class='drop'><a href='2_1.aspx'><img src='../images/arrow_dropdown.gif' border=0>&nbsp;<B>Introduction</B></a></p>");
											...
											<TR>
												<td colspan="2">
														...
														<TR>
															...
															<TD valign="top">
																<table width="150" border="0" cellspacing="0" cellpadding="0" ID="Table6">
																	<tr>
																		<td width="89" class="maintext"><a href="1_5.aspx"><img src="../images/navigation/previous.gif" width="89" height="24" border="0" alt="Previous Step"></a></td>
													...
													<TABLE WIDTH="756" BORDER="0" CELLPADDING="0" CELLSPACING="0">
														...
														<tr valign="top">
															<td width="500">
																<P>Let's get started building our first Web form. We will use a simple drag and 
																	drop technique from the Toolbox, just like building a Windows Form.</P>
																<p>When you look in the Toolbox, you might see a lot of new and unfamiliar controls 
																	that you can use on your Web Form (an HTML page that makes up part of the 
																	Internet application you are building right now). As we work through this 
																	sample, we'll point out as many of these as we can along the way. Also, keep an 
																	eye on the
																	<span class="evalgui">
        Learn More</span>
																	area if you want to dig a bit deeper into the new controls available in a 
																	Visual Basic .NET Web Application.</p>
																<p>Below is a screenshot of the completed application outlined in this task. Along 
																	the way you will have the option of making your own choices for formatting, 
																	control placement, colors and so forth. We encourage you to experiment as you 
																	begin to learn the Visual Studio .NET 2003 IDE. As you build the interface, 
																	check the bottom of the page for a link to the completed user interface for 
																	reference.</p>
																<p>If you follow the directions closely, your completed Web Form should look 
																	approximately like this.</p>
																<P align="center">
																	<IMG src="Screenshot/CompletedWebForm_sm.jpg">
																</P>
															</td>
															<td>
																...
																<TABLE WIDTH="200" BORDER="0" CELLPADDING="0" CELLSPACING="0">
																	...
																	<TR>
																		...
																		<TD width="100%" valign="top" bgcolor="#e5f2ff" class="maintext"><div class="learn">
																				<p>
																					How do I use the <a target="_blank" class="vseval" href="http://msdn.microsoft.com/library/default.asp?url=/library/en-us/vsintro7/html/vxtskusingtoolboxwindow.asp">
																						Toolbox</a>
																				</p>
																				<p>
																					<a target="_blank" class="vseval" href="http://msdn.microsoft.com/library/default.asp?url=/library/en-us/dndotnet/html/introwebforms.asp?frame=true">
																						Inside Web Forms</a></p>
																			</div>
																		</TD>
