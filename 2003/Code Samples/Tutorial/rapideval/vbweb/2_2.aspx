...
mm_menu_Step2.addMenuItem("<p class='drop'><a href='2_2.aspx'><img src='../images/arrow_dropdown.gif' border=0>&nbsp;<B>Add Labels and Dropdown</B></a></p>");
														...
														<TR>
															...
															<TD valign="top" class="maintext"><table width="500" border="0" cellspacing="0" cellpadding="0" ID="Table5">
																	<tr>
																		...
																		<td class="status"><strong>Step 2 of 5: Add Labels and Dropdown</strong></td>
																	</tr>
																</table>
															</TD>
															<TD valign="top">
															...
															<td width="500">
																<ol>
																	<li>
																		...
																		labels. Drag three <a href="javascript:openWindow('../Pops/LabelControl.htm')" class="poplink">
																	...
																	<li>
																		...
																		property in the <a href="javascript:openWindow('../Pops/PropertyWindow.htm')" class="poplink">
																			Properties window</a>. From left to right, update the text of the labels 
																		to:
																	...
																	<li>
																		We want to align the labels vertically, so select all of the labels by holding 
																		down the
																		<span class="key">Ctrl</span>
																	key and clicking each control.
																	<li>
																		From the
																		<span class="menu">Format</span>
																		menu, choose
																		<span class="menucmd">Align - Tops</span>. The top edge of the labels will 
																	now be aligned vertically.
																	<li>
																		Now, drag a
																		<span class="inline">DropdownList</span>
																		control from the
																		<span class="heading">Toolbox</span>
																		...
																		property to
																		<span class="propvalue">ddlCustomers</span></li>
																</ol>
																...
																<TABLE WIDTH="200" BORDER="0" CELLPADDING="0" CELLSPACING="0">
																	...
																	<TR>
																		...
																		<TD width="100%" valign="top" bgcolor="#e5f2ff" class="maintext"><div class="learn">
																				<p>
																					Develop <a target="_blank" class="vseval" href="http://msdn.microsoft.com/msdnmag/issues/02/06/webc/toc.asp">
																						Polished Web Form Controls</a> the Easy Way with the .NET Framework
																				</p>
																			</div>
																		</TD>
