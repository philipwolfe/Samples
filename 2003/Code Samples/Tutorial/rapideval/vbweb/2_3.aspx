...
mm_menu_Step2.addMenuItem("<p class='drop'><a href='2_3.aspx'><img src='../images/arrow_dropdown.gif' border=0>&nbsp;<B>Add Textboxes</B></a></p>");
														...
														<TR>
															...
															<TD valign="top" class="maintext"><table width="500" border="0" cellspacing="0" cellpadding="0" ID="Table5">
																	<tr>
																		...
																		<td class="status"><strong>Step 3 of 5: Add Textboxes</strong></td>
																	</tr>
																</table>
															</TD>
															<TD valign="top">
													...
													<TABLE WIDTH="756" BORDER="0" CELLPADDING="0" CELLSPACING="0">
														...
														<tr valign="top">
															<td width="500">
																<ol>
																	<li>
																		Next, we will add 2 <a href="javascript:openWindow('../Pops/TextboxControl.htm')" class="poplink">
																			Textbox controls</a>
																	to our Web Form. These textboxes will hold the Start Date and End Date for our 
																	data search. You will be able to enter a date into these textboxes directly or 
																	use the Calendar control to graphically select a date.
																	<li>
																		Drag a
																		<span class="control">Textbox</span>
																		onto the web form and place it under the
																		<SPAN class="mnu">Choose Start Date</SPAN>
																	label.
																	<li>
																		Set the
																	...
																	<li>
																		...
																		<span class="control">Textbox</span>
																		onto the web form and place it under the
																		<SPAN class="mnu">Choose End Date</SPAN>
																	label.
																	<li>
																		Set the
																		<span class="property">ID</span>
																		property to
																		<span class="propvalue">txtEndDate</span></li>
																</ol>
																...
																<TABLE WIDTH="200" BORDER="0" CELLPADDING="0" CELLSPACING="0">
																	...
																	<TR>
																		...
																		<TD width="100%" valign="top" bgcolor="#e5f2ff" class="maintext"><div class="learn">
																				<p>Changes to the <a target="_blank" class="vseval" href="http://msdn.microsoft.com/library/default.asp?url=/library/en-us/vbcon/html/vxconChangesToTextBoxControlInVisualBasicNET.asp">
																						Textbox control</a> in Visual Basic .NET</p>
																			</div>
																		</TD>
