...
mm_menu_Step2.addMenuItem("<p class='drop'><a href='2_4.aspx'><img src='../images/arrow_dropdown.gif' border=0>&nbsp;<B>Add Calendars</B></a></p>");
...
//-->
	...
	<body bgColor="#000066" leftMargin="0" topMargin="0" marginwidth="0" marginheight="0">
											...
											<TR>
												<td colspan="2">
													<TABLE WIDTH="756" BORDER="0" CELLPADDING="0" CELLSPACING="0">
														...
														<TR>
															<TD colspan="2"><script language="JavaScript1.2">mmLoadMenus();</script><img name="navigation" src="../images/navigation/step_2_web.gif" width="756" height="61"
														...
														<TR>
															...
															<TD valign="top" class="maintext"><table width="500" border="0" cellspacing="0" cellpadding="0" ID="Table5">
																	<tr>
																		...
																		<td class="status"><strong>Step 4 of 5: Add Calendars</strong></td>
																	</tr>
																</table>
															</TD>
															<TD valign="top">
																<table width="150" border="0" cellspacing="0" cellpadding="0" ID="Table6">
																	<tr>
																		<td width="89" class="maintext"><a href="2_3.aspx"><img src="../images/navigation/previous.gif" width="89" height="24" border="0" alt="Previous Step"></a></td>
																		<td width="82" class="maintext"><a href="2_5.aspx"><img src="../images/navigation/next.gif" width="89" height="24" border="0" alt="Next Step"></a></td>
																	</tr>
																</table>
															</TD>
													...
													<TABLE WIDTH="756" BORDER="0" CELLPADDING="0" CELLSPACING="0">
														...
														<tr valign="top">
															<td width="500">
																<p>One of the exciting new web controls included with Visual Basic .NET is the
																	<span class="control">Calendar</span>
																	control. A Calendar is one of the most useful controls for Web Applications 
																	because of its versatility. It can be used as a date picker, to show special 
																	days or appointments, or for web sites that specialize in events. There are a 
																	wealth of properties available that allow you to customize the calendar to your 
																	liking. Let's try it out.</p>
																<ol>
																	<li>
																		Drag 2
																		<span class="control">Calendar</span>
																		controls onto the Web Form. Place one under the
																		<span class="propvalue">txtStartDate</span>
																		<span class="control">Textbox</span>
																		and one under the
																		<span class="propvalue">txtEndDate</span>
																		<span class="control">Textbox</span>
																	<LI>
																		Set the
																		<span class="property">ID</span>
																		property of the first calendar to
																		<span class="propvalue">OrderDateStart</span>
																	<LI>
																		Set the
																		<span class="property">ID</span>
																		property of the second to
																		<span class="propvalue">OrderDateEnd</span></LI>
																</ol>
																<P>We'll have some fun with formatting in the next step.</P>
																<P>Our order data in the XML file runs from July 4, 2000 to May 6, 2002. Let's set 
																	these start and end dates for our calendars.</P>
																<ol>
																	<li>
																		In the
																		<SPAN class="propvalue">OrderDateStart</SPAN>
																		Calendar, set the
																		<span class="property">SelectedDate</span>
																		property and the
																		<span class="property">VisibleDate</span>
																		property to
																		<span class="propvalue">
		7/1/2000</span>
																	<li>
																		In the
																		<SPAN class="propvalue">OrderDateEnd</SPAN>
																		Calendar, set the
																		<span class="property">SelectedDate</span>
																		property and the
																		<span class="property">VisibleDate</span>
		...
		5/1/2002</span></li>
																...
																<p align="center">Your final Web Form should look like <a class="poplink" href="javascript:openWindowBig('../Pops/CompletedWebForm.htm')">
																	this</p>
																</A>
															</td>
															<td>
																...
																<TABLE WIDTH="200" BORDER="0" CELLPADDING="0" CELLSPACING="0">
																	...
																	<TR>
																		...
																		<TD width="100%" valign="top" bgcolor="#e5f2ff" class="maintext"><div class="learn">
																				<P>For more information on the Calendar control, look <a target="_blank" class="vseval" href="http://msdn.microsoft.com/library/en-us/vbcon/html/vboriCalendarWebControl.asp">
																						here</a>!</P>
																				<P>Delve deeper into <a target="_blank" class="vseval" href="http://msdn.microsoft.com/library/en-us/vbcon/html/vbtskCustomizingCalendarWebControlAppearance.asp">
																						formatting</a> the Calendar control.</P>
																			</div>
																		</TD>
