...
mm_menu_Step2.addMenuItem("<p class='drop'><a href='2_5.aspx'><img src='../images/arrow_dropdown.gif' border=0>&nbsp;<B>Add Button and Datagrid</B></a></p>");
														...
														<TR>
															...
															<TD valign="top" class="maintext"><table width="500" border="0" cellspacing="0" cellpadding="0" ID="Table5">
																	<tr>
																		...
																		<td class="status"><strong>Step 5 of 5: Add Button and Datagrid</strong></td>
																	</tr>
																</table>
															</TD>
															<TD valign="top">
															...
															<td width="500">
																<ol>
																	<li>
																		...
																		control from the Toolbox and place it under the two
																		<span class="control">Calendar</span>
																		controls. We liked it (aligned right) beneath the second
																		<span class="control">Calendar</span>
																	control, but you are welcome to play around with the placement.
																	<LI>
																		Set
																	...
																	<LI>
																		...
																		property to
																		<span class="propvalue">cmdShow</span>
																	<li>
																		Lastly, drag a
																		<span class="control">DataGrid</span>
																		control from the Toolbox and place it under the
																		<span class="propvalue">cmdShow</span>
																	Button. Resize the DataGrid control to fill most of the form.
																	<li>
																		Set the ID property of the DataGrid to dgOrders</li>
																</ol>
																<p>The
																	<span class="control">DataGrid</span>
																	is one of the more powerful Web Controls. Functionality that was once 
																	challenging becomes easy to incorporate into your web pages. Many of the 
																	resources in the Learn More areas will help you learn more about this powerful 
																	control.</p>
																<P>Save the Web Form. This will prepare the code and control references you'll need 
																	in the
																	<span class="evalgui">Add Code</span>
																	step.</P>
																...
																<TABLE WIDTH="200" BORDER="0" CELLPADDING="0" CELLSPACING="0">
																	...
																	<TR>
																		...
																		<TD width="100%" valign="top" bgcolor="#e5f2ff" class="maintext"><div class="learn">
																				<p>Using the <a target="_blank" class="vseval" href="http://msdn.microsoft.com/library/default.asp?url=/library/en-us/vsintro7/html/vxurfWebFormsDesigner.asp">
																						Web Forms Designer</a></p>
																			</div>
																		</TD>
