...
mm_menu_Step3.addMenuItem("<p class='drop'><a href='3_1.aspx'><img src='../images/arrow_dropdown.gif' border=0>&nbsp;<B>AutoFormat Calendar</B></a></p>");
											...
											<TR>
												<td colspan="2">
														...
														<TR>
															...
															<TD valign="top" class="maintext"><table width="500" border="0" cellspacing="0" cellpadding="0" ID="Table5">
																	<tr>
																		...
																		<td class="status"><strong>Step 1 of 4: AutoFormat Calendar</strong></td>
																	</tr>
																</table>
															</TD>
															<TD valign="top">
													...
													<TABLE WIDTH="756" BORDER="0" CELLPADDING="0" CELLSPACING="0">
														...
														<tr valign="top">
															<td width="500">
																<P>The calendar control includes an autoformat option. This allows you to select 
																	from a variety of existing styles and immediately apply the style to your 
																	calendar. You can change the look of your calendar with just one click.
																</P>
																<P>
																	Unlike a datetime picker control in a Windows Forms application, the Web Form 
																	calendar control displays on the page as a full calendar. You will probably 
																	want to keep the size of the control as small as possible for this reason.
																</P>
																<P>Right-click the calendar in the Web Form designer. In the popup menu, choose
																	<span class="mnu">AutoFormat</span>. A list of available styles and a sample of 
																	each is displayed. To minimize the space used by the calendar select the
																	<span class="mnu">Simple</span>
																	scheme.</P>
																<p align="center">
																	<img src="Screenshot/calAutoFormat.jpg">
																</p>
															</td>
															<td>
																...
																<TABLE WIDTH="200" BORDER="0" CELLPADDING="0" CELLSPACING="0">
																	...
																	<TR>
																		...
																		<TD width="100%" valign="top" bgcolor="#e5f2ff" class="maintext"><div class="learn">
																				<p>
																					<a target="_blank" class="vseval" href="http://msdn.microsoft.com/library/en-us/vbcon/html/vboriCalendarWebControl.asp">
																						The Calendar Web Control</a>
																				</p>
																				<p><a target="_blank" class="vseval" href="http://msdn.microsoft.com/library/en-us/vbcon/html/vbtskCustomizingCalendarWebControlAppearance.asp">Customize</a>
																					the Calendar control.</p>
																			</div>
																		</TD>
