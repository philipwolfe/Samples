...
mm_menu_Step3.addMenuItem("<p class='drop'><a href='3_2.aspx'><img src='../images/arrow_dropdown.gif' border=0>&nbsp;<B>AutoFormat Datagrid</B></a></p>");
											...
											<TR>
												<td colspan="2">
														...
														<TR>
															...
															<TD valign="top" class="maintext"><table width="500" border="0" cellspacing="0" cellpadding="0" ID="Table5">
																	<tr>
																		...
																		<td class="status"><strong>Step 2 of 4: AutoFormat Datagrid</strong></td>
																	</tr>
																</table>
															</TD>
															<TD valign="top">
													...
													<TABLE WIDTH="756" BORDER="0" CELLPADDING="0" CELLSPACING="0">
														...
														<tr valign="top">
															<td width="500">
																<P>The datagrid is a rich Web Form control that provides a variety of formatting 
																	options. Formatting can be applied specifically to header elements, footer 
																	elements, rows and alternating rows. The autoformat option for the datagrid can 
																	apply a particular style to your datagrid.</P>
																<ol>
																	<li>
																		To apply a style, right-click the datagrid and choose
																		<span class="mnu">AutoFormat</span>.
																	<li>
																		Select the Simple1 style (or your favorite) from the list of available styles.</li>
																</ol>
																<p align="center">
																	<img src="Screenshot/dgAutoFormat.jpg">
																</p>
															</td>
															<td>
																...
																<TABLE WIDTH="200" BORDER="0" CELLPADDING="0" CELLSPACING="0">
																	...
																	<TR>
																		...
																		<TD width="100%" valign="top" bgcolor="#e5f2ff" class="maintext"><span class="learn">
																				<P>The Web Form DataGrid control is <a target="_blank" class="vseval" href="http://msdn.microsoft.com/library/en-us/dv_vstechart/html/vbtchTopQuestionsAboutASPNETDataGridServerControl.asp?frame=true">
																						flexible</a> and highly customizable</P>
																				<p>
																					Using the <a target="_blank" class="vseval" href="http://msdn.microsoft.com/library/en-us/vsintro7/html/vxurfDataGridDataListAutoFormatDialogBox.asp">
																						AutoFormat</a> Dialog Box
																				</p>
																				<p>
																					Get <a target="_blank" class="vseval" href="http://msdn.microsoft.com/library/en-us/dv_vstechart/html/vbtchTopQuestionsAboutASPNETDataGridServerControl.asp?frame=true">
																						common questions answered</a> about the DataGrid Web Server Control
																				</p>
																				<p>
																					Allow users to <a target="_blank" class="vseval" href="http://msdn.microsoft.com/library/en-us/vbcon/html/vbtskallowinguserstoselectitemsindatagridwebcontrol.asp">
																						select a row</a> in the Datagrid
																				</p>
																				<p>
																					How to <a target="_blank" class="vseval" href="http://support.microsoft.com/default.aspx?scid=kb;en-us;316672">
																						format data and handle null values</a> in the Datagrid
																				</p>
																			</span></TD>
