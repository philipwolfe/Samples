...
mm_menu_Step3.addMenuItem("<p class='drop'><a href='3_3.aspx'><img src='../images/arrow_dropdown.gif' border=0>&nbsp;<B>PropertyBuilder</B></a></p>");
											...
											<TR>
												<td colspan="2">
														...
														<TR>
															...
															<TD valign="top" class="maintext"><table width="500" border="0" cellspacing="0" cellpadding="0" ID="Table5">
																	<tr>
																		...
																		<td class="status"><strong>Step 3 of 4: PropertyBuilder</strong></td>
																	</tr>
																</table>
															</TD>
															<TD valign="top">
																<table width="150" border="0" cellspacing="0" cellpadding="0" ID="Table6">
																	<tr>
																		<td width="89" class="maintext"><a href="3_2.aspx"><img src="../images/navigation/previous.gif" width="89" height="24" border="0" alt="Previous Step"></a></td>
																		<td width="82" class="maintext"><a href="3_4.aspx"><img src="../images/navigation/next.gif" width="89" height="24" border="0" alt="Next Step"></a></td>
																	</tr>
																</table>
															</TD>
													...
													<TABLE WIDTH="756" BORDER="0" CELLPADDING="0" CELLSPACING="0">
														...
														<tr valign="top">
															<td width="500">
																<P>A more advanced wizard called the
																	<span class="mnu">Property Builder</span>
																	can assist you in setting various properties for your datagrid. Some of the 
																	properties you can set include:</P>
																<UL>
																	<LI>
																	Specific style options for your datagrid, as well as for specific sections such 
																	as headers, footers and row items.
																	<LI>
																	Borders, gridlines and spacing of cells
																	<LI>
																		Datasource, sorting and paging options
																	</LI>
																</UL>
																<p>We will use the
																	<span class="menu">PropertyBuilder</span>
																	to add a EditCommandColumn. An EditCommandColumn will use the first column of 
																	the datagrid to provide an
																	<span class="menu">Edit</span>
																	link to put the row into Edit mode. When in Edit mode, the column will contain
																	<span class="menu">Update</span>
																	and
																	<span class="menu">Cancel</span>
																	links.</p>
																<ol>
																	<li>
																		To access the
																		<span class="menu">Property Builder</span>, right-click on the datagrid and 
																	choose PropertyBuilder... from the menu.
																	<li>
																		On the left side, click
																		<span class="menu">Columns</span>
																	to set various column properties for the datagrid.
																	<li>
																		Notice that
																		<span class="propvalue">Create columns automatically at run time</span>
																	is checked.
																	<li>
																		Under
																		<span class="menu">Column List</span>, in the
																		<span class="menu">Available Columns</span>
																		area, expand
																		<span class="selection">ButtonColumn</span>.
																	<li>
																		Highlight
																		<span class="menucmd">Edit, Update, Cancel</span>
																		and click the <b>&gt;</b> button to move it to the
																		<span class="selection">Selected Columns</span>
																		<p align="center">
																			<img src="Screenshot/PropertyBuilder1.jpg">
																		</p>
																	<li>
																		In the Column Properties, set the
																		<span class="property">HeaderText</span>
																		property to
																		<span class="propvalue">Edit</span>.
																	<li>
																		Click
																		<span class="menucmd">OK</span>
																		to close the Property Builder.</li>
																</ol>
																<br>
																<p align="center">
																	<img src="Screenshot/PropertyBuilder2.jpg">
																</p>
															</td>
															<td>
																...
																<TABLE WIDTH="200" BORDER="0" CELLPADDING="0" CELLSPACING="0">
																	...
																	<TR>
																		...
																		<TD width="100%" valign="top" bgcolor="#e5f2ff" class="maintext"><div class="learn">
																				<p>
																					Watch a <a target="_blank" class="vseval" href="http://support.microsoft.com/default.aspx?scid=kb;en-us;328137">
																						webcast</a> to learn more about Datagrid columns and the PropertyBuilder</p>
																			</div>
																		</TD>
