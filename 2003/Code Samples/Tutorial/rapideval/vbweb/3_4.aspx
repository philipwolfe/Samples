...
mm_menu_Step3.addMenuItem("<p class='drop'><a href='3_4.aspx'><img src='../images/arrow_dropdown.gif' border=0>&nbsp;<B>Validation</B></a></p>");
											...
											<TR>
												<td colspan="2">
													<TABLE WIDTH="756" BORDER="0" CELLPADDING="0" CELLSPACING="0">
														...
														<TR>
															<TD colspan="2"><script language="JavaScript1.2">mmLoadMenus();</script><img name="navigation" src="../images/navigation/step_3_web.gif" width="756" height="61"
														...
														<TR>
															...
															<TD valign="top" class="maintext"><table width="500" border="0" cellspacing="0" cellpadding="0" ID="Table5">
																	<tr>
																		...
																		<td class="status"><strong>Step 4 of 4: Validation</strong></td>
																	</tr>
																</table>
															</TD>
															<TD valign="top">
													...
													<TABLE WIDTH="756" BORDER="0" CELLPADDING="0" CELLSPACING="0">
														...
														<tr valign="top">
															<td width="500">
																<P>A task often dreaded in Web applications is writing validation code. Validation 
																	code enforces rules ensuring that data entered into a form meets the 
																	application requirements for data types, ranges and so on. Often a mix of 
																	client-side and server-side script, validation logic can be hard to reuse 
																	effectively.</P>
																<p>To remedy this issue, ASP.NET includes a set of validation controls that provide 
																	a consistent mechanism for validating your Web application forms in an 
																	intuitive way.</p>
																<p>The
																	<span class="control">CompareValidator</span>
																	compares the data entered against a static value or a value from another field 
																	on the form. We will use one to make sure that the start date for our order 
																	search, as entered in
																	<span class="propvalue">txtStartDate</span>, is earlier than January 1st, 2001.</p>
																<ol>
																	<li>
																		Drag the
																		<span class="control">CompareValidator</span>
																	from the Toolbox onto the Web Form.
																	<li>
																		The
																		<span class="property">Display</span>
																		property is set to
																		<span class="propvalue">Static</span>
																	by default. This simply means that the error message will be rendered in the 
																	spot where we place the validator.
																	<li>
																	The free space under the Customers dropdown is a good spot to place the 
																	control.
																	<li>
																		Set the
																		<span class="property">ErrorMessage</span>
																	property to the error message you want to display, for instance "StartDate must 
																	be less than January 1, 2001".
																	<li>
																		Set the
																		<span class="property">ControlToValidate</span>
																		property to
																		<span class="propvalue">txtStartDate</span>. This property displays all the 
																	form controls in a combobox, so you may also select from the list.
																	<li>
																		Set the
																		<span class="property">Operator</span>
																		property to
																		<span class="propvalue">LessThanEqual</span>.
																	<li>
																		To properly perform comparisons, the CompareValidator must know what type of 
																		data is being compared. The options for the
																		<span class="property">Type</span>
																		property are
																		<span class="propvalue">String, Integer, Double,
		Date &amp; Currency.</span>. Choose
																		<span class="propvalue">Date</span>
																	<li>
																		Set the
																		<span class="property">ValueToCompare</span>
																		property to
																		<span class="propvalue">1/1/2001</span>
																	<li>
																		Save the Web Form.</li>
																</ol>
																<p align="center">
																	<img src="Screenshot/CompareValidator.jpg">
																</p>
															</td>
															<td>
																...
																<TABLE WIDTH="200" BORDER="0" CELLPADDING="0" CELLSPACING="0">
																	...
																	<TR>
																		...
																		<TD width="100%" valign="top" bgcolor="#e5f2ff" class="maintext"><div class="learn">
																				<p>
																					There are <a target="_blank" class="vseval" href="http://msdn.microsoft.com/library/default.asp?url=/library/en-us/vbcon/html/vbcontypesofvalidation.asp">
																						various types</a> of Validation Controls
																				</p>
																				<p>
																					<a target="_blank" class="vseval" href="http://msdn.microsoft.com/library/default.asp?url=/library/en-us/dnaspp/html/aspplusvalid.asp">
																						ASP.NET Data Validation In Depth</a>
																				</p>
																				<p>
																					Validating <a target="_blank" class="vseval" href="http://msdn.microsoft.com/library/en-us/vbcon/html/vboriWebFormsValidation.asp">
																						Web Forms</a> using the Validation Controls
																				</p>
																			</div>
																		</TD>
