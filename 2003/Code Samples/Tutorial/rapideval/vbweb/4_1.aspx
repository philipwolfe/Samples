...
mm_menu_Step4.addMenuItem("<p class='drop'><a href='4_1.aspx'><img src='../images/arrow_dropdown.gif' border=0>&nbsp;<B>Introduction</B></a></p>");
											...
											<TR>
												<td colspan="2">
														...
														<TR>
															...
															<TD valign="top" class="maintext"><table width="500" border="0" cellspacing="0" cellpadding="0" ID="Table5">
																	<tr>
																		...
																		<td class="status"><strong>Step 1 of 5: Introduction</strong></td>
																	</tr>
																</table>
															</TD>
															<TD valign="top">
													...
													<TABLE WIDTH="756" BORDER="0" CELLPADDING="0" CELLSPACING="0">
														...
														<tr valign="top">
															<td width="500">
																<P>To minimize requirements to complete this walkthrough, we have provided an XML 
																	file as a data source rather than requiring access to a database. ADO.NET has 
																	been designed to provide a consistent programming interface regardless of the 
																	source for the data, so you will write similar code when accessing a database 
																	as your data source. Meanwhile, you will learn it is very easy to work with XML 
																	files in Visual Studio .NET 2003 even if you have never worked with XML before.</P>
																<P>The XML file consists of two tables, Customers and Orders. There is a simple 
																	...
																	date, and the application will display orders placed by the selected Customer 
																	between those two dates.</P>
																We will load the XML file into an ADO.NET <A class="poplink" href="javascript:openWindow('../Pops/DataSet.htm')">
																	DataSet</A> and will populate the DropDownList and DataGrid controls using 
																the power of databinding.
																<P>ADO.NET DataSets are similar to ADO Recordsets in Visual Basic 6.0 but are 
																	...
																	dataset is defined using an XML schema file.</P>
															</td>
															<td>
																...
																<TABLE WIDTH="200" BORDER="0" CELLPADDING="0" CELLSPACING="0">
																	...
																	<TR>
																		...
																		<TD width="100%" valign="top" bgcolor="#e5f2ff" class="maintext"><div class="learn">
																				<p>
																					<a target="_blank" class="vseval" href="http://support.microsoft.com/default.aspx?scid=kb;en-us;307860">
																						Basic Information</a> about Data Binding
																				</p>
																				<p>
																					Have experience using ADO? Learn how to <a target="_blank" class="vseval" href="http://msdn.microsoft.com/library/default.asp?url=/library/en-us/dndotnet/html/adonetprogmsdn.asp">
																						transition</a> to ADO.NET
																				</p>
																				<p>
																					More in depth information <a target="_blank" class="vseval" href="http://msdn.microsoft.com/library/en-us/dndotnet/html/usingadonet.asp?frame=true">
																						for the ADO programmer</a>
																				</p>
																				<p>
																					Already using ADO.NET? Learn some <a target="_blank" class="vseval" href="http://msdn.microsoft.com/library/en-us/dnadonet/html/adonetbest.asp">
																						best practices</a>
																				</p>
																			</div>
																		</TD>
