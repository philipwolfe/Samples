...
mm_menu_Step4.addMenuItem("<p class='drop'><a href='4_2.aspx'><img src='../images/arrow_dropdown.gif' border=0>&nbsp;<B>Add Data Files</B></a></p>");
											...
											<TR>
												<td colspan="2">
													<TABLE WIDTH="756" BORDER="0" CELLPADDING="0" CELLSPACING="0">
														...
														<TR>
															<TD colspan="2"><script language="JavaScript1.2">mmLoadMenus();</script><img name="navigation" src="../images/navigation/step_4_web.gif" width="756" height="61"
														...
														<TR>
															...
															<TD valign="top" class="maintext"><table width="500" border="0" cellspacing="0" cellpadding="0" ID="Table5">
																	<tr>
																		...
																		<td class="status"><strong>Step 2 of 5: Add Data Files</strong></td>
																	</tr>
																</table>
															</TD>
															<TD valign="top">
													...
													<TABLE WIDTH="756" BORDER="0" CELLPADDING="0" CELLSPACING="0">
														...
														<tr valign="top">
															<td width="500">
																<ol>
																	<LI>
																		To get started implementing data access in this walkthrough, <A class="vseval" href="../Downloads/VSRapidEval.zip">
																			download</A>
																	...
																	<LI>
																	After the download completes, extract the files to a directory of your choice 
																	but make a note of the location.
																	<LI>
																		Go back to Visual Studio .NET 2003 and in
																		<SPAN class="heading">Solution 
Explorer</SPAN>, right-click on the
																		<SPAN class="propvalue">OrdersWebVB</SPAN>
																		project. From the submenu, choose
																		<SPAN class="menucmd">Add - Add Existing Item</SPAN>. Find the
																		<SPAN class="selection">CustOrder.xml</SPAN>
																		and
																		<SPAN class="selection">dsCustOrder.xsd</SPAN>
																		files and add them to the project so we have data and a definition for our 
																		DataSet. You may need to choose to "Show All Files.</LI>
																</ol>
																<p>In order for Datagrid editing to work, the account that the web site uses 
																	(ASPNET user) must have necessary permissions to write to the XML file. As a 
																	good security practice, the ASPNET user has very limited permissions by 
																	default. You must explicitly grant permissions for the ASPNET user account to 
																	modify the CustOrder.xml file. These are general instructions and the process 
																	may vary slightly depending upon your operating system. For further help, 
																	contact your system administrator.</p>
																<ol>
																	<li>
																		In Windows Explorer, find the directory of this sample project. By default the 
																		path will be <b>C:\\inetPub\wwwRoot\OrdersWebVB\</b>
																	<li>
																	The CustOrder.xml file you just added will be in this directory.
																	<li>
																		Right-click the CustOrder.xml file and choose
																		<span class="menu">Properties</span>
																	<li>
																		Click the
																		<span class="menu">Security</span>
																	tab.
																	<li>
																		Click
																		<span class="menu">Add</span>
																	and find the ASPNET local user account. Add the account to the list of accounts 
																	with permissions.
																	<li>
																		With the ASPNET user account still highlighted in the list, make sure to grant 
																		at least
																		<span class="selection">Modify</span>
																	permissions
																	<li>
																		Close out of the File Properties dialog box and continue building the 
																		application.</li>
																</ol>
																<p>(Note: If you get stuck on this step, you can return to it later. All of the 
																	functions of this sample other than updating will still work fine.)</p>
																<P align="center">
																	<IMG src="Screenshot/Security.jpg">
																</P>
															</td>
															<td>
																...
																<TABLE WIDTH="200" BORDER="0" CELLPADDING="0" CELLSPACING="0">
																	...
																	<TR>
																		...
																		<TD width="100%" valign="top" bgcolor="#e5f2ff" class="maintext"><div class="learn">
																				<p>
																					<a target="_blank" class="vseval" href="http://msdn.microsoft.com/library/en-us/dnadvnet/html/vbnet06252002.asp">
																						ADO.NET and XML: Two Great Tastes That Go Great Together</a>
																				</p>
																				<p>All you need to know to <a target="_blank" class="vseval" href="http://msdn.microsoft.com/library/default.asp?url=/library/en-us/dnnetsec/html/SecNetHT01.asp">
																						secure ASP.NET applications</a>
																				<p>Best practices for security in <a target="_blank" class="vseval" href="http://msdn.microsoft.com/library/default.asp?url=/library/en-us/dnnetsec/html/openhack.asp">
																						Internet Information Server and ASP.NET</a>
																				<p>Understanding <a target="_blank" class="vseval" href="http://support.microsoft.com/default.aspx?scid=kb%3Ben-us%3B317012">
																						security and identity</a> in ASP.NET</p>
																			</div>
																		</TD>
