...
mm_menu_Step4.addMenuItem("<p class='drop'><a href='4_3.aspx'><img src='../images/arrow_dropdown.gif' border=0>&nbsp;<B>Define Dataset</B></a></p>");
														...
														<TR>
															...
															<TD valign="top" class="maintext"><table width="500" border="0" cellspacing="0" cellpadding="0" ID="Table5">
																	<tr>
																		...
																		<td class="status"><strong>Step 3 of 5: Define Dataset</strong></td>
																	</tr>
																</table>
															</TD>
															<TD valign="top">
														...
														<tr valign="top">
															<td width="500">
																<ol>
																	...
																	to open a visual designer displaying the Customer and Orders tables and the 
																	...
																	<li>
																		...
																		elsewhere in our project. From the
																		<span class="menu">Schema</span>
																		menu, choose
																		<span class="menucmd">Generate 
		DataSet</span>.
																	<li>
																		Save the DataSet</li>
																</ol>
																...
																<TABLE WIDTH="200" BORDER="0" CELLPADDING="0" CELLSPACING="0">
																	...
																	<TR>
																		...
																		<TD width="100%" valign="top" bgcolor="#e5f2ff" class="maintext"><div class="learn">
																				<p>
																					Get a <a target="_blank" class="vseval" href="http://msdn.microsoft.com/library/en-us/dnadvnet/html/vbnet05142002.asp">
																						gentle introduction</a> to XML
																				</p>
																				<p>
																					Dig deeper into <a target="_blank" class="vseval" href="http://msdn.microsoft.com/library/en-us/vbcon/html/vburfWorkingWithXMLDataSchemas.asp">
																						XML Schemas</a>
																				</p>
																				<p>
																					Visual Studio .NET lets you create DataSets <a target="_blank" class="vseval" href="http://msdn.microsoft.com/library/en-us/vbcon/html/vbconADONETDataSetCreationInVisualStudioNET.asp">
																						visually</a>
																				</p>
																			</div>
																		</TD>
