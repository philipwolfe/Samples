...
mm_menu_Step4.addMenuItem("<p class='drop'><a href='4_4.aspx'><img src='../images/arrow_dropdown.gif' border=0>&nbsp;<B>Dropdown Properties</B></a></p>");
												...
												<td colspan="2">
														...
														<TR>
															...
															<TD valign="top" class="maintext"><table width="500" border="0" cellspacing="0" cellpadding="0" ID="Table5">
																	<tr>
																		...
																		<td class="status"><strong>Step 4 of 5: Dropdown Properties</strong></td>
																	</tr>
																</table>
															</TD>
															<TD valign="top">
																<table width="150" border="0" cellspacing="0" cellpadding="0" ID="Table6">
																	<tr>
																		...
																		<td width="82" class="maintext"><a href="4_5.aspx"><img src="../images/navigation/next.gif" width="89" height="24" border="0" alt="Next Step"></a></td>
																	</tr>
																</table>
															</TD>
													...
													<TABLE WIDTH="756" BORDER="0" CELLPADDING="0" CELLSPACING="0">
														...
														<tr valign="top">
															<td width="500">
																<P>The
																	<span class="propvalue">ddlCustomers</span>
																	<span class="control">DropDownList</span>
																	will use the data from the Customers table in our DataSet. The DropdownList has 
																	4 properties that need to be set in order to bind the data.</P>
																<ol>
																	<li>
																		Click
																		<span class="propvalue">ddlCustomers</span>
																	...
																	<li>
																		...
																		property to
																		<span class="propvalue">dsOrders</span>
																	<li>
																		Set the
																		<span class="property">DataMember</span>
																		property to
																		<span class="propvalue">Customers</span>
																	<li>
																		Set the
																		<span class="property">DataTextField</span>
																		property to
																		<span class="propvalue">CompanyName</span>
																	<li>
																		Set the
																		<span class="property">DataValueField</span>
																		property to
																		<span class="propvalue">CustomerID</span></li>
																</ol>
																<p align="center">
																	<img src="Screenshot/ddlDatasource.jpg">
																</p>
															</td>
															<td>
																...
																<TABLE WIDTH="200" BORDER="0" CELLPADDING="0" CELLSPACING="0">
																	...
																	<TR>
																		...
																		<TD width="100%" valign="top" bgcolor="#e5f2ff" class="maintext"><div class="learn">
																				<p>
																					Add <a target="_blank" class="vseval" href="http://msdn.microsoft.com/library/en-us/vbcon/html/vbtskaddingdropdownlisttowebformspage.asp">
																						DropDownList Controls</a>
																				to your Web Form
																				<p>More on <a target="_blank" class="vseval" href="http://msdn.microsoft.com/library/default.asp?url=/library/en-us/dv_vbcode/html/vbtskcodepopulatinglistboxordropdownlistcontrolfromdatasetvisualbasic.asp">
																						populating a DropDownList</a> control from a DataSet</p>
																			</div>
																		</TD>
