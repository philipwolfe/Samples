...
mm_menu_Step4.addMenuItem("<p class='drop'><a href='4_5.aspx'><img src='../images/arrow_dropdown.gif' border=0>&nbsp;<B>Dataset Properties</B></a></p>");
														...
														<TR>
															...
															<TD valign="top" class="maintext"><table width="500" border="0" cellspacing="0" cellpadding="0" ID="Table5">
																	<tr>
																		...
																		<td class="status"><strong>Step 5 of 5: Dataset Properties</strong></td>
																	</tr>
																</table>
															</TD>
															<TD valign="top">
																<table width="150" border="0" cellspacing="0" cellpadding="0" ID="Table6">
																	<tr>
																		<td width="89" class="maintext"><a href="4_4.aspx"><img src="../images/navigation/previous.gif" width="89" height="24" border="0" alt="Previous Step"></a></td>
																		<td width="82" class="maintext"><a href="5_1.aspx"><img src="../images/navigation/next.gif" width="89" height="24" border="0" alt="Next Step"></a></td>
																	</tr>
																</table>
															</TD>
														...
														<tr valign="top">
															<td width="500">
																<P>Our
																	...
																	will use data from the Orders table, but the purpose of our application is to 
																	find only a subset of that data. ADO.NET introduces a useful concept called a 
																	DataView. A DataView is exactly what it sounds like, a particular view on your 
																	data. Think of it as a filter based on certain criteria you choose. For 
																	instance, all customers from a certain state or all orders from a certain date 
																	range, like the application we are building. We will explore how to create a 
																	dataview when we add the code.</P>
																<ol>
																	<li>
																	We are going to name our dataview dvOrders and it will be the source of data 
																	for our DataGrid.
																	<li>
																		Click the
																		<span class="propvalue">dgOrders</span>
																	DataGrid to view properties.
																	<li>
																	We will be setting 3 properties.
																	<li>
																		Set the
																	...
																	<li>
																		Set the
																		<span class="property">DataMember</span>
																		property to
																		<span class="propvalue">Orders</span>
																	<li>
																		Set the
																		<span class="property">DataKeyField</span>
																		property to
																		<span class="propvalue">OrderID</span></li>
																</ol>
																<p align="center">
																	<img src="Screenshot/dgDatasource.jpg">
																</p>
															</td>
															<td>
																...
																<TABLE WIDTH="200" BORDER="0" CELLPADDING="0" CELLSPACING="0">
																	...
																	<TR>
																		...
																		<TD width="100%" valign="top" bgcolor="#e5f2ff" class="maintext"><div class="learn">
																				<p>
																					How to <a target="_blank" class="vseval" href="http://msdn.microsoft.com/library/en-us/dv_vbCode/html/vbtskCodeExampleFilteringDataInDataView.asp">
																						filter data </a>in a DataView
																				</p>
																				<p>
																					What is this <a target="_blank" class="vseval" href="http://msdn.microsoft.com/library/default.asp?url=/library/en-us/cpguide/html/cpcongeneratingstronglytypeddataset.asp">
																						Typed DataSet</a> I've heard about?
																				</p>
																				<p>
																					Gain a better understanding of <a target="_blank" class="vseval" href="http://msdn.microsoft.com/library/en-us/vbcon/html/vboriCreatingSchemasDataSets.asp">
																						XML Schemas</a> and how they relate to DataSets
																				</p>
																				<p>
																					Learn the power of <a target="_blank" class="vseval" href="http://msdn.microsoft.com/library/en-us/cpguide/html/cpconcreatingusingdataviews.asp">
																						DataViews</a>
																				</p>
																			</div>
																		</TD>
