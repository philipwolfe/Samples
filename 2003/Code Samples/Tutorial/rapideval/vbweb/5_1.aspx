...
mm_menu_Step5.addMenuItem("<p class='drop'><a href='5_1.aspx'><img src='../images/arrow_dropdown.gif' border=0>&nbsp;<B>Introduction</B></a></p>");
											...
											<TR>
												<td colspan="2">
														...
														<TR>
															...
															<TD valign="top" class="maintext"><table width="500" border="0" cellspacing="0" cellpadding="0" ID="Table5">
																	<tr>
																		...
																		<td class="status"><strong>Step 1 of 7: Introduction</strong></td>
																	</tr>
																</table>
															</TD>
															<TD valign="top">
																<table width="150" border="0" cellspacing="0" cellpadding="0" ID="Table6">
																	<tr>
																		<td width="89" class="maintext"><a href="4_5.aspx"><img src="../images/navigation/previous.gif" width="89" height="24" border="0" alt="Previous Step"></a></td>
																		<td width="82" class="maintext"><a href="5_2.aspx"><img src="../images/navigation/next.gif" width="89" height="24" border="0" alt="Next Step"></a></td>
																	</tr>
																</table>
															</TD>
													...
													<TABLE WIDTH="756" BORDER="0" CELLPADDING="0" CELLSPACING="0">
														...
														<tr valign="top">
															<td width="500">
																<P>Thus far, we've used the Web Form designer to add controls to our form and set 
																	some properties. This should be familiar to anyone who has used Visual Basic 
																	6.0.</P>
																<p>With ASP.NET, our code is compiled so we get much better performance, debugging, 
																	error handling and other benefits. Visual Studio .NET uses the concept of a 
																	code-behind file to separate the presentation and logic of your page into 
																	separate files. The aspx file contains your user interface code (html and 
																	controls). The Visual Basic .NET source file containing code sits "behind" your 
																	aspx page, hence the name "code-behind".</p>
																<ol>
																	<li>
																		Press
																		<span class="key">F7</span>
																		to display the Visual Studio .NET <a href="javascript:openWindow('../Pops/CodeEditor.htm')" class="poplink">
																			code editor</a>. You can also right-click the Web Form in the designer and 
																		select
																		<span class="menucmd">View Code</span>This is similar to toggling between 
																	"View Code" and "View Form" when building a Visual Basic 6.0 form.
																	<li>
																		At the top of the file, you will see a Class declared that has the same name as 
																		your Web Form.
																		<br>
																		<pre class="csharpcode">
<span class="kwrd">Public</span> <span class="kwrd">Class</span> WebForm1
    <span class="kwrd">Inherits</span> System.Web.UI.Page</pre>
																	<li>
																		Declare 2 variables to hold the <a href="javascript:openWindow('../Pops/DataSet.htm')" class="poplink">
																			DataSet</a> and <a href="javascript:openWindow('../Pops/Dataview.htm')" class="poplink">
																			Dataview</a>. Class level variables are generally declared at the top of 
																		the class. Add the following code after the line with
																		<span class="kwrd">Inherits</span>.
																		<pre class="csharpcode">
<span class="kwrd">Protected</span> dvOrders <span class="kwrd">As</span> <span class="kwrd">New</span> DataView
<span class="kwrd">Protected</span> <span class="kwrd">WithEvents</span> dsOrders <span class="kwrd">As</span> <span class="kwrd">New</span> dsCustOrder</pre>
																	<li>
																		Throughout this step you will add code to your code-behind file. As a general 
																		rule of thumb, just paste it between the
																		<span class="kwrd">Public</span>
																		<span class="kwrd">Class</span>
																		WebForm1 and
																		<span class="kwrd">End</span>
																		<span class="kwrd">Class</span>
																		statements and you will be fine.</li>
																</ol>
																<P></P>
															</td>
															<td>
																...
																<TABLE WIDTH="200" BORDER="0" CELLPADDING="0" CELLSPACING="0">
																	...
																	<TR>
																		...
																		<TD width="100%" valign="top" bgcolor="#e5f2ff" class="maintext"><div class="learn">
																				<p>What is <a target="_blank" class="vseval" href="http://support.microsoft.com/default.aspx?scid=kb%3ben-us%3b303247">
																						code-behind</a>?</p>
																				<P>Code-behind files can also help promote <a target="_blank" class="vseval" href="http://msdn.microsoft.com/msdnmag/issues/01/08/cutting/default.aspx">
																						reusability</a></P>
																				<p>
																					<a target="_blank" class="vseval" href="http://msdn.microsoft.com/msdnmag/issues/01/08/cutting/default.aspx">
																						Reusability in ASP .NET: Code-behind Classes and Pagelets</a>
																				</p>
																				<p>
																					<a target="_blank" class="vseval" href="http://msdn.microsoft.com/library/default.asp?url=/library/en-us/vbcon/html/vbconWebFormsEventModel.asp">
																						ASP.NET Server Control Event Model</a>
																				</p>
																			</div>
																		</TD>
