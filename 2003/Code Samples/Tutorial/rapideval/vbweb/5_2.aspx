...
mm_menu_Step5.addMenuItem("<p class='drop'><a href='5_2.aspx'><img src='../images/arrow_dropdown.gif' border=0>&nbsp;<B>Page Load</B></a></p>");
...
//-->
	...
	<body bgColor="#000066" leftMargin="0" topMargin="0" marginwidth="0" marginheight="0">
											...
											<TR>
												<td colspan="2">
														...
														<TR>
															...
															<TD valign="top" class="maintext"><table width="500" border="0" cellspacing="0" cellpadding="0" ID="Table5">
																	<tr>
																		...
																		<td class="status"><strong>Step 2 of 7: Page Load</strong></td>
																	</tr>
																</table>
															</TD>
															<TD valign="top">
																<table width="150" border="0" cellspacing="0" cellpadding="0" ID="Table6">
																	<tr>
																		<td width="89" class="maintext"><a href="5_1.aspx"><img src="../images/navigation/previous.gif" width="89" height="24" border="0" alt="Previous Step"></a></td>
																		<td width="82" class="maintext"><a href="5_3.aspx"><img src="../images/navigation/next.gif" width="89" height="24" border="0" alt="Next Step"></a></td>
																	</tr>
																</table>
															</TD>
													...
													<TABLE WIDTH="756" BORDER="0" CELLPADDING="0" CELLSPACING="0">
														...
														<tr valign="top">
															<td width="500">
																<P>You should see one subroutine declared called
																	<span class="selection">Page_Load</span>. The code in this routine will run 
																	each time the page is loaded in a browser. Paste the following code into the 
																	Page_Load routine.</P>
																<pre class="csharpcode">

        dsOrders.ReadXml(Server.MapPath(<span class="str">"CustOrder.xml"</span>))
        <span class="kwrd">If</span> <span class="kwrd">Not</span> IsPostBack <span class="kwrd">Then</span>
        ...
        <span class="kwrd">End</span> <span class="kwrd">If</span>
																...
																<p>Notice that loading the XML file into the DataSet only takes one line of code!</p>
																<p>You might wonder what the line
																	<pre class="csharpcode">
<span class="kwrd">If</span> <span class="kwrd">Not</span> IsPostBack <span class="kwrd">Then</span>
</pre>
																is doing. This logic allows you to only run code the first time the page loads. 
																Sometimes you don't want code to run again after a user clicks a button and 
																reloads the page.
																<P></P>
															</td>
															<td>
																...
																<TABLE WIDTH="200" BORDER="0" CELLPADDING="0" CELLSPACING="0">
																	...
																	<TR>
																		...
																		<TD width="100%" valign="top" bgcolor="#e5f2ff" class="maintext"><div class="learn">
																				<p>Tell me about the ASP.NET <a target="_blank" class="vseval" href="http://support.microsoft.com/default.aspx?scid=kb;en-us;305141">
																						page framework</a>
																				<p>What is the <a target="_blank" class="vseval" href="http://msdn.microsoft.com/library/default.asp?url=/library/en-us/vbcon/html/vbconWebFormsPageProcessingStages.asp">
																						lifecycle of a page</a>?</p>
																			</div>
																		</TD>
