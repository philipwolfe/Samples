...
mm_menu_Step5.addMenuItem("<p class='drop'><a href='5_3.aspx'><img src='../images/arrow_dropdown.gif' border=0>&nbsp;<B>Calendars</B></a></p>");
														...
														<TR>
															...
															<TD valign="top" class="maintext"><table width="500" border="0" cellspacing="0" cellpadding="0" ID="Table5">
																	<tr>
																		...
																		<td class="status"><strong>Step 3 of 7: Calendars</strong></td>
																	</tr>
																</table>
															</TD>
															<TD valign="top">
																<table width="150" border="0" cellspacing="0" cellpadding="0" ID="Table6">
																	<tr>
																		<td width="89" class="maintext"><a href="5_2.aspx"><img src="../images/navigation/previous.gif" width="89" height="24" border="0" alt="Previous Step"></a></td>
																		<td width="82" class="maintext"><a href="5_4.aspx"><img src="../images/navigation/next.gif" width="89" height="24" border="0" alt="Next Step"></a></td>
																	</tr>
																</table>
															</TD>
														...
														<tr valign="top">
															<td width="500">
																<p>The
																	...
																	control can fire off code each time a new date is selected. This is useful for 
																	loading data or changing the properties of another control.</p>
																<ol>
																	<li>
																		Paste the following code into the code-behind file
																		<pre class="csharpcode">
<span class="kwrd">Private</span> <span class="kwrd">Sub</span> OrderDateStart_SelectionChanged(_
     <span class="kwrd">ByVal</span> sender <span class="kwrd">As</span> System.<span class="kwrd">Object</span>, _
     <span class="kwrd">ByVal</span> e <span class="kwrd">As</span> System.EventArgs) _
     <span class="kwrd">Handles</span> OrderDateStart.SelectionChanged

        txtStartDate.Text = _
          OrderDateStart.SelectedDate.ToShortDateString

<span class="kwrd">End</span> <span class="kwrd">Sub</span>

<span class="kwrd">Private</span> <span class="kwrd">Sub</span> OrderDateEnd_SelectionChanged(_
    <span class="kwrd">ByVal</span> sender <span class="kwrd">As</span> System.<span class="kwrd">Object</span>, _
    <span class="kwrd">ByVal</span> e <span class="kwrd">As</span> System.EventArgs) _
    <span class="kwrd">Handles</span> OrderDateEnd.SelectionChanged

        txtEndDate.Text = _
          OrderDateEnd.SelectedDate.ToShortDateString

<span class="kwrd">End</span> Sub</pre>
																	<li>
																		This code simply demonstrates how straightforward it is to get the currently 
																		selected date from the calendar and use it in your code. Here we are simply 
																		setting the
																		<span class="propvalue">Text</span>
																		property of the TextBoxes, but you could also use it to update or retrieve 
																		records from a database.</li>
																</ol>
															</td>
															<td>
																...
																<TABLE WIDTH="200" BORDER="0" CELLPADDING="0" CELLSPACING="0">
																	...
																	<TR>
																		...
																		<TD width="100%" valign="top" bgcolor="#e5f2ff" class="maintext"><div class="learn">
																				<p>The ASP.NET QuickStarts can <a target="_blank" class="vseval" href="http://samples.gotdotnet.com/quickstart/aspplus/samples/webforms/ctrlref/webctrl/calendar/doc_cal.aspx">
																						teach you more</a> about working with the Calendar control</p>
																			</div>
																		</TD>
