...
mm_menu_Step5.addMenuItem("<p class='drop'><a href='5_5.aspx'><img src='../images/arrow_dropdown.gif' border=0>&nbsp;<B>Format Date</B></a></p>");
											...
											<TR>
												<td colspan="2">
														...
														<TR>
															...
															<TD valign="top" class="maintext"><table width="500" border="0" cellspacing="0" cellpadding="0" ID="Table5">
																	<tr>
																		...
																		<td class="status"><strong>Step 5 of 7: Format Date</strong></td>
																	</tr>
																</table>
															</TD>
															<TD valign="top">
																<table width="150" border="0" cellspacing="0" cellpadding="0" ID="Table6">
																	<tr>
																		<td width="89" class="maintext"><a href="5_4.aspx"><img src="../images/navigation/previous.gif" width="89" height="24" border="0" alt="Previous Step"></a></td>
																		<td width="82" class="maintext"><a href="5_6.aspx"><img src="../images/navigation/next.gif" width="89" height="24" border="0" alt="Next Step"></a></td>
																	</tr>
																</table>
															</TD>
													...
													<TABLE WIDTH="756" BORDER="0" CELLPADDING="0" CELLSPACING="0">
														...
														<tr valign="top">
															<td width="500">
																<p>The DataGrid exposes events that allow you to format the data before it is 
																	displayed. Using the ItemDataBound event, we can format the OrderDate field 
																	using a standard format, such as ShortDate.</p>
																<p>Paste this function into your code-behind.</p>
																<pre class="csharpcode">
<span class="kwrd">Private</span> <span class="kwrd">Sub</span> dgOrders_ItemDataBound(<span class="kwrd">ByVal</span> sender <span class="kwrd">As</span> <span class="kwrd">Object</span>, _
     <span class="kwrd">ByVal</span> e <span class="kwrd">As</span> System.Web.UI.WebControls.DataGridItemEventArgs) _
     <span class="kwrd">Handles</span> dgOrders.ItemDataBound

        <span class="kwrd">Dim</span> itemType <span class="kwrd">As</span> ListItemType
        <span class="kwrd">Dim</span> intCell <span class="kwrd">As</span> TableCell

        itemType = <span class="kwrd">CType</span>(e.Item.ItemType, ListItemType)

        <span class="kwrd">If</span> ((itemType = ListItemType.Item) <span class="kwrd">Or</span> _
                (itemType = ListItemType.AlternatingItem)) <span class="kwrd">Then</span>
            intCell = e.Item.Cells(3)
            intCell.Text = Format(intCell.Text, <span class="str">"Short Date"</span>)
																...
																<TABLE WIDTH="200" BORDER="0" CELLPADDING="0" CELLSPACING="0">
																	...
																	<TR>
																		...
																		<TD width="100%" valign="top" bgcolor="#e5f2ff" class="maintext"><div class="learn">
																				<p>More <a target="_blank" class="vseval" href="http://msdn.microsoft.com/library/default.asp?url=/library/en-us/dv_vbCode/html/vbtskCodeCustomizingItemsDynamicallyInDataListWebControlVisualBasic.asp">
																						examples</a> of using ItemDataBound to customize Datagrid items.</p>
																				<p>Probe a little deeper into the <a target="_blank" class="vseval" href="http://msdn.microsoft.com/library/default.asp?url=/library/en-us/cpref/html/frlrfsystemwebuiwebcontrolsdatagridclassitemdataboundtopic.asp">
																						ItemDataBound</a> event</p>
																			</div>
																		</TD>
