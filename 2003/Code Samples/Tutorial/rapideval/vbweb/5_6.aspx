...
mm_menu_Step5.addMenuItem("<p class='drop'><a href='5_6.aspx'><img src='../images/arrow_dropdown.gif' border=0>&nbsp;<B>Datagrid Paging</B></a></p>");
											...
											<TR>
												<td colspan="2">
														...
														<TR>
															...
															<TD valign="top" class="maintext"><table width="500" border="0" cellspacing="0" cellpadding="0" ID="Table5">
																	<tr>
																		...
																		<td class="status"><strong>Step 6 of 7: Datagrid Paging</strong></td>
																	</tr>
																</table>
															</TD>
															<TD valign="top">
																<table width="150" border="0" cellspacing="0" cellpadding="0" ID="Table6">
																	<tr>
																		<td width="89" class="maintext"><a href="5_5.aspx"><img src="../images/navigation/previous.gif" width="89" height="24" border="0" alt="Previous Step"></a></td>
																		<td width="82" class="maintext"><a href="5_7.aspx"><img src="../images/navigation/next.gif" width="89" height="24" border="0" alt="Next Step"></a></td>
																	</tr>
																</table>
															</TD>
													...
													<TABLE WIDTH="756" BORDER="0" CELLPADDING="0" CELLSPACING="0">
														...
														<tr valign="top">
															<td width="500">
																<p>When allowing a user to browse through a set of data, it is often useful to 
																	break the data up into manageable chunks. This is called "paging" through data 
																	and is often used in search engines. In the past, the code required to do this 
																	was often difficult to implement.</p>
																<p>Paging functionality is built right into the ASP.NET Datagrid and is simple to 
																	implement.</p>
																<ol>
																	<li>
																		Press
																		<span class="key">Shift-F7</span>
																	to move back into the Web Form designer.
																	<li>
																	Highlight the dgOrders DataGrid so that you can view the Properties.
																	<li>
																	In Properties, you will see a section called Paging.
																	<li>
																		Set the
																		<span class="property">AllowPaging</span>
																		property to
																		<span class="propvalue">True</span>
																	<li>
																		Set the
																		<span class="property">PageSize</span>
																		property to
																		<span class="propvalue">5</span>
																	<li>
																		Press
																		<span class="key">F7</span>
																	to move back into the code-behind file.
																	<li>
																		Paste the code below into the code-behind file.</li>
																</ol>
																<pre class="csharpcode">
<span class="kwrd">Protected</span> <span class="kwrd">Sub</span> dgOrders_PageIndexChanged(<span class="kwrd">ByVal</span> source <span class="kwrd">As</span> <span class="kwrd">Object</span>, _
     <span class="kwrd">ByVal</span> e <span class="kwrd">As</span> System.Web.UI.WebControls.DataGridPageChangedEventArgs) _
     <span class="kwrd">Handles</span> dgOrders.PageIndexChanged
																...
																<TABLE WIDTH="200" BORDER="0" CELLPADDING="0" CELLSPACING="0">
																	...
																	<TR>
																		...
																		<TD width="100%" valign="top" bgcolor="#e5f2ff" class="maintext"><div class="learn">
																				<p>Various <a target="_blank" class="vseval" href="http://msdn.microsoft.com/library/default.asp?url=/library/en-us/vbcon/html/vbtskSpecifyingPagingBehaviorInDataGridWebControl.asp">
																						paging</a> options available for the Datagrid</p>
																			</div>
																		</TD>
