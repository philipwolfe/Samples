...
mm_menu_Step5.addMenuItem("<p class='drop'><a href='5_7.aspx'><img src='../images/arrow_dropdown.gif' border=0>&nbsp;<B>Datagrid Editing</B></a></p>");
											...
											<TR>
												<td colspan="2">
														...
														<TR>
															...
															<TD valign="top" class="maintext"><table width="500" border="0" cellspacing="0" cellpadding="0" ID="Table5">
																	<tr>
																		...
																		<td class="status"><strong>Step 7 of 7: Datagrid Editing</strong></td>
																	</tr>
																</table>
															</TD>
															<TD valign="top">
																<table width="150" border="0" cellspacing="0" cellpadding="0" ID="Table6">
																	<tr>
																		<td width="89" class="maintext"><a href="5_6.aspx"><img src="../images/navigation/previous.gif" width="89" height="24" border="0" alt="Previous Step"></a></td>
																		<td width="82" class="maintext"><a href="6_1.aspx"><img src="../images/navigation/next.gif" width="89" height="24" border="0" alt="Next Step"></a></td>
																	</tr>
																</table>
															</TD>
													...
													<TABLE WIDTH="756" BORDER="0" CELLPADDING="0" CELLSPACING="0">
														...
														<tr valign="top">
															<td width="500">
																<p>The DataGrid has built-in support for editing of data. The EditCommandColumn has 
																	already been added using the PropertyBuilder. The code to get this all to work 
																	is actually surprisingly simple.
																	<ol>
																		<li>
																			When the Edit link is clicked, the DataGrid is put into Edit mode. The
																			<span class="property">EditItemIndex</span>
																		of the DataGrid determines which row is currently being edited.
																		<li>
																			Setting the EditItemIndex to
																			<span class="propvalue">-1</span>
																		puts the DataGrid back into standard display mode. We do this to cancel editing 
																		and also after we are finished editing.
																		<li>
																			Paste the dgOrders_CancelCommand code for the CancelCommand.
																			<pre class="csharpcode">
<span class="kwrd">Private</span> <span class="kwrd">Sub</span> dgOrders_CancelCommand(<span class="kwrd">ByVal</span> source <span class="kwrd">As</span> <span class="kwrd">Object</span>, _
    <span class="kwrd">ByVal</span> e <span class="kwrd">As</span> System.Web.UI.WebControls.DataGridCommandEventArgs) _
    <span class="kwrd">Handles</span> dgOrders.CancelCommand
...
<span class="kwrd">End</span> <span class="kwrd">Sub</span></pre>
																		<li>
																		Paste the dgOrders_EditCommand code for the EditCommand.
																		<li>
																			Paste the dgOrders_UpdateCommand to update of the XML file.</li>
																	</ol>
																	<pre class="csharpcode">
    <span class="kwrd">Private</span> <span class="kwrd">Sub</span> dgOrders_EditCommand(<span class="kwrd">ByVal</span> source <span class="kwrd">As</span> <span class="kwrd">Object</span>, _
        <span class="kwrd">ByVal</span> e <span class="kwrd">As</span> System.Web.UI.WebControls.DataGridCommandEventArgs) _
        <span class="kwrd">Handles</span> dgOrders.EditCommand
    ...
    <span class="kwrd">Private</span> <span class="kwrd">Sub</span> dgOrders_UpdateCommand(<span class="kwrd">ByVal</span> source <span class="kwrd">As</span> <span class="kwrd">Object</span>, _
        <span class="kwrd">ByVal</span> e <span class="kwrd">As</span> System.Web.UI.WebControls.DataGridCommandEventArgs) _
        <span class="kwrd">Handles</span> dgOrders.UpdateCommand


        <span class="kwrd">Dim</span> key <span class="kwrd">As</span> <span class="kwrd">Integer</span> = _
          Convert.ToInt32(dgOrders.DataKeys(e.Item.ItemIndex))
        <span class="kwrd">Dim</span> r <span class="kwrd">As</span> dsCustOrder.OrdersRow

        r = dsOrders.Orders.FindByOrderID(key)

        r.CustomerID = <span class="kwrd">CType</span>(e.Item.Cells(2).Controls(0), TextBox).Text
        r.OrderDate = _
          Convert.ToDateTime(<span class="kwrd">CType</span>(e.Item.Cells(3).Controls(0), TextBox).Text)
        r.ShipName = <span class="kwrd">CType</span>(e.Item.Cells(4).Controls(0), TextBox).Text
        r.ShipAddress = <span class="kwrd">CType</span>(e.Item.Cells(5).Controls(0), TextBox).Text
        r.ShipCity = <span class="kwrd">CType</span>(e.Item.Cells(6).Controls(0), TextBox).Text
        r.ShipRegion = <span class="kwrd">CType</span>(e.Item.Cells(7).Controls(0), TextBox).Text
        r.ShipPostalCode = <span class="kwrd">CType</span>(e.Item.Cells(8).Controls(0), TextBox).Text

        dsOrders.AcceptChanges()
        dsOrders.WriteXml(Server.MapPath(<span class="str">"CustOrder.xml"</span>))
																...
																<TABLE WIDTH="200" BORDER="0" CELLPADDING="0" CELLSPACING="0">
																	...
																	<TR>
																		...
																		<TD width="100%" valign="top" bgcolor="#e5f2ff" class="maintext"><div class="learn">
																				<p>Lots of information about <a target="_blank" class="vseval" href="http://samples.gotdotnet.com/quickstart/aspplus/doc/webdataaccess.aspx">
																						editing the Datagrid</a> in the ASP.NET QuickStarts</p>
																				<p>
																					Here are the <a target="_blank" class="vseval" href="http://msdn.microsoft.com/library/en-us/dv_vstechart/html/vbtchTopQuestionsAboutASPNETDataGridServerControl.asp?frame=true">
																						top questions</a> people ask about the DataGrid
																				</p>
																			</div>
																		</TD>
