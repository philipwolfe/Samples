...
mm_menu_Step6.addMenuItem("<p class='drop'><a href='6_2.aspx'><img src='../images/arrow_dropdown.gif' border=0>&nbsp;<B>Test Sample Validation</B></a></p>");
														...
														<TR>
															...
															<TD valign="top">
																<table width="150" border="0" cellspacing="0" cellpadding="0" ID="Table6">
																	<tr>
																		<td width="89" class="maintext"><a href="6_1.aspx"><img src="../images/navigation/previous.gif" width="89" height="24" border="0" alt="Previous Step"></a></td>
																		<td width="82" class="maintext"><a href="6_3.aspx"><img src="../images/navigation/next.gif" width="89" height="24" border="0" alt="Next Step"></a></td>
																	</tr>
																</table>
															</TD>
													...
													<TABLE WIDTH="756" BORDER="0" CELLPADDING="0" CELLSPACING="0">
														...
														<tr valign="top">
															<td width="500">
																<ol>
																	<li>
																		Enter a Start Date greater than 1/1/2001. Click the
																		<span class="propValue">Show Orders</span>
																		button. Notice that the error message appears under the Customers drop-down 
																		list and the DataGrid is not refreshed.
																		<p align="center">
																			<IMG src="Screenshot/ValidationError.jpg">
																		</p>
																	<li>
																		Enter a date less than 1/1/2001 and click the
																		<span class="propValue">Show Orders</span>
																		button. Notice that the error message disappears and results matching your 
																		choices are retrieved from the XML file and displayed in the DataGrid</li>
																</ol>
															</td>
															<td>
																...
																<TABLE WIDTH="200" BORDER="0" CELLPADDING="0" CELLSPACING="0">
																	...
																	<TR>
																		...
																		<TD width="100%" valign="top" bgcolor="#e5f2ff" class="maintext"><div class="learn">
																				<p>
																					The ASP.NET <a target="_blank" class="vseval" href="http://samples.gotdotnet.com/quickstart/aspplus/doc/webvalidation.aspx">
																						Quickstarts</a> has a great overview of validation
																				</p>
																			</div>
																		</TD>
