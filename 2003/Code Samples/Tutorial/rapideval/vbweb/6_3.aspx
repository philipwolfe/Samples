...
mm_menu_Step6.addMenuItem("<p class='drop'><a href='6_3.aspx'><img src='../images/arrow_dropdown.gif' border=0>&nbsp;<B>Update Data</B></a></p>");
														...
														<TR>
															...
															<TD valign="top">
																<table width="150" border="0" cellspacing="0" cellpadding="0" ID="Table6">
																	<tr>
																		<td width="89" class="maintext"><a href="6_2.aspx"><img src="../images/navigation/previous.gif" width="89" height="24" border="0" alt="Previous Step"></a></td>
																		<td width="82" class="maintext"><a href="6_4.aspx"><img src="../images/navigation/next.gif" width="89" height="24" border="0" alt="Next Step"></a></td>
																	</tr>
																</table>
															</TD>
													...
													<TABLE WIDTH="756" BORDER="0" CELLPADDING="0" CELLSPACING="0">
														...
														<tr valign="top">
															<td width="500">
																<ol>
																	<li>
																		To modify data in the DataGrid, click the
																		<span class="propvalue">Edit</span>
																		link in the first column of the row you wish to edit. After the page refreshes, 
																		notice that the links change to
																		<span class="propvalue">Update</span>
																		and
																		<span class="propvalue">Cancel</span>. You get this functionality just by 
																	adding the EditCommandColumn to your DataGrid.
																	<li>
																		Notice that the data in the columns is now in an editable format in textboxes.
																		<p align="center">
																			<IMG src="Screenshot/dgUpdate.jpg">
																		</p>
																	<li>
																		Edit one of the columns and click the
																		<span class="propvalue">Update</span>
																	link to save your changes.
																	<li>
																		The datagrid will bind again using your saved data and return to the standard 
																		display.</li></ol>
															</td>
															<td>
																...
																<TABLE WIDTH="200" BORDER="0" CELLPADDING="0" CELLSPACING="0">
																	...
																	<TR>
																		...
																		<TD width="100%" valign="top" bgcolor="#e5f2ff" class="maintext"><div class="learn">
																				<p>More <a target="_blank" class="vseval" href="http://msdn.microsoft.com/library/default.asp?url=/library/en-us/dv_vbCode/html/vbtskCodeEditingItemsInDataGridWebControlVisualBasic.asp">
																						examples</a> of editing in a DataGrid</p>
																			</div>
																		</TD>
