...
mm_menu_Step1.addMenuItem("<p class='drop'><a href='1_1.aspx'><img src='../images/arrow_dropdown.gif' border=0>&nbsp;<B>Introduction</B></a></p>");
											...
											<TR>
												<td colspan="2">
													<TABLE WIDTH="756" BORDER="0" CELLPADDING="0" CELLSPACING="0">
														...
														<TR>
															<TD colspan="2"><script language="JavaScript1.2">mmLoadMenus();</script><img name="navigation" src="../images/navigation/step_1_windows.gif" width="756" height="61"
														...
														<TR>
															...
															<TD valign="top" class="maintext"><table width="500" border="0" cellspacing="0" cellpadding="0" ID="Table5">
																	<tr>
																		...
																		<td class="status"><strong>Step 1 of 3: Introduction</strong></td>
																	</tr>
																</table>
															</TD>
															<TD valign="top">
																<table width="150" border="0" cellspacing="0" cellpadding="0" ID="Table6">
																	<tr>
																		<td width="89" class="maintext"></td>
																		<td width="82" class="maintext"><a href="1_2.aspx"><img src="../images/navigation/next.gif" width="89" height="24" border="0" alt="Next Step"></a></td>
																	</tr>
																</table>
															</TD>
													...
													<TABLE WIDTH="756" BORDER="0" CELLPADDING="0" CELLSPACING="0">
														...
														<tr valign="top">
															<td width="500">
																<p>
																	In this overview you will learn how to create a Windows application using 
																	Visual Basic .NET. If you'd like to see the final sample in action, follow the
																	<span class="evalgui">Run Sample Application</span>
																	link at the top of the page now or at any time during the walkthrough.</p>
																<p>
																	The application you are about to build enables a user to retrieve customer 
																	order information from a database based on a specific date range. The user is 
																	able to specify the desired customer using a drop-down list and can specify the 
																	desired dates using two date range picker controls. The resulting orders are 
																	displayed in a <a href="javascript:openWindow('../Pops/DataGridControl.htm')" class="poplink">
																		DataGrid</a> which can then be edited and saved back to the data source.
																</p>
																<P></P>
															</td>
															<td>
																...
																<TABLE WIDTH="200" BORDER="0" CELLPADDING="0" CELLSPACING="0">
																	...
																	<TR>
																		...
																		<TD width="100%" valign="top" bgcolor="#e5f2ff" class="maintext"><div class="learn"><p><a class="vseval" target="_blank" href="http://msdn.microsoft.com/library/default.asp?url=/library/en-us/dndotnet/html/getstarwinform.asp">Get 
																						started</a> with Windows Forms</p>
																				<p>Want <a class="vseval" target="_blank" href="http://www.windowsforms.org">more 
																						information</a> on Windows Forms?</p>
																				<p>View an <a class="vseval" target="_blank" href="http://www.microsoft.com/seminar/shared/asp/view.asp?url=/seminar/en/20030117Move2vbnet/manifest.xml">
																						online presentation</a> on moving to Visual Basic .NET</p>
																				</SPAN></div>
																		</TD>
