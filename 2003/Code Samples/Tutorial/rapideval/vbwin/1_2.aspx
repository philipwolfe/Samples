...
mm_menu_Step1.addMenuItem("<p class='drop'><a href='1_2.aspx'><img src='../images/arrow_dropdown.gif' border=0>&nbsp;<B>Create Project</B></a></p>");
														...
														<TR>
															...
															<TD valign="top" class="maintext"><table width="500" border="0" cellspacing="0" cellpadding="0" ID="Table5">
																	<tr>
																		...
																		<td class="status"><strong>Step 2 of 3: Create Project</strong></td>
																	</tr>
																</table>
															</TD>
															<TD valign="top">
																<table width="150" border="0" cellspacing="0" cellpadding="0" ID="Table6">
																	<tr>
																		<td width="89" class="maintext"><a href="1_1.aspx"><img src="../images/navigation/previous.gif" width="89" height="24" border="0" alt="Previous Step"></a></td>
																		<td width="82" class="maintext"><a href="1_3.aspx"><img src="../images/navigation/next.gif" width="89" height="24" border="0" alt="Next Step"></a></td>
																	</tr>
																</table>
															</TD>
													...
													<TABLE WIDTH="756" BORDER="0" CELLPADDING="0" CELLSPACING="0">
														...
														<tr valign="top">
															<td width="500">
																<ol>
																	<li>
																	To get things started, open Visual Studio .NET 2003 and create a new project.
																	<li>
																		From the
																		<span class="menu">File</span>
																		menu, choose
																		<span class="menucmd">New - Project</span>. A
																		<span class="heading">New Project</span>
																		dialog box will be displayed. The left half of the dialog displays <a href="javascript:openWindow('../Pops/ProjectType.htm')" class="poplink">
																			project types</a> and the right half displays <a href="javascript:openWindow('../Pops/ProjectTemplates.htm')" class="poplink">
																			project templates</a>
																	which serve as the starting point for new applications.
																	<li>
																		Under
																		<span class="heading">Project Types</span>, choose
																		<span class="selection">Visual Basic Projects</span>.
																	<li>
																		Under
																		<span class="heading">Templates</span>, choose
																		<span class="selection">Windows Application</span>.
																	<li>
																		In the
																		<span class="property">Name</span>
																		field, type the name
																		<span class="entry">OrdersWinVB</span>
																		and select
																		<span class="button">OK</span>.
																		<p align="center">
																			<img src="Screenshot/NewProjectVBWin.jpg">
																		</p>
																	</li>
																</ol>
															</td>
															<td>
																...
																<TABLE WIDTH="200" BORDER="0" CELLPADDING="0" CELLSPACING="0">
																	...
																	<TR>
																		...
																		<TD width="100%" valign="top" bgcolor="#e5f2ff" class="maintext"><div class="learn"><p>Looking 
																					for more <a class="vseval" target="_blank" href="http://msdn.microsoft.com/library/en-us/dndotnet/html/introvisstunet.asp?frame=true">
																						introductory information</a> on Visual Studio.NET?</p>
																				<p>Learn how to <a class="vseval" target="_blank" href="http://msdn.microsoft.com/library/en-us/vsintro7/html/vxoriManagingProjectsSolutions.asp">
																						manage solutions, projects, and files</a>.</p>
																				</SPAN></div>
																		</TD>
