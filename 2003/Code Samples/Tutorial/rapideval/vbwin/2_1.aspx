...
mm_menu_Step2.addMenuItem("<p class='drop'><a href='2_1.aspx'><img src='../images/arrow_dropdown.gif' border=0>&nbsp;<B>Create Windows Form</B></a></p>");
														...
														<TR>
															...
															<TD valign="top" class="maintext"><table width="500" border="0" cellspacing="0" cellpadding="0" ID="Table5">
																	<tr>
																		...
																		<td class="status"><strong>Step 1 of 6: Create Windows Form</strong></td>
																	</tr>
																</table>
															</TD>
															<TD valign="top">
																<table width="150" border="0" cellspacing="0" cellpadding="0" ID="Table6">
																	<tr>
																		...
																		<td width="82" class="maintext"><a href="2_2.aspx"><img src="../images/navigation/next.gif" width="89" height="24" border="0" alt="Next Step"></a></td>
																	</tr>
																</table>
															</TD>
													...
													<TABLE WIDTH="756" BORDER="0" CELLPADDING="0" CELLSPACING="0">
														...
														<tr valign="top">
															<td width="500">
																<ol>
																	<li>
																		Now we will begin designing a Windows Form in our new project. Similar to 
																		Visual Basic 6.0, we design a form in Visual Studio .NET by dragging controls 
																		from the Toolbox onto the surface of the form in the <a href="javascript:openWindow('../Pops/WindowsFormDesigner.htm')" class="poplink">
																			Windows Form Designer</a>. Click on
																		<span class="menucmd">Form1</span>
																		in the
																		<span class="heading">Form Design Window</span>
																	to select it.
																	<li>
																	We need to increase the size of the form to create room for the controls. Drag 
																	the lower right corner of the form to expand its size until it fills most of 
																	the design window
																	<li>
																		Press
																		<span class="key">F4</span>
																		to display properties for
																		<span class="propvalue">Form1</span>
																		in the
																		<span class="heading">Properties</span>
																	window.
																	<li>
																		Update the name displayed in the title bar of the form by locating the
																		<span class="property">Text</span>
																		property and changing its value to
																		<span class="propvalue">Customer Orders</span></li>
																</ol>
																<p align="center">
																	<img src="Screenshot/FormProperties.jpg">
																</p>
															</td>
															<td>
																...
																<TABLE WIDTH="200" BORDER="0" CELLPADDING="0" CELLSPACING="0">
																	...
																	<TR>
																		...
																		<TD width="100%" valign="top" bgcolor="#e5f2ff" class="maintext"><div class="learn"><P>See 
																					what you can do with the <a class="vseval" target="_blank" href="http://msdn.microsoft.com/library/default.asp?url=/library/en-us/vsintro7/html/dturfWinFormsDesigner.asp">
																						Windows Form Designer</a>.</P>
																				<P>Before building your own .NET application, spend some time <a class="vseval" target="_blank" href="http://msdn.microsoft.com/library/en-us/dndotnet/html/designnetapp.asp?frame=true">
																						designing</a> it.</P>
																			</div>
																		</TD>
