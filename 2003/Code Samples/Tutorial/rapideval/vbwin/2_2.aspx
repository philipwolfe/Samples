...
mm_menu_Step2.addMenuItem("<p class='drop'><a href='2_2.aspx'><img src='../images/arrow_dropdown.gif' border=0>&nbsp;<B>Add Labels and Combobox</B></a></p>");
														...
														<TR>
															...
															<TD valign="top" class="maintext"><table width="500" border="0" cellspacing="0" cellpadding="0" ID="Table5">
																	<tr>
																		...
																		<td class="status"><strong>Step 2 of 6: Add Labels and Combobox</strong></td>
																	</tr>
																</table>
															</TD>
															<TD valign="top">
																<table width="150" border="0" cellspacing="0" cellpadding="0" ID="Table6">
																	<tr>
																		<td width="89" class="maintext"><a href="2_1.aspx"><img src="../images/navigation/previous.gif" width="89" height="24" border="0" alt="Previous Step"></a></td>
																		<td width="82" class="maintext"><a href="2_3.aspx"><img src="../images/navigation/next.gif" width="89" height="24" border="0" alt="Next Step"></a></td>
																	</tr>
																</table>
															</TD>
														...
														<tr valign="top">
															<td width="500">
																<table>
																	<tr valign="top">
																		<td rowspan="2">
																			<img src="Screenshot/Toolbox.jpg">
																		</td>
																		<td>
																			<ol>
																				<li>
																					Now, let's begin placing controls on the form starting with three descriptive 
																					labels. Drag three
																					<span class="vseval">Label</span>
																					controls from the
																					<span class="heading">Toolbox</span>
																				onto the form surface.
																				<li>
																					Update the text of the labels by clicking on the labels one at a time and 
																					changing the
																					<span class="property">Text</span>
																					property in the
																					<span class="heading">Properties</span>
																					window. From left to right, update the text of the labels to:
																					<span class="propvalue">Choose Customer</span>,
																					<span class="propvalue">Choose Start Date</span>, and
																					<span class="propvalue">Choose End Date</span>.
																				<li>
																					We want to align the labels vertically, so select all the Label controls on the 
																					form, then choose
																					<span class="menucmd">Align - Tops</span>
																					from the
																					<span class="menu">Format</span>
																				menu. The top edge of the labels will now be aligned vertically.
																				<li>
																					Now, drag a <a href="javascript:openWindow('../Pops/ComboBoxControl.htm')" class="poplink">
																						ComboBox</a> control from the
																					<span class="heading">Toolbox</span>
																					onto the form beneath the
																					<span class="propvalue">Choose Customer</span>
																					label. In the
																					<span class="heading">Properties</span>
																					window, change the
																					...
																					property to
																					<span class="propvalue">cboCustomers</span>
																					and the
																					<span class="property">DropDownStyle</span>
																					property to
																					<span class="propvalue">DropDownList</span>.</li>
																			</ol>
																		</td>
																	</tr>
																	<tr>
																		<td valign="top">
																			<img src="Screenshot/LabelsCombo.jpg">
																		</td>
																	</tr>
																</table>
															</td>
															<td>
																...
																<TABLE WIDTH="200" BORDER="0" CELLPADDING="0" CELLSPACING="0">
																	...
																	<TR>
																		...
																		<TD width="100%" valign="top" bgcolor="#e5f2ff" class="maintext"><div class="learn"><p>.NET 
																					controls are very similar to Visual Basic 6.0 controls, but also have some 
																					important <a class="vseval" target="_blank" href="http://msdn.microsoft.com/library/en-us/dndotnet/html/actxvnetcontrols.asp?frame=true">
																						differences</a></p>
																				<P>.NET includes several new and improved <a class="vseval" target="_blank" href="http://msdn.microsoft.com/library/en-us/vsintro7/html/vxurfToolboxS.asp">
																						controls</a></P>
																				<P>Learn techniques for easily <a class="vseval" target="_blank" href="http://msdn.microsoft.com/library/default.asp?url=/library/en-us/vbcon/html/vboriarrangingcontrolsonwinforms.asp">
																						arranging controls</a> on a Windows Form.</P>
																			</div>
																		</TD>
