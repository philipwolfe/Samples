...
mm_menu_Step2.addMenuItem("<p class='drop'><a href='2_3.aspx'><img src='../images/arrow_dropdown.gif' border=0>&nbsp;<B>Add DateTimePickers</B></a></p>");
											...
											<TR>
												<td colspan="2">
														...
														<TR>
															...
															<TD valign="top" class="maintext"><table width="500" border="0" cellspacing="0" cellpadding="0" ID="Table5">
																	<tr>
																		...
																		<td class="status"><strong>Step 3 of 6: Add DateTimePickers</strong></td>
																	</tr>
																</table>
															</TD>
															<TD valign="top">
																<table width="150" border="0" cellspacing="0" cellpadding="0" ID="Table6">
																	<tr>
																		<td width="89" class="maintext"><a href="2_2.aspx"><img src="../images/navigation/previous.gif" width="89" height="24" border="0" alt="Previous Step"></a></td>
																		<td width="82" class="maintext"><a href="2_4.aspx"><img src="../images/navigation/next.gif" width="89" height="24" border="0" alt="Next Step"></a></td>
																	</tr>
																</table>
															</TD>
													...
													<TABLE WIDTH="756" BORDER="0" CELLPADDING="0" CELLSPACING="0">
														...
														<tr valign="top">
															<td width="500">
																<p>Visual Studio .NET includes several advanced controls which simplify development 
																	and improve application usability. One of these controls is the <a href="javascript:openWindow('../Pops/DateTimePickerControl.htm')" class="poplink">
																		DateTimePicker</a>. We will add two DateTimePicker controls to the form to 
																	simplify date entry.</p>
																<p align="center">
																	<img src="Screenshot/DateTimePicker.jpg">
																</p>
																<ol>
																	<li>
																		Drag a
																		<span class="control">DateTimePicker</span>
																		control from the
																		<span class="heading">Toolbox</span>
																		onto the form beneath the
																		<span class="propvalue">Choose Start Date</span>
																		label. Next we will update a few of the control's properties in the
																		<span class="control">Properties</span>
																	window.
																	<li>
																		Set the
																		<span class="property">Name</span>
																		property to
																		<span class="propvalue">dtpStartDate</span>.
																	<li>
																		To display the date but not the time, set the
																		<span class="property">Format</span>
																		property to
																		<span class="propvalue">Short</span>.
																	<li>
																		Set the initial value of the control by entering
																		<span class="propvalue">1/1/2000</span>
																		in the
																	...
																	label. We will update the same properties for this control.
																	<li>
																		Set the
																		<span class="property">Name</span>
																		property to
																		<span class="propvalue">dtpEndDate</span>.
																	<li>
																		To display the date but not the time, set the
																		<span class="property">Format</span>
																		property to
																	...
																	<li>
																		Set the initial value of the control by entering
																		<span class="propvalue">12/31/2002</span>
																		in the
																		<span class="property">Value</span>
																		property.</li>
																</ol>
																<p align="center">
																	<img src="Screenshot/DateTimePickers.jpg">
																</p>
															</td>
															<td>
																...
																<TABLE WIDTH="200" BORDER="0" CELLPADDING="0" CELLSPACING="0">
																	...
																	<TR>
																		...
																		<TD width="100%" valign="top" bgcolor="#e5f2ff" class="maintext"><P>See a <a class="vseval" target="_blank" href="http://samples.gotdotnet.com/quickstart/winforms/doc/ControlRef/DateTimePickerCtl.aspx">
																					working sample</a> of DateTimePicker features.</P>
																			<DIV></DIV>
																		</TD>
