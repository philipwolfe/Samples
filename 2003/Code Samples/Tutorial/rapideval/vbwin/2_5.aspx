...
mm_menu_Step2.addMenuItem("<p class='drop'><a href='2_5.aspx'><img src='../images/arrow_dropdown.gif' border=0>&nbsp;<B>Add DataGrid</B></a></p>");
														...
														<TR>
															...
															<TD valign="top" class="maintext"><table width="500" border="0" cellspacing="0" cellpadding="0" ID="Table5">
																	<tr>
																		...
																		<td class="status"><strong>Step 5 of 6: Add DataGrid</strong></td>
																	</tr>
																</table>
															</TD>
															<TD valign="top">
																<table width="150" border="0" cellspacing="0" cellpadding="0" ID="Table6">
																	<tr>
																		<td width="89" class="maintext"><a href="2_4.aspx"><img src="../images/navigation/previous.gif" width="89" height="24" border="0" alt="Previous Step"></a></td>
																		<td width="82" class="maintext"><a href="2_6.aspx"><img src="../images/navigation/next.gif" width="89" height="24" border="0" alt="Next Step"></a></td>
																	</tr>
																</table>
															</TD>
														...
														<tr valign="top">
															<td width="500">
																<ol>
																	<li>
																		From the
																		<span class="heading">Toolbox</span>, drag a
																		<span class="control">DataGrid</span>
																	control and place it under the first row of controls.
																	<li>
																	Resize the DataGrid control to fill the remaining area of the form.
																	<li>
																		In the
																	...
																	<li>
																		All Windows Forms controls have an
																		<span class="property">Anchor</span>
																		property which causes the control to automatically resize when the form is 
																		resized. Set the
																		<span class="property">Anchor</span>
																		property of the DataGrid to
																		<span class="propvalue">Top, Bottom, Left, Right</span>
																	so it expands in all directions as the form is resized.
																	<li>
																		You can right-click on the DataGrid and select
																		<span class="menucmd">AutoFormat</span>
																		to choose from several predefined color schemes. For this walkthrough, we will 
																		leave the DataGrid formatted with the
																		<span class="propvalue">Default</span>
																		format.
																		<P align="center">
																			<IMG src="Screenshot/DataGridAutoFormat.jpg">
																		</P>
																	</li>
																</ol>
															</td>
															<td>
																...
																<TABLE WIDTH="200" BORDER="0" CELLPADDING="0" CELLSPACING="0">
																	...
																	<TR>
																		...
																		<TD width="100%" valign="top" bgcolor="#e5f2ff" class="maintext"><div class="learn"><p>Interested 
																					in <a class="vseval" target="_blank" href="http://msdn.microsoft.com/library/en-us/dnwinforms/html/wnf_CustDataGrid.asp?frame=true">
																						customizing</a> your DataGrid control?</p>
																			</div>
																		</TD>
