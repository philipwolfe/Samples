...
mm_menu_Step2.addMenuItem("<p class='drop'><a href='2_6.aspx'><img src='../images/arrow_dropdown.gif' border=0>&nbsp;<B>Sample Validation</B></a></p>");
											...
											<TR>
												<td colspan="2">
													<TABLE WIDTH="756" BORDER="0" CELLPADDING="0" CELLSPACING="0">
														...
														<TR>
															<TD colspan="2"><script language="JavaScript1.2">mmLoadMenus();</script><img name="navigation" src="../images/navigation/step_2_windows.gif" width="756" height="61"
														...
														<TR>
															...
															<TD valign="top" class="maintext"><table width="500" border="0" cellspacing="0" cellpadding="0" ID="Table5">
																	<tr>
																		...
																		<td class="status"><strong>Step 6 of 6: Sample Validation</strong></td>
																	</tr>
																</table>
															</TD>
															<TD valign="top">
																<table width="150" border="0" cellspacing="0" cellpadding="0" ID="Table6">
																	<tr>
																		<td width="89" class="maintext"><a href="2_5.aspx"><img src="../images/navigation/previous.gif" width="89" height="24" border="0" alt="Previous Step"></a></td>
																		<td width="82" class="maintext"><a href="3_1.aspx"><img src="../images/navigation/next.gif" width="89" height="24" border="0" alt="Next Step"></a></td>
																	</tr>
																</table>
															</TD>
													...
													<TABLE WIDTH="756" BORDER="0" CELLPADDING="0" CELLSPACING="0">
														...
														<tr valign="top">
															<td width="500">
																<ol>
																	<p>
																		Now we will implement sample input validation code to demonstrate how easy it 
																		is to reliably verify user input. In this walkthrough, we will validate the 
																		Start Date is prior to 1/1/2001.</p>
																	Windows Forms have an <a href="javascript:openWindow('../Pops/ErrorProviderComponent.htm')" class="poplink">
																		ErrorProvider</a> component which provides a visual cue to users when data 
																	is incorrect or in an invalid format. To see how an ErrorProvider can be used 
																	to report validation errors, follow this procedure:
																	<P></P>
																	<li>
																		Drag an
																		<span class="control">ErrorProvider</span>
																		component from the
																		<span class="heading">Toolbox</span>
																		onto the form. Leave the ErrorProvider control's name as the default
																		<span class="propvalue">ErrorProvider1.</span>
																	<li>
																		Press
																		<span class="key">F7</span>
																		to display the
																		<span class="heading">Code Editor</span>.
																	<li>
																		Select
																		<span class="selection">dtpStartDate</span>
																		from the
																		<span class="heading">Class Name</span>
																		drop-down list and
																		<span class="selection">Validating</span>
																		from the
																		<span class="heading">Method Name</span>
																		drop-down list. This event is fired when new input in a control is ready for 
																		validation. Place the following code in the
																		<span class="propvalue">dtpStartDate_Validating</span>
																		event procedure to verify the Start Date is prior to 1/1/2001.
																		<pre class="csharpcode">
<span class="kwrd">If</span> dtpStartDate.Value.CompareTo(<span class="kwrd">New</span> System.DateTime(2001, 1, 1)) &lt; 0 <span class="kwrd">Then</span> 
    ErrorProvider1.SetError(dtpStartDate, <span class="str">""</span>)
<span class="kwrd">Else</span>
    ErrorProvider1.SetError(dtpStartDate, _
	                        <span class="str">"Start Date must be prior to 1/1/2001"</span>)
    e.Cancel = <span class="kwrd">True</span>
<span class="kwrd">End</span> <span class="kwrd">If</span>
</pre>
																	<li>
																		Before moving on, press
																		<span class="key">Ctrl+S</span>
																		to save your changes to the Windows Form</li>
																</ol>
																<p align="center">
																	<img src="Screenshot/ErrorProviderControl.jpg">
																</p>
															</td>
															<td>
																...
																<TABLE WIDTH="200" BORDER="0" CELLPADDING="0" CELLSPACING="0">
																	...
																	<TR>
																		...
																		<TD width="100%" valign="top" bgcolor="#e5f2ff" class="maintext"><div class="learn"><p>The 
																					ErrorProvider control can also be used to relay information about <a class="vseval" target="_blank" href="http://msdn.microsoft.com/library/en-us/dv_vstechart/html/vbtchExceptionsErrorsInVisualBasicNET.asp?frame=true">
																						exceptions</a></p>
																			</div>
																		</TD>
