...
mm_menu_Step3.addMenuItem("<p class='drop'><a href='3_1.aspx'>Introduction</a></p>");
mm_menu_Step3.addMenuItem("<p class='drop'><a href='3_2.aspx'><img src='../images/arrow_dropdown.gif' border=0>&nbsp;<B>Define Dataset</B></a></p>");
														...
														<TR>
															...
															<TD valign="top" class="maintext"><table width="500" border="0" cellspacing="0" cellpadding="0" ID="Table5">
																	<tr>
																		...
																		<td class="status"><strong>Step 2 of 6: Define Dataset</strong></td>
																	</tr>
																</table>
															</TD>
															<TD valign="top">
																<table width="150" border="0" cellspacing="0" cellpadding="0" ID="Table6">
																	<tr>
																		<td width="89" class="maintext"><a href="3_1.aspx"><img src="../images/navigation/previous.gif" width="89" height="24" border="0" alt="Previous Step"></a></td>
																		<td width="82" class="maintext"><a href="3_3.aspx"><img src="../images/navigation/next.gif" width="89" height="24" border="0" alt="Next Step"></a></td>
																	</tr>
																</table>
															</TD>
													...
													<TABLE WIDTH="756" BORDER="0" CELLPADDING="0" CELLSPACING="0">
														...
														<tr valign="top">
															<td width="500">
																<ol>
																	<li>
																		To start implementing data access in this walkthrough, <a href="../Downloads/VSRapidEval.zip" class="vseval">
																			download</a>
																	a zip file, which contains the XML data file CustOrder.xml, and the schema file 
																	dsCustOrder.xsd, which defines the structure for the DataSet.
																	<li>
																	After the download is complete, extract the files to a directory of your choice 
																	and make a note of the location.
																	<li>
																		Go back to Visual Studio .NET 2003 and in
																		<span class="heading">Solution Explorer</span>, right-click the
																		<span class="propvalue">OrdersWinVB</span>
																		project and then choose
																		<span class="menucmd">Add Existing Item</span>. Find the
																		<span class="selection">dsCustOrder.xsd</span>
																	file and add it to the project so we have a definition for our DataSet.
																	<li>
																		Now we'll look at the structure of the DataSet by double-clicking the
																		<span class="selection">dsCustOrder.xsd</span>
																		file in
																		<span class="heading">Solution Explorer</span>
																	to open a visual designer that displays the Customer and Orders tables and the 
																	relationship between them. XML schemas such as this can be designed visually in 
																	Visual Studio .NET and do not require knowledge of XML syntax.
																	<li>
																		Before moving on, we need to generate the DataSet so it can be referenced 
																		elsewhere in our project. Right-click on the Schema Designer surface and choose
																		<span class="menucmd">Generate DataSet</span>.
																		<P align="center">
																			<IMG src="Screenshot/GenerateDataset.jpg">
																		</P>
																	</li>
																</ol>
															</td>
															<td>
																...
																<TABLE WIDTH="200" BORDER="0" CELLPADDING="0" CELLSPACING="0">
																	...
																	<TR>
																		...
																		<TD width="100%" valign="top" bgcolor="#e5f2ff" class="maintext"><div class="learn"><p>You 
																					can create your own <a class="vseval" target="_blank" href="http://msdn.microsoft.com/library/en-us/vbcon/html/vboriCreatingSchemasDataSets.asp">
																						DataSets</a> and schemas in <a class="vseval" target="_blank" href="http://msdn.microsoft.com/library/en-us/vbcon/html/vbconADONETDataSetCreationInVisualStudioNET.asp">
																						Visual Studio.NET</a></p>
																				<P>While you don't need to know a lot about schemas to work with .NET, schemas can <a class="vseval" target="_blank" href="http://msdn.microsoft.com/library/en-us/vbcon/html/vburfWorkingWithXMLDataSchemas.asp">
																						simplify</a> working with XML</P>
																			</div>
																		</TD>
