...
mm_menu_Step3.addMenuItem("<p class='drop'><a href='3_4.aspx'><img src='../images/arrow_dropdown.gif' border=0>&nbsp;<B>Databind Combobox</B></a></p>");
											...
											<TR>
												<td colspan="2">
														...
														<TR>
															...
															<TD valign="top" class="maintext"><table width="500" border="0" cellspacing="0" cellpadding="0" ID="Table5">
																	<tr>
																		...
																		<td class="status"><strong>Step 4 of 6: Databind Combobox</strong></td>
																	</tr>
																</table>
															</TD>
															<TD valign="top">
																<table width="150" border="0" cellspacing="0" cellpadding="0" ID="Table6">
																	<tr>
																		<td width="89" class="maintext"><a href="3_3.aspx"><img src="../images/navigation/previous.gif" width="89" height="24" border="0" alt="Previous Step"></a></td>
																		<td width="82" class="maintext"><a href="3_5.aspx"><img src="../images/navigation/next.gif" width="89" height="24" border="0" alt="Next Step"></a></td>
																	</tr>
																</table>
															</TD>
													...
													<TABLE WIDTH="756" BORDER="0" CELLPADDING="0" CELLSPACING="0">
														...
														<tr valign="top">
															<td width="500">
																<P>After we have a dataset populated, we use the power of databinding to populate 
																	controls with data in the dataset. The
																	<span class="propvalue">cboCustomers</span>
																	<span class="control">ComboBox</span>
																	will be populated with data from the Customers table. To set up a datasource 
																	for the ComboBox, do the following:</P>
																<ol>
																	<li>
																		Click
																		<span class="propvalue">cboCustomers</span>
																		in the
																		<span class="heading">Windows Form Designer</span>
																	to bring up the properties for the control.
																	<li>
																		Set the
																		<span class="property">DataSource</span>
																		property to
																		<span class="property">dsCustOrder1.Customers</span>
																	to specify the table we wish to bind to.
																	<li>
																		Set the
																		<span class="property">DisplayMember</span>
																		property to
																		<span class="property">CompanyName</span>. This property identifies the 
																	column in the Customers table containing data we want to display in the 
																	ComboBox.
																	<li>
																		Set the
																		<span class="property">ValueMember</span>
																		property to
																		<span class="property">CustomerID</span>
																		This property identifies the column containing the value to be returned when an 
																		item is selected in the ComboBox.</li>
																</ol>
																<P align="center">
																	<IMG src="Screenshot/cboDatasource.jpg">
																</P>
																<P></P>
															</td>
															<td>
																...
																<TABLE WIDTH="200" BORDER="0" CELLPADDING="0" CELLSPACING="0">
																	...
																	<TR>
																		...
																		<TD width="100%" valign="top" bgcolor="#e5f2ff" class="maintext"><div class="learn"><p>You 
																					can bind to a host of <a class="vseval" target="_blank" href="http://msdn.microsoft.com/library/en-us/dnadvnet/html/vbnet08262002.asp">
																						controls</a> in .NET</p>
																			</div>
																		</TD>
