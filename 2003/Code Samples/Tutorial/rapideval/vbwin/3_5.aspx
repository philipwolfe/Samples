...
mm_menu_Step3.addMenuItem("<p class='drop'><a href='3_5.aspx'><img src='../images/arrow_dropdown.gif' border=0>&nbsp;<B>Databind Datagrid</B></a></p>");
														...
														<TR>
															...
															<TD valign="top" class="maintext"><table width="500" border="0" cellspacing="0" cellpadding="0" ID="Table5">
																	<tr>
																		...
																		<td class="status"><strong>Step 5 of 6: Databind Datagrid</strong></td>
																	</tr>
																</table>
															</TD>
															<TD valign="top">
																<table width="150" border="0" cellspacing="0" cellpadding="0" ID="Table6">
																	<tr>
																		<td width="89" class="maintext"><a href="3_4.aspx"><img src="../images/navigation/previous.gif" width="89" height="24" border="0" alt="Previous Step"></a></td>
																		<td width="82" class="maintext"><a href="3_6.aspx"><img src="../images/navigation/next.gif" width="89" height="24" border="0" alt="Next Step"></a></td>
																	</tr>
																</table>
															</TD>
															...
															<td width="500">
																<p>Our DataGrid
																	...
																	do this, we will utilize a <a href="javascript:openWindow('../Pops/DataView.htm')" class="poplink">
																		DataView</a>. Double-click the
																	<span class="propvalue">Show Orders</span>
																	button to bring up the
																	<span class="propvalue">btnShow_Click</span>
																	event procedure. Note the use of the StringBuilder class which performs string 
																	concatenation more efficiently than using
																	<span class="propvalue">+</span>
																	to concatenate strings. Add the following code.</p>
...
<span class="kwrd">Dim</span> dvOrders <span class="kwrd">As</span> DataView = DsCustOrder1.Orders.DefaultView
...
dgOrders.DataSource = dvOrders
																...
																<P>The RowFilter uses syntax similar to a SQL statement WHERE clause to select 
																	matching rows from the DataSet. You will also notice the += operator new in 
																	Visual Basic .NET, which is a shorthand convention for appending to a string 
																	value or incrementing a numeric value.</P>
																<P></P>
															</td>
															<td>
																	...
																	<TR>
																		...
																		<TD width="100%" valign="top" bgcolor="#e5f2ff" class="maintext"><div class="learn">
																				<p>Why use a <a target="_blank" class="vseval" href="http://msdn.microsoft.com/msdnnews/2001/sept/Classroom/Classroom.asp">
																						StringBuilder</a>?</p>
																				<p><a class="vseval" target="_blank" href="http://msdn.microsoft.com/library/en-us/cpguide/html/cpconcreatingusingdataviews.asp">DataViews</a>
																					provide a fast and easy way to limit data results.</p>
																				<P>Looking for more <a class="vseval" target="_blank" href="http://msdn.microsoft.com/library/en-us/dv_vbCode/html/vbtskCodeExampleFilteringDataInDataView.asp">
																						DataView samples</a>?</P>
																			</div>
																		</TD>
