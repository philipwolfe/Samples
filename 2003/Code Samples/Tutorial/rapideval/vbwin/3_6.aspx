...
mm_menu_Step3.addMenuItem("<p class='drop'><a href='3_6.aspx'><img src='../images/arrow_dropdown.gif' border=0>&nbsp;<B>Save Datagrid Changes</B></a></p>");
											...
											<TR>
												<td colspan="2">
														...
														<TR>
															...
															<TD valign="top" class="maintext"><table width="500" border="0" cellspacing="0" cellpadding="0" ID="Table5">
																	<tr>
																		...
																		<td class="status"><strong>Step 6 of 6: Save Datagrid Changes</strong></td>
																	</tr>
																</table>
															</TD>
															<TD valign="top">
																<table width="150" border="0" cellspacing="0" cellpadding="0" ID="Table6">
																	<tr>
																		<td width="89" class="maintext"><a href="3_5.aspx"><img src="../images/navigation/previous.gif" width="89" height="24" border="0" alt="Previous Step"></a></td>
																		<td width="82" class="maintext"><a href="4_1.aspx"><img src="../images/navigation/next.gif" width="89" height="24" border="0" alt="Next Step"></a></td>
																	</tr>
																</table>
															</TD>
													...
													<TABLE WIDTH="756" BORDER="0" CELLPADDING="0" CELLSPACING="0">
														...
														<tr valign="top">
															<td width="500">
																<P>Last, we will add code to save user changes to values in the DataGrid. 
																	Double-click the
																	<span class="propvalue">Update Orders</span>
																	button to display the
																	<span class="propvalue">btnUpdate_Click</span>
																	event procedure. Because the DataSet is bound to the DataGrid, the user changes 
																	are automatically reflected in the DataSet and we need to accept only the user 
																	changes to the DataSet and save the changes to the XML file using the following 
																	statements:</P>
															...
															<td>
																...
																<TABLE WIDTH="200" BORDER="0" CELLPADDING="0" CELLSPACING="0">
																	...
																	<TR>
																		...
																		<TD width="100%" valign="top" bgcolor="#e5f2ff" class="maintext"><P>Start with the 
																				concepts of <a class="vseval" target="_blank" href="http://msdn.microsoft.com/library/en-us/vbcon/html/vbconIntroductionToDatasetUpdates.asp">
																					DataSet updates</a>.</P>
																			<P>Use <a class="vseval" target="_blank" href="http://msdn.microsoft.com/library/en-us/vbcon/html/vboriDataUpdatesConcurrency.asp">
																					concurrency control</a> to keep users from overwriting each other's 
																				changes.</P>
																			<DIV></DIV>
																		</TD>
