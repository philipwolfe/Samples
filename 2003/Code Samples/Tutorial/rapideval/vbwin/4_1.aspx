...
mm_menu_Step4.addMenuItem("<p class='drop'><a href='4_1.aspx'><img src='../images/arrow_dropdown.gif' border=0>&nbsp;<B>Launch Application</B></a></p>");
														...
														<TR>
															...
															<TD valign="top">
																<table width="150" border="0" cellspacing="0" cellpadding="0" ID="Table6">
																	<tr>
																		<td width="89" class="maintext"><a href="3_6.aspx"><img src="../images/navigation/previous.gif" width="89" height="24" border="0" alt="Previous Step"></a></td>
																		<td width="82" class="maintext"><a href="4_2.aspx"><img src="../images/navigation/next.gif" width="89" height="24" border="0" alt="Next Step"></a></td>
																	</tr>
																</table>
															</TD>
														...
														<tr valign="top">
															<td width="500">
																<ol>
																	...
																	to build the application and launch the debugger. An executable version of the 
																	form will display once the application is built.
																	<li>
																		Drop down the Customer list to see the data populated from the Customer table 
																		in the DataSet.
																		<p align="center">
																			<IMG src="Screenshot/RunCombo.jpg">
																		</p>
																	<li>
																		Resize the form by dragging the lower right corner and notice how the Anchor 
																		property of the DataGrid causes the DataGrid to resize as the form is resized.
																		<p align="center">
																			<IMG src="Screenshot/RunResize.jpg">
																		</p>
																	</li>
																</ol>
															</td>
															<td>
																...
																<TABLE WIDTH="200" BORDER="0" CELLPADDING="0" CELLSPACING="0">
																	...
																	<TR>
																		...
																		<TD width="100%" valign="top" bgcolor="#e5f2ff" class="maintext"><div class="learn"><p>When 
																					building your own applications, you're bound to encounter some bugs. Visual 
																					Studio.NET includes a powerful <a class="vseval" target="_blank" href="http://msdn.microsoft.com/library/en-us/dv_vstechart/html/vstchDebuggingInVisualStudioNET.asp?frame=true">
																						debugging</a> environment</p>
																			</div>
																		</TD>
