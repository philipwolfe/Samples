...
mm_menu_Step4.addMenuItem("<p class='drop'><a href='4_2.aspx'><img src='../images/arrow_dropdown.gif' border=0>&nbsp;<B>Test Sample Validation</B></a></p>");
														...
														<TR>
															...
															<TD valign="top" class="maintext"><table width="500" border="0" cellspacing="0" cellpadding="0" ID="Table5">
																	<tr>
																		...
																		<td class="status"><strong>Step 2 of 4: Test Sample Validation</strong></td>
																	</tr>
																</table>
															</TD>
															<TD valign="top">
																<table width="150" border="0" cellspacing="0" cellpadding="0" ID="Table6">
																	<tr>
																		<td width="89" class="maintext"><a href="4_1.aspx"><img src="../images/navigation/previous.gif" width="89" height="24" border="0" alt="Previous Step"></a></td>
																		<td width="82" class="maintext"><a href="4_3.aspx"><img src="../images/navigation/next.gif" width="89" height="24" border="0" alt="Next Step"></a></td>
																	</tr>
																</table>
															</TD>
													...
													<TABLE WIDTH="756" BORDER="0" CELLPADDING="0" CELLSPACING="0">
														...
														<tr valign="top">
															<td width="500">
																<ol>
																	<li>
																		Enter a Start Date greater than 1/1/2001 and tab out of the control to see the 
																		error icon displayed by the ErrorProvider. Move the mouse over the error icon 
																		to see the error message. Click on the
																		<span class="propvalue">Show Orders</span>
																		button to verify that the command will not execute until a valid date is 
																		entered.
																		<p align="center">
																			<IMG src="Screenshot/RunError.jpg">
																		</p>
																	<li>
																		Enter a date less than 1/1/2001 and click the
																		<span class="propvalue">Show Orders</span>
																		button. The error icon disappears and results are retrieved from the XML file.
																		<p align="center">
																			<IMG src="Screenshot/RunShowOrders.jpg">
																		</p>
																	</li>
																</ol>
															</td>
															<td>
																...
																<TABLE WIDTH="200" BORDER="0" CELLPADDING="0" CELLSPACING="0">
																	...
																	<TR>
																		...
																		<TD width="100%" valign="top" bgcolor="#e5f2ff" class="maintext"><P>It's a good idea to 
																				test <a class="vseval" target="_blank" href="http://msdn.microsoft.com/library/default.asp?url=/library/en-us/vbcon/html/vboriTestingScalabilityPerformanceVB.asp">
																					scalability and performance</a> too.</P>
																			<DIV></DIV>
																		</TD>
