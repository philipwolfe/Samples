...
mm_menu_Step4.addMenuItem("<p class='drop'><a href='4_3.aspx'><img src='../images/arrow_dropdown.gif' border=0>&nbsp;<B>Update Data</B></a></p>");
											...
											<TR>
												<td colspan="2">
													<TABLE WIDTH="756" BORDER="0" CELLPADDING="0" CELLSPACING="0">
														...
														<TR>
															<TD colspan="2"><script language="JavaScript1.2">mmLoadMenus();</script><img name="navigation" src="../images/navigation/step_4_windows.gif" width="756" height="61"
														...
														<TR>
															...
															<TD valign="top" class="maintext"><table width="500" border="0" cellspacing="0" cellpadding="0" ID="Table5">
																	<tr>
																		...
																		<td class="status"><strong>Step 3 of 4: Update Data</strong></td>
																	</tr>
																</table>
															</TD>
															<TD valign="top">
																<table width="150" border="0" cellspacing="0" cellpadding="0" ID="Table6">
																	<tr>
																		<td width="89" class="maintext"><a href="4_2.aspx"><img src="../images/navigation/previous.gif" width="89" height="24" border="0" alt="Previous Step"></a></td>
																		<td width="82" class="maintext"><a href="4_4.aspx"><img src="../images/navigation/next.gif" width="89" height="24" border="0" alt="Next Step"></a></td>
																	</tr>
																</table>
															</TD>
													...
													<TABLE WIDTH="756" BORDER="0" CELLPADDING="0" CELLSPACING="0">
														...
														<tr valign="top">
															<td width="500">
																<ol>
																	<li>
																		Modify data in the DataGrid and click
																		<span class="propvalue">Update Orders</span>
																		to save the changes to the XML file.
																		<p align="center">
																			<IMG src="Screenshot/RunUpdate.jpg">
																		</p>
																	<li>
																	...
																	<li>
																		Launch the application a second time and execute the same search. Notice that 
																		the changes from the previous session were successfully saved to the XML file 
																		and displayed in the DataGrid.
																		<p align="center">
																			<IMG src="Screenshot/RunShowOrders2.jpg">
																		</p>
																	</li>
																</ol>
															</td>
															<td>
																...
																<TABLE WIDTH="200" BORDER="0" CELLPADDING="0" CELLSPACING="0">
																	...
																	<TR>
																		...
																		<TD width="100%" valign="top" bgcolor="#e5f2ff" class="maintext"><P>Once you've tested 
																				your Windows Application, it's time to think about <a class="vseval" target="_blank" href="http://msdn.microsoft.com/library/default.asp?url=/library/en-us/vsintro7/html/vbtskcreatinginstallerforyourapplication.asp">
																					deploying</a> it.</P>
																			<P>It's much easier to <a class="vseval" target="_blank" href="http://msdn.microsoft.com/library/default.asp?url=/library/en-us/dv_vstechart/html/vbtchNo-TouchDeploymentInNETFramework.asp">
																					deploy Windows Applications</a> with Visual Studio .NET.</P>
																			<DIV></DIV>
																		</TD>
