<%@ Page Language="vb" AutoEventWireup="false" Codebehind="main.aspx.vb" Inherits="HowToBuildAWebDataEntryApp.Main" %>
	...
	<body>
		<form id="frmMain" method="post" runat="server">
			...
			<TABLE width="100%" border="0">
				...
				<TR>
					<TD vAlign="top"><asp:datagrid id="grdProducts" runat="server" AllowPaging="True" AutoGenerateColumns="False" AllowSorting="True" DataKeyField="ProductID">
							...
							<Columns>
								...
								<asp:TemplateColumn SortExpression="Discontinued" ItemStyle-CssClass="Discontinued" HeaderText="Discontinued">
									<ItemTemplate>
										<asp:CheckBox ID="chkDiscontinuedGrid" Runat="server" Checked='<%# CBool(Container.DataItem("Discontinued")) %>' />
									</ItemTemplate>
								</asp:TemplateColumn>
						...
						<input id="htmlHiddenSortExpression" type="hidden" value="ProductID" name="htmlHiddenSortExpression" runat="server">
					</TD>
				</TR>
			</TABLE>
			<span class="Message">
				...
				<TABLE id="Table1" width="100%">
					...
					<TR>
						...
						<TD class="FormInput">
							...
							<asp:RegularExpressionValidator id="revPrice" runat="server" ErrorMessage="You must enter a valid price." Display="Dynamic" ValidationExpression="\d+[.]?[\d]{0,2}" ControlToValidate="txtPrice"></asp:RegularExpressionValidator></TD>
					</TR>
					<TR>
						...
						<TD class="FormInput">
							...
							<asp:RegularExpressionValidator id="revInStock" runat="server" ErrorMessage="You must enter a number." Display="Dynamic" ValidationExpression="\d+" ControlToValidate="txtInStock"></asp:RegularExpressionValidator></TD>
					</TR>
					<TR>
					...
					<TR>
						<TD>&nbsp;</TD>
						<TD>
							<asp:Button id="btnSave" Text="Save Changes" CssClass="Button" Runat="server"></asp:Button></TD>
					</TR>
				</TABLE>
			</asp:panel></form>
	</body>
