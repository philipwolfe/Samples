...
Partial Public NotInheritable Class ThisDocument
    ...
    Friend WithEvents emailAddressBookmark As Microsoft.Office.Tools.Word.Bookmark

    Friend WithEvents firstNameBookmark As Microsoft.Office.Tools.Word.Bookmark

    Friend WithEvents jobTitleBookmark As Microsoft.Office.Tools.Word.Bookmark

    Friend WithEvents lastNameBookmark As Microsoft.Office.Tools.Word.Bookmark
    ...
    Public Overrides Sub OnShutdown() Implements Microsoft.VisualStudio.Tools.Applications.Runtime.IStartup.OnShutdown
        Me.lastNameBookmark.Dispose()
        Me.jobTitleBookmark.Dispose()
        Me.firstNameBookmark.Dispose()
        Me.emailAddressBookmark.Dispose()
    ...
    Private Sub BeginInitialization()
        ...
        Me.emailAddressBookmark.BeginInit()
        Me.firstNameBookmark.BeginInit()
        Me.jobTitleBookmark.BeginInit()
        Me.lastNameBookmark.BeginInit()
    End Sub
    ...
    Private Sub EndInitialization()
        Me.lastNameBookmark.EndInit()
        Me.jobTitleBookmark.EndInit()
        Me.firstNameBookmark.EndInit()
        Me.emailAddressBookmark.EndInit()
    ...
    Private Sub InitializeControls()
        ...
        Me.emailAddressBookmark = New Microsoft.Office.Tools.Word.Bookmark(Me.HostItemHost, Me.RuntimeCallback, "emailAddressBookmark", Me, "emailAddressBookmark")
        Me.firstNameBookmark = New Microsoft.Office.Tools.Word.Bookmark(Me.HostItemHost, Me.RuntimeCallback, "firstNameBookmark", Me, "firstNameBookmark")
        Me.jobTitleBookmark = New Microsoft.Office.Tools.Word.Bookmark(Me.HostItemHost, Me.RuntimeCallback, "jobTitleBookmark", Me, "jobTitleBookmark")
        Me.lastNameBookmark = New Microsoft.Office.Tools.Word.Bookmark(Me.HostItemHost, Me.RuntimeCallback, "lastNameBookmark", Me, "lastNameBookmark")
    End Sub
    ...
    Private Sub InitializeComponents()
        ...
        CType(Me.emailAddressBookmark, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.firstNameBookmark, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.jobTitleBookmark, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.lastNameBookmark, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(Me, System.ComponentModel.ISupportInitialize).BeginInit()
        '
        'ThisDocument
        '
        CType(Me.ActionsPane, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.emailAddressBookmark, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.firstNameBookmark, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.jobTitleBookmark, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.lastNameBookmark, System.ComponentModel.ISupportInitialize).EndInit()
