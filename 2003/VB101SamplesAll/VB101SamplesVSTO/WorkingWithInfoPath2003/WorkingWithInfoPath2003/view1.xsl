...
<xsl:stylesheet version="1.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:d="http://schemas.microsoft.com/office/infopath/2003/ado/dataFields" xmlns:dfs="http://schemas.microsoft.com/office/infopath/2003/dataFormSolution" xmlns:my="http://schemas.microsoft.com/office/infopath/2003/myXSD/2005-10-25T23-50-04" xmlns:xd="http://schemas.microsoft.com/office/infopath/2003" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt" xmlns:x="urn:schemas-microsoft-com:office:excel" xmlns:xdExtension="http://schemas.microsoft.com/office/infopath/2003/xslt/extension" xmlns:xdXDocument="http://schemas.microsoft.com/office/infopath/2003/xslt/xDocument" xmlns:xdSolution="http://schemas.microsoft.com/office/infopath/2003/xslt/solution" xmlns:xdFormatting="http://schemas.microsoft.com/office/infopath/2003/xslt/formatting" xmlns:xdImage="http://schemas.microsoft.com/office/infopath/2003/xslt/xImage" xmlns:xdUtil="http://schemas.microsoft.com/office/infopath/2003/xslt/Util" xmlns:xdMath="http://schemas.microsoft.com/office/infopath/2003/xslt/Math" xmlns:xdDate="http://schemas.microsoft.com/office/infopath/2003/xslt/Date" xmlns:sig="http://www.w3.org/2000/09/xmldsig#" xmlns:xdSignatureProperties="http://schemas.microsoft.com/office/infopath/2003/SignatureProperties">
...
.langFont {
	FONT-FAMILY: Verdana
			...
			<body>
				...
				<div>Category: <select class="xdComboBox xdBehavior_Select" title="" style="WIDTH: 130px" size="1" xd:CtrlId="CTRL53" xd:xctname="DropDown" value="" xd:boundProp="value" xd:binding="my:SelectedCategory" tabIndex="0">
					...
					</select> <input class="langFont" title="" type="button" value="Get Products" xd:CtrlId="getProductsButton" xd:xctname="Button" tabIndex="0">
						<xsl:choose>
				...
				<div>
					<strong>
						<font style="FONT-SIZE: 13pt">
							<div class="xdSection xdScrollableRegion" title="" style="OVERFLOW-Y: auto; PADDING-LEFT: 1px; WIDTH: 693px; HEIGHT: 137px; BACKGROUND-COLOR: #fffbdf" align="left" xd:CtrlId="CTRL78_5" xd:xctname="ScrollableRegion">
								<div>
										...
										<tbody class="xdTableHeader">
											...
											<xsl:if test="function-available('xdXDocument:GetDOM')">
												<xsl:for-each select="xdXDocument:GetDOM(&quot;Products&quot;)/dfs:myFields/dfs:dataFields/d:Product">
													<tr>
														<td><span class="xdExpressionBox xdDataBindingUI" title="" tabIndex="-1" xd:CtrlId="CTRL73" xd:xctname="ExpressionBox" xd:disableEditing="yes" xd:datafmt="&quot;number&quot;,&quot;numDigits:0;negativeOrder:1;&quot;" style="WIDTH: 100%">
																<xsl:choose>
														...
														<td><span class="xdExpressionBox xdDataBindingUI" title="" tabIndex="-1" xd:CtrlId="CTRL74" xd:xctname="ExpressionBox" xd:disableEditing="yes" style="WIDTH: 100%">
																<xsl:value-of select="@Name"/>
															</span>
														</td>
														<td><span class="xdExpressionBox xdDataBindingUI" title="" tabIndex="-1" xd:CtrlId="CTRL75" xd:xctname="ExpressionBox" xd:disableEditing="yes" style="WIDTH: 100%">
																<xsl:value-of select="@ProductNumber"/>
															</span>
														</td>
														<td><span class="xdExpressionBox xdDataBindingUI" title="" tabIndex="-1" xd:CtrlId="CTRL76" xd:xctname="ExpressionBox" xd:disableEditing="yes" style="WIDTH: 100%">
																<xsl:value-of select="@Color"/>
															</span>
														</td>
														<td><span class="xdExpressionBox xdDataBindingUI xdBehavior_Formatting" title="" tabIndex="-1" xd:CtrlId="CTRL77" xd:xctname="ExpressionBox" xd:binding="@ListPrice" xd:disableEditing="yes" xd:datafmt="&quot;currency&quot;,&quot;numDigits:2;negativeOrder:0;positiveOrder:0;currencyLocale:1033;&quot;" style="WIDTH: 100%; WHITE-SPACE: normal; TEXT-ALIGN: right">
					...
					<table class="xdRepeatingTable msoUcTable" title="" style="TABLE-LAYOUT: fixed; WIDTH: 691px; BORDER-TOP-STYLE: none; BORDER-RIGHT-STYLE: none; BORDER-LEFT-STYLE: none; BORDER-COLLAPSE: collapse; WORD-WRAP: break-word; BORDER-BOTTOM-STYLE: none" border="1" xd:CtrlId="CTRL45">
						...
						<tbody class="xdTableHeader">
							...
							<xsl:for-each select="my:Product">
								<tr>
									<td>
										<div><span class="xdTextBox xdBehavior_Formatting" hideFocus="1" title="" contentEditable="true" tabIndex="0" xd:CtrlId="CTRL63" xd:xctname="PlainText" xd:boundProp="xd:num" xd:binding="my:ID" xd:datafmt="&quot;number&quot;,&quot;numDigits:0;negativeOrder:1;&quot;" style="WIDTH: 100%">
												<xsl:attribute name="xd:num">
									...
									<td><span class="xdExpressionBox xdDataBindingUI" title="" tabIndex="-1" xd:CtrlId="CTRL52" xd:xctname="ExpressionBox" xd:disableEditing="yes" style="WIDTH: 100%">
											<xsl:value-of select="my:Name"/>
										</span>
									</td>
									<td><span class="xdTextBox xdBehavior_Formatting" hideFocus="1" title="" contentEditable="true" tabIndex="0" xd:CtrlId="CTRL47" xd:xctname="PlainText" xd:boundProp="xd:num" xd:binding="my:Qty" xd:datafmt="&quot;number&quot;,&quot;numDigits:0;negativeOrder:1;&quot;" style="WIDTH: 100%">
											<xsl:attribute name="xd:num">
									...
									<td><span class="xdExpressionBox xdDataBindingUI xdBehavior_Formatting" title="" tabIndex="-1" xd:CtrlId="CTRL51" xd:xctname="ExpressionBox" xd:binding="my:UnitPrice" xd:disableEditing="yes" xd:datafmt="&quot;currency&quot;,&quot;numDigits:2;negativeOrder:0;positiveOrder:0;currencyLocale:1033;&quot;" style="WIDTH: 100%; WHITE-SPACE: normal; TEXT-ALIGN: right">
											<xsl:attribute name="xd:num">
									...
									<td><span class="xdExpressionBox xdDataBindingUI xdBehavior_Formatting" title="" tabIndex="-1" xd:CtrlId="CTRL50" xd:xctname="ExpressionBox" xd:binding="my:ExtPrice" xd:disableEditing="yes" xd:datafmt="&quot;currency&quot;,&quot;numDigits:2;negativeOrder:0;positiveOrder:0;currencyLocale:1033;&quot;" style="WIDTH: 100%; WHITE-SPACE: normal; TEXT-ALIGN: right">
											<xsl:attribute name="xd:num">
				...
				<div align="right">
					<table class="xdLayout" style="BORDER-RIGHT: medium none; TABLE-LAYOUT: fixed; BORDER-TOP: medium none; BORDER-LEFT: medium none; WIDTH: 690px; BORDER-BOTTOM: medium none; BORDER-COLLAPSE: collapse; WORD-WRAP: break-word" borderColor="buttontext" border="1">
						<colgroup>
							<col style="WIDTH: 112px"></col>
							<col style="WIDTH: 95px"></col>
							<col style="WIDTH: 483px"></col>
						</colgroup>
						<tbody vAlign="top">
							<tr style="MIN-HEIGHT: 19px">
								...
								<td>
									<div>
										<font face="Verdana"><span class="xdExpressionBox xdDataBindingUI xdBehavior_Formatting" title="" tabIndex="-1" xd:CtrlId="CTRL82" xd:xctname="ExpressionBox" xd:binding="my:SubTotal" xd:disableEditing="yes" xd:datafmt="&quot;currency&quot;,&quot;numDigits:2;negativeOrder:0;positiveOrder:0;currencyLocale:1033;&quot;" style="FONT-WEIGHT: normal; MARGIN-BOTTOM: 0pt; PADDING-BOTTOM: 0px; WIDTH: 100%; WHITE-SPACE: normal; TEXT-ALIGN: right">
												<xsl:attribute name="xd:num">
							...
							<tr>
								...
								<td>
									<div>
										<font face="Verdana"><span class="xdExpressionBox xdDataBindingUI xdBehavior_Formatting" title="" tabIndex="-1" xd:CtrlId="CTRL83" xd:xctname="ExpressionBox" xd:binding="my:Tax" xd:disableEditing="yes" xd:datafmt="&quot;currency&quot;,&quot;numDigits:2;negativeOrder:0;positiveOrder:0;currencyLocale:1033;&quot;" style="FONT-WEIGHT: normal; MARGIN-BOTTOM: 0pt; PADDING-BOTTOM: 0px; WIDTH: 100%; WHITE-SPACE: normal; TEXT-ALIGN: right">
												<xsl:attribute name="xd:num">
							...
							<tr>
								...
								<td>
									<div>
										<font face="Verdana"><span class="xdExpressionBox xdDataBindingUI xdBehavior_Formatting" title="" tabIndex="-1" xd:CtrlId="CTRL84" xd:xctname="ExpressionBox" xd:binding="my:Total" xd:disableEditing="yes" xd:datafmt="&quot;currency&quot;,&quot;numDigits:2;negativeOrder:0;positiveOrder:0;currencyLocale:1033;&quot;" style="FONT-WEIGHT: normal; MARGIN-BOTTOM: 0pt; PADDING-BOTTOM: 0px; WIDTH: 100%; WHITE-SPACE: normal; TEXT-ALIGN: right">
												<xsl:attribute name="xd:num">
