...
Partial Public NotInheritable Class Sheet1
    ...
    Friend WithEvents salaryNamedRange As Microsoft.Office.Tools.Excel.NamedRange

    Friend WithEvents debtNamedRange As Microsoft.Office.Tools.Excel.NamedRange

    Friend WithEvents riskNamedRange As Microsoft.Office.Tools.Excel.NamedRange
    ...
    Public Overrides Sub OnShutdown() Implements Microsoft.VisualStudio.Tools.Applications.Runtime.IStartup.OnShutdown
        Me.riskNamedRange.Dispose()
        Me.debtNamedRange.Dispose()
        Me.salaryNamedRange.Dispose()
        MyBase.OnShutdown()
    End Sub
    ...
    Private Sub BeginInitialization()
        Me.BeginInit()
        Me.salaryNamedRange.BeginInit()
        Me.debtNamedRange.BeginInit()
        Me.riskNamedRange.BeginInit()
    End Sub
    ...
    Private Sub EndInitialization()
        Me.riskNamedRange.EndInit()
        Me.debtNamedRange.EndInit()
        Me.salaryNamedRange.EndInit()
        Me.EndInit()
    End Sub
    ...
    Private Sub InitializeControls()
        Me.salaryNamedRange = New Microsoft.Office.Tools.Excel.NamedRange(Me.HostItemHost, Me.RuntimeCallback, "salaryNamedRange", Me, "salaryNamedRange")
        Me.debtNamedRange = New Microsoft.Office.Tools.Excel.NamedRange(Me.HostItemHost, Me.RuntimeCallback, "debtNamedRange", Me, "debtNamedRange")
        Me.riskNamedRange = New Microsoft.Office.Tools.Excel.NamedRange(Me.HostItemHost, Me.RuntimeCallback, "riskNamedRange", Me, "riskNamedRange")
    End Sub
    ...
    Private Sub InitializeComponents()
        CType(Me.salaryNamedRange, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.debtNamedRange, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.riskNamedRange, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        'Sheet1
        '
        CType(Me.salaryNamedRange, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.debtNamedRange, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.riskNamedRange, System.ComponentModel.ISupportInitialize).EndInit()
