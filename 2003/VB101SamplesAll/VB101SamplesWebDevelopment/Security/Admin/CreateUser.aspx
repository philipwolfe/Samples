<%@ Page Language="VB" MasterPageFile="~/SiteMaster.master" CodeFile="CreateUser.aspx.vb" Inherits="CreateUser_aspx" Title="Create User" %>
...
<table border="0" cellpadding="2" cellspacing="3" width="95%" style="border-right: navy 2px solid; border-top: navy 2px solid; border-left: navy 2px solid; border-bottom: navy 2px solid"><tr>
    </tr>
    <tr>
        <td align="left" width="150px">User Name:</td>
        <td align="left">
