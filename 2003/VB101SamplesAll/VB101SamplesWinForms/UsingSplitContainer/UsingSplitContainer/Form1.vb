Public Class Form1
    ...
    Public Sub New()
        ...
        HorizontalSplitContainer.Panel1.BackgroundImage = My.Resources.graybackground
    ...
    Private Sub SalesTreeView_AfterSelect(ByVal sender As Object, ByVal e As TreeViewEventArgs) Handles SalesTreeView.AfterSelect
