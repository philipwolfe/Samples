...
{
	/// <summary>
	/// The AgentLogoffAction sets an agent as no longer logged in.<br/>
	/// Available since Asterisk 1.2
	/// </summary>
	public class AgentLogoffAction : AbstractManagerAction
	{
		...
		/// </returns>
		/// <summary> Sets whether existing calls should be hung up or not.<br/>
		/// Default is to hangup existing calls on logoff.
		/// </summary>
		/// <param name="soft">
