...
namespace Asterisk.NET.Manager.Event
{
	...
	{
		/// <summary> Returns the name of the queue.</summary>
		/// <summary> Sets the name of the queue.</summary>
		...
		virtual public int ServiceLevel
		{
		...
		/// calls.
		/// </summary>
		virtual public Double ServiceLevelPerf
		{
