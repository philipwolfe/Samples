namespace Asterisk.NET.Manager
{
	...
	public class EventTimeoutException:TimeoutException
	{
		...
		/// </returns>
		virtual public IResponseEvents PartialResult
		{
			get { return partialResult; }
		}
		private IResponseEvents partialResult;
		...
		/// </param>
		public EventTimeoutException(string message, IResponseEvents partialResult): base(message)
		{
