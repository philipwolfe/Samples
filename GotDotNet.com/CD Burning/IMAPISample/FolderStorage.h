...
class CFolderStorage :
	public IStorage, public IEnumSTATSTG
{
	CFoldersAndFiles* m_pFolders;
	LONG m_nRefCount;
public:
	CFolderStorage( CFoldersAndFiles* pFolders );
	~CFolderStorage(void);
...
virtual /* [local] */ HRESULT STDMETHODCALLTYPE EnumElements( 
	...
	virtual HRESULT STDMETHODCALLTYPE Next( ULONG celt, STATSTG *rgelt, ULONG *pceltFetched );
