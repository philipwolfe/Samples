...
Public Class ds
    ...
    Private Sub InitClass()
        ...
        Me.Locale = New System.Globalization.CultureInfo("tr-TR")
    ...
    Public Class OrdersDataTable
        ...
        Private columnboo As DataColumn
        
        Private columnShipName As DataColumn
        
        Private columnIntCol As DataColumn
        ...
        Friend ReadOnly Property booColumn As DataColumn
            Get
                Return Me.columnboo
            End Get
        End Property
        ...
        Friend ReadOnly Property IntColColumn As DataColumn
            Get
                Return Me.columnIntCol
            End Get
        End Property
        ...
        Public Overloads Function AddOrdersRow(ByVal CustomerID As String, ByVal OrderDate As Date, ByVal boo As Boolean, ByVal ShipName As String, ByVal IntCol As Integer) As OrdersRow
            Dim rowOrdersRow As OrdersRow = CType(Me.NewRow,OrdersRow)
            rowOrdersRow.ItemArray = New Object() {Nothing, CustomerID, OrderDate, boo, ShipName, IntCol}
        ...
        Friend Sub InitVars()
            ...
            Me.columnboo = Me.Columns("boo")
            Me.columnShipName = Me.Columns("ShipName")
            Me.columnIntCol = Me.Columns("IntCol")
        End Sub
        ...
        Private Sub InitClass()
            ...
            Me.columnboo = New DataColumn("boo", GetType(System.Boolean), Nothing, System.Data.MappingType.Element)
            Me.Columns.Add(Me.columnboo)
            ...
            Me.columnIntCol = New DataColumn("IntCol", GetType(System.Int32), Nothing, System.Data.MappingType.Element)
            Me.Columns.Add(Me.columnIntCol)
    ...
    Public Class OrdersRow
        ...
        Public Property boo As Boolean
            Get
                Try 
                    Return CType(Me(Me.tableOrders.booColumn),Boolean)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableOrders.booColumn) = value
            End Set
        End Property
        ...
        Public Property IntCol As Integer
            Get
                Try 
                    Return CType(Me(Me.tableOrders.IntColColumn),Integer)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableOrders.IntColColumn) = value
            End Set
        End Property
        ...
        Public Function IsbooNull() As Boolean
            Return Me.IsNull(Me.tableOrders.booColumn)
        End Function
        
        Public Sub SetbooNull()
            Me(Me.tableOrders.booColumn) = System.Convert.DBNull
        End Sub
        ...
        Public Function IsIntColNull() As Boolean
            Return Me.IsNull(Me.tableOrders.IntColColumn)
        End Function
        
        Public Sub SetIntColNull()
            Me(Me.tableOrders.IntColColumn) = System.Convert.DBNull
        End Sub
    End Class
