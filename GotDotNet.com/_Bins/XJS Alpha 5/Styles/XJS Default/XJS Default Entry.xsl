...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
 ...
 <table id="top" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td class="center"><xsl:value-of select="XJE/Info/Name"/><br/>
		<div class="smalltxt"><xsl:value-of select="XJE/Info/Description"/></div></td>
	</tr>
</table>
<table id="main" cellpadding="0" cellspacing="0">
	<tr>
		<td class="sidebar" valign="top">
		<div class="center"><img src="..\Images\logo.jpg"/></div>
 <xsl:for-each select="XJE/XEL">
 <xsl:for-each select="Index">
    <font size="-1"><b>Main:</b></font><br/><a href="..\{Link}"><xsl:value-of select="Name"/></a><br/>
    </xsl:for-each>
...
<td id="content" valign="top">
   ...
   <div class="mdy"><img alt="Day" src="../Images/Day.jpg"/><br/><xsl:value-of select="DateTime"/></div>
