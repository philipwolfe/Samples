...
namespace SpaceWar
{
	...
	public class Constants
	{
		...
		public const int NetworkBufferSize = 512;
		public const int RotateSteps = 60;				// number of steps to rotate ship.

		//public const int NumSteps = 60;
		...
		public const int ScoreOffest = 100;		// offset of score from name...
		...
		public const int StarColorFull = 0xFF0000;
		public const int StarColorDim  = 0x330000;
