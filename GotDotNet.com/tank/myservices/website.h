...
template <typename TParentClass>  class CWebSite :
	public CBaseElement<CWebSite>
{
public:
	CCat<CWebSite>	cat;
	CString			url;
	...
	void 
	SetFrom(CWebSite<TParentClass> *from)
	{
	...
	void 
	OnDoneChain(CCat<CWebSite> *const c)
	{
		cat.SetFrom(c);
	}
	...
	BEGIN_XMLTAG_MAP(CSpecialDate)		
		XMLTAG_CLASS("cat",			CCat<CWebSite>)
	...
	BEGIN_REPLACEMENT_METHOD_MAP(CWebSite)		
