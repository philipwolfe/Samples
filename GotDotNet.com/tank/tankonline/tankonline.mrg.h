...
//
// d:\sourcedepot\vcqalibs\test sources\work in progress\hps\hailstorm\pdc\tankonline\tankonline.mrg.h
...
BEGIN_ATTR_REPLACEMENT_METHOD_MAP(CTankOnlineHandler)
REPLACEMENT_METHOD_ENTRY("GetUserName", OnGetUserName)
REPLACEMENT_METHOD_ENTRY("GetServer", OnGetServer)
REPLACEMENT_METHOD_ENTRY("GetPUID", OnGetPUID)
REPLACEMENT_METHOD_ENTRY("HasMyServicesInfo", OnGetMyServicesInfo)
END_ATTR_REPLACEMENT_METHOD_MAP()
	//--- End Injected Code For Attribute 'tag_name'
};

//+++ Start Injected Code For Attribute 'request_handler'
#injected_line 19 "d:\\sourcedepot\\vcqalibs\\test sources\\work in progress\\hps\\hailstorm\\pdc\\tankonline\\tankonline.h"

				
DECLARE_REQUEST_HANDLER("Default", CTankOnlineHandler, ::CTankOnlineHandler)
