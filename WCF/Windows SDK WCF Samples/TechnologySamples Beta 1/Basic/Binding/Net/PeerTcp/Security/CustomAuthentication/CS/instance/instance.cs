...
namespace Microsoft.ServiceModel.Samples
{
    ...
    public class ChatApp : IChat
    {
        ...
        public static void Main()
        {
            ...
            X509Certificate2 issuer = GetCertificate(StoreName.CertificateAuthority, StoreLocation.CurrentUser, "CN=" + issuerName, X509FindType.FindBySubjectDistinguishedName);
