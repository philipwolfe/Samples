...
namespace Microsoft.Samples.Channels.ChunkingChannel
{
    public class ChunkingDuplexSessionChannel : ChannelBase, IDuplexSessionChannel
    {
            ...
            int maxBufferedChunks)
        {
            ...
            this.trace = new TraceSourceHelper(ChunkingUtils.ChunkingTraceSource);
        ...
        {
            trace.TraceMethod(System.Diagnostics.TraceEventType.Information, "ChunkingDuplexSessionChannel.OnOpen");
            innerChannel.Open(timeout);
            //we don't call base.OnOpen because it does nothing
        }
        ...
        {
            trace.TraceMethod(System.Diagnostics.TraceEventType.Information, "ChunkingDuplexSessionChannel.ReceiveChunkLoop");
            ...
            do
            {
                ...
                trace.WriteTraceData(System.Diagnostics.TraceEventType.Information, 0, "Information", "", "Calling innerChannel.Receive", null, "ChunkingDuplexSessionChannel.ReceiveChunkLoop", null);
        ...
        {
            trace.TraceMethod(System.Diagnostics.TraceEventType.Information, "ChunkingDuplexSessionChannel.Receive");
            ...
            trace.WriteTraceData(System.Diagnostics.TraceEventType.Information, 0, "Information", "", "Calling innerChannel.Receive", null, "ChunkingDuplexSessionChannel.Receive", null);
        ...
        {
            trace.TraceMethod(System.Diagnostics.TraceEventType.Information, "ChunkingDuplexSessionChannel.Send");
            ThrowIfDisposedOrNotOpen();
            ...
            lock (base.ThisLock) // synchronized state transitions are not allowed while sending
            {
                ...
                {
                    //passthrough
                    trace.WriteTraceData(System.Diagnostics.TraceEventType.Information, 0, "Information", "", "Calling innerChannel.Send", null, "ChunkingDuplexSessionChannel.Send", null);
