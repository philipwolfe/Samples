    ...
    internal class ChunkingReader : XmlDictionaryReader
    {
        ...
        private void GetReaderFromNextChunk(TimeoutHelper timeouthelper)
        {
            ...
            if(this.bufferedChunks.TryDequeue(timeouthelper,out chunk))
            {
                ...
                trace.WriteTraceData(System.Diagnostics.TraceEventType.Information, 0, "", "", String.Format(" < Received chunk {0} of message {1}", chunkNum, this.messageId), "ChunkingReader", "GetReaderFromNextChunk", null);
