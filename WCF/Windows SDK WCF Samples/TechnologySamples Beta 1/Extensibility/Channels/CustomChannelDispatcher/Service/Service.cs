...
namespace Microsoft.ServiceModel.Samples
{
    public class CustomServiceHostBase : ServiceHostBase
    {
        ...
        protected override void InitializeRuntime()
        {
            ...
            serviceManager.MessageVersion = basicHttpBinding.MessageVersion;
    ...
    class MyServiceManager
    {
        ...
        {
            Message message = new HtmlMessage(new BasicHttpBinding().MessageVersion,
            // Message message = new HtmlMessage(,
                context.RequestMessage.Headers.To.ToString(),
                HelloWorldService.ServiceName,
                HelloWorldService.OperationName);
