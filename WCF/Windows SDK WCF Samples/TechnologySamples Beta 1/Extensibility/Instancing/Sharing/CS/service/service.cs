...
namespace Microsoft.ServiceModel.Samples
{
    ...
    public class CalculatorService : ICalculatorInstance
    {
        ...
        {
            AddressableInstanceContextExtension extension = OperationContext.Current.InstanceContext.Extensions.Find<AddressableInstanceContextExtension>();
            return (extension != null) ? extension.InstanceId : null;
        }
    }
