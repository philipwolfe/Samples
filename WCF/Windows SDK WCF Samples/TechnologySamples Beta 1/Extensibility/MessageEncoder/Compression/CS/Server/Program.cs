...
namespace Microsoft.Samples.Indigo.Server
{
	...
	static class Program
	{
		static void Main()
		{
            ...
            Uri baseHttpAddress = new Uri(ConfigurationManager.AppSettings["baseHttpAddress"]);

			using (ServiceHost sampleServer = new ServiceHost(typeof(SampleServer), baseHttpAddress))
			{
				sampleServer.Open();
