...
namespace Microsoft.ServiceModel.Samples
{
    ...
    class Client
    {
        ...
        private static void CallEndpoint ( string endpointName )
        {
            ...
            using (CalculatorProxy proxy = new CalculatorProxy(endpointName))
            {
                // Create new credentials class
                SamlClientCredentials samlCC = new SamlClientCredentials();

                // Set the client certificate. This is the cert that will be used to sign the SAML token in the symmetric proof key case
                samlCC.ClientCertificate.SetCertificate(StoreLocation.CurrentUser, StoreName.TrustedPeople, X509FindType.FindBySubjectName, "Alice");
                ...
                proxy.ChannelFactory.Endpoint.Behaviors.Add(samlCC);
