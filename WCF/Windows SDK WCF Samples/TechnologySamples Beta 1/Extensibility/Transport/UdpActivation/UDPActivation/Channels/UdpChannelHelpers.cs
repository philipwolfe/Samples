...
namespace Microsoft.ServiceModel.Samples.Channels
{
    ...
    static class UdpConstants
    {
        ...
        internal const string UdpProtocolId = "net.udp.v1";
        internal const string UriSchemeNetUdp = "net.udp";
    ...
    static class UdpPolicyStrings
    {
        ...
        public const string TransportAssertion = UdpConstants.UriSchemeNetUdp;
    }
