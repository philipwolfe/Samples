...
namespace Microsoft.ServiceModel.Samples.Channels
{
    ...
    class UdpOutputChannel : ChannelBase, IOutputChannel
    {
            ...
            : base(factory)
        {
            ...
            if (!string.Equals(via.Scheme, factory.Scheme, StringComparison.InvariantCultureIgnoreCase))
            {
            ...
            #region ADDRESSING_host_resolution
        ...
        #region Socket_Setup
        /// <summary>
        /// Open the channel for use. This creates a new UDP socket to use for sends.
        /// </summary>
...
#if LATER // multicast interface sockopt
