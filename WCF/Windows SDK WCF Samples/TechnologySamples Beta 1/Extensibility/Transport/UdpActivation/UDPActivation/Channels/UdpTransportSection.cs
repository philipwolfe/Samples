...
namespace Microsoft.ServiceModel.Samples.Channels
{
    ...
    /// </summary>
    public class UdpTransportSection : BindingElementExtensionSection
    {
        public UdpTransportSection()
        {
        }
        ...
        public override void CopyFrom(ServiceModelExtensionSection from)
        {
            base.CopyFrom(from);

            UdpTransportSection source = (UdpTransportSection)from;
