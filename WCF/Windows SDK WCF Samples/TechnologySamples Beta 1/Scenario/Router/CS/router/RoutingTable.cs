...
namespace Microsoft.ServiceModel.Samples
{
    ...
    public class RoutingTable
    {
        ...
        public RoutingTable()
        {
            ...
            foreach (Namespace ns in routingTableData.NamespacesSection.Namespaces)
            {
    ...
    public class RoutingTableData
    {
        ...
        NamespacesSection namespaces = new NamespacesSection();
        ...
        [XmlElement("namespaces", Type = typeof(NamespacesSection))]
        public NamespacesSection NamespacesSection
        {
    ...
    public class NamespacesSection
    {
        ...
        [XmlElement("namespace", Type = typeof(Namespace))]
