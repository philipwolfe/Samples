...
Namespace Microsoft.ServiceModel.Samples
    ...
    Public Class RoutingTable
        ...
        Public Sub New()
            ...
            For Each ns As [Namespace] In routingTableData.NamespacesSection.Namespaces
    ...
    Public Class RoutingTableData
        ...
        Private namespaces As New NamespacesSection()
        ...
        <XmlElement("namespaces", Type:=GetType(NamespacesSection))> _
        Public Property NamespacesSection() As NamespacesSection
            ...
            End Get
            Set(ByVal value As NamespacesSection)
    ...
    <XmlType([Namespace]:="http://Microsoft.ServiceModel.Samples/Router")> _
    Public Class NamespacesSection

        Private m_namespaces As New List(Of [Namespace])()

        Public Sub New()

        End Sub

        <XmlElement("namespace", Type:=GetType([Namespace]))> _
        Public Property Namespaces() As List(Of [Namespace])
            ...
            End Get
            Set(ByVal value As List(Of [Namespace]))
