...
namespace Microsoft.ServiceModel.Samples
{
    ...
    public class CalcResult
    {
        ...
        // The constructor is not reconstituted on the client-side
        // in the proxy, but it is useful on the service-side.
    ...
    // Service class thatimplements the service contract.
