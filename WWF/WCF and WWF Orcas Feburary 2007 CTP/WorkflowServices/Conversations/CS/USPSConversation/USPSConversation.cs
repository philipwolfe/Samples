...
{
	public sealed partial class USPSConversation: SequentialWorkflowActivity
	{
		public USPSConversation()
		{
			InitializeComponent();
		}
        ...
        public String USPSAck = default(System.String);

        private void codeActivity1_ExecuteCode(object sender, EventArgs e)
        {
            Console.WriteLine("=============================================");
            Console.WriteLine("Received Logistics Quote Request");
            this.USPSAck = "Working On the Quote";
