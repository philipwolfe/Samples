...
namespace Microsoft.WorkflowServices.Samples
{
	public partial class ServiceWorkflow: StateMachineWorkflowActivity
	{
        ...
        {   // apply ReturnAddress to ReverseEndpoint
            ...
            DebugOutput("[ServiceWorkflow:ApplyReturnAddress] " + epr.Headers[0].GetValue<string>());
        }
        ...
        private void CheckPendingItem(object sender, ConditionalEventArgs e)
        {
            if (this.CompletedWorkItems.Count > 0)
            {
                e.Result = true;
            }
            else
