...
namespace Microsoft.Samples.Discovery
{
    ...
    class OnFindAsyncResult : CompletedAsyncResult
    {
        Collection<EndpointDiscoveryMetadata> matchingEndpoints;

        public OnFindAsyncResult(Collection<EndpointDiscoveryMetadata> matchingEndpoints, AsyncCallback callback, object state)
            : base(callback, state)
        {
        ...
        {
            OnFindAsyncResult thisPtr = AsyncResult.End<OnFindAsyncResult>(result);
            return thisPtr.matchingEndpoints;
        }
    }

    class OnResolveAsyncResult : CompletedAsyncResult
    {
