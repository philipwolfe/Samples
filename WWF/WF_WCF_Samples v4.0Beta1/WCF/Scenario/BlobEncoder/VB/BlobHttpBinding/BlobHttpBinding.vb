...
Namespace Microsoft.Samples.BlobMessageEncoder
	...
	Public Class BlobHttpBinding
        Inherits Binding

		Private httpTransport As HttpTransportBindingElement
		Private blobEncoding As BlobMessageEncodingBindingElement

		Public Sub New()
			Me.httpTransport = New HttpTransportBindingElement()
			Me.blobEncoding = New BlobMessageEncodingBindingElement()
        End Sub
		...
		Private Sub ApplyConfiguration(ByVal configurationName As String)
			...
			Dim section As BlobHttpBindingCollectionElement = CType(bindings("blobHttpBinding"), BlobHttpBindingCollectionElement)
			Dim element As BlobHttpBindingElement = section.Bindings(configurationName)
		...
		Public Overrides Function CreateBindingElements() As BindingElementCollection
			...
			bindingElements.Add(Me.blobEncoding)
