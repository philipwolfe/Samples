...
Namespace Microsoft.Samples.Compensation.CompensableActivitySample
	...
	Friend Class Program
		...
		Private Shared Function BuildASequenceofCompensableActions() As WorkflowElement
		...
		Private Shared Function BuildASequenceofCompensableActionsThatThrows() As WorkflowElement
            Dim s As New Sequence
            ...
            s.Activities.Add(New [Throw] With {.Exception = New ApplicationException(" Something unexpected happened")})
        ...
        Private Shared Function HandleException(ByVal e As WorkflowUnhandledExceptionEventArgs) As UnhandledExceptionAction
