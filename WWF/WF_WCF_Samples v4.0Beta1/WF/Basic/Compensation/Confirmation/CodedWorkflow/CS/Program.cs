...
namespace Microsoft.Sample.Compensation.ConfirmationSample
{
    using System;
    ...
    class Program
    {
        ...
        static WorkflowElement ConfirmACompensableActivity()
        {
        ...
        static WorkflowElement CompensateACompensableActivity()
        {
            Variable<CompensationToken> token = new Variable<CompensationToken>();
        ...
        static WorkflowElement SpecifyCustomOrderInCompensationHandler()
        {
            ...
            return new CompensableActivity()
            {
                ...
                //The default confirmation order would be reverse of successful execution. Notice in this case I can explicitly change the order
                ConfirmationHandler = new Sequence()
                {
                    Activities =
                    {
                        ...
                        //Even though I don't specify CA3 it will still be confirmed. All CompensableActivities which are not compensated or confirmed will be confirmed in the default order
                    },
                },
            };
        }
        ...
        static WorkflowElement VariableAccessVignette()
        {
                    ...
                    new CompensableActivity()
                    {
                        ...
                        ConfirmationHandler = new Sequence
                        {
                            Activities = 
                            {
                                ...
                                new WriteLine() { Text = new InArgument<string>(new VisualBasicValue<string> { ExpressionText = "\"CompensableActivity2: The sum is: \" + mySum.toString()" }) },

                                new Subtract<int, int, int> { Left = mySum, Right = 12, Result = mySum},

                                new WriteLine() { Text = new InArgument<string>(new VisualBasicValue<string> { ExpressionText = "\"CompensableActivity2: After subtracting 12 the sum is now: \" + mySum.toString()" }) },
                            },
                        },
                    },
