...
Namespace Microsoft.Samples.Compensation.CustomCompensation
    ...
    Friend Class Program
        ...
        Private Shared Function TruckRentalAgency() As WorkflowElement
            ...
            Dim truckRentalRate As Variable(Of Integer) = New Variable(Of Integer) With {.Default = ValueExpression.CreateLiteral(500)}
            ...
            truckSeq.Activities.Add(New WriteLine With {.Text = New InArgument(Of String)(ValueExpression.Create(Function(env) ("Charge truck rental cost on customer credit card: $" & truckRentalRate.Get(env).ToString())))})

            truckComp.Body = truckSeq
            truckComp.CompensationHandler = New WriteLine With {.Text = New InArgument(Of String)(ValueExpression.Create(Function(env) ("Refund truck rental cost on customer credit card: $" & truckRentalRate.Get(env).ToString())))}
            ...
            customComp.Activities.Add(New [If] With _
                                      { _
                                        .Condition = ValueExpression.CreateLiteral(True), _
            ...
            mainParallel.CompletionCondition = ValueExpression.CreateLiteral(True)
        ...
        Shared Sub Main()
            ...
            instance = New WorkflowInstance(TruckRentalAgency())
            Dim resetEvent As New System.Threading.ManualResetEvent(False)
            instance.OnCompleted = Function(e As WorkflowCompletedEventArgs) resetEvent.Set()
            instance.Run()
            resetEvent.WaitOne()
