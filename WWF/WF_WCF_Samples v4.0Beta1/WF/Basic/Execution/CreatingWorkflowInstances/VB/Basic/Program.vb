...
Namespace Microsoft.Samples.WF.WorkflowInstances
    Friend Class Program
        ...
        Private Shared Function BuildTestWorkflow() As WorkflowElement
        ...
        Shared Sub Main()
            ...
            Dim activity As WorkflowElement = BuildTestWorkflow()
            WorkflowInvoker.Invoke(activity)

            ' This is how you run a workflow instance asynchronously,
            ' and can receive an event when it completes
            Dim instance As WorkflowInstance = New WorkflowInstance(BuildTestWorkflow())

            instance.OnCompleted = AddressOf HandleCompleted
        ...
        Private Shared Function HandleCompleted(ByVal e As WorkflowCompletedEventArgs) As UnhandledExceptionAction
            resetEvent.Set()
