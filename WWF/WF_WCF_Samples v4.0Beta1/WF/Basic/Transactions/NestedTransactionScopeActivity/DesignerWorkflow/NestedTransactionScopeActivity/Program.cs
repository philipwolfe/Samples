...
namespace Microsoft.Sample.Transaction.NestedTransactionScopeActivitySample
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            new WorkflowInvoker(new ScenarioOne()).Invoke();
            ...
            instance = new WorkflowInstance(new ScenarioTwo());
            ...
            instance = new WorkflowInstance(new ScenarioThree());
            instance.OnAborted = Program.OnAborted;
            instance.OnCompleted = Program.OnCompleted;
            instance.OnUnhandledException = Program.OnUnhandledException;
            syncEvent.Reset();
            ...
            instance = new WorkflowInstance(new ScenarioFour());
            instance.OnAborted = Program.OnAborted;
            instance.OnCompleted = Program.OnCompleted;
            instance.OnUnhandledException = Program.OnUnhandledException;
            syncEvent.Reset();
