...
namespace Microsoft.Samples.RegexActivities
{
    ...
    class Program
    {
        ...
        {            
            ...
            IDictionary<string, object> isMatchResult = WorkflowInvoker.Invoke(
                    new IsMatch
                    {
                        Pattern = new InArgument<string>(pattern),
                        Input = "20.00",
                    });
            Console.WriteLine("        Result: {0}", isMatchResult["Result"].ToString());
        ...
        static void MatchesSampleUse()
        {
            // Matches sample
            Console.WriteLine("\r\nTesting Matches");            
            IDictionary<string, object> matchesResults = WorkflowInvoker.Invoke(
                new Matches
                    {
            ...
            MatchCollection matches = (MatchCollection)matchesResults["Result"];
        ...
        static void ReplaceSampleUse()
        {
            ...
            IDictionary<string, object> replaceTest = WorkflowInvoker.Invoke(
                new Replace
                {
                    Pattern = @"\bWorld\b",
            ...
            Console.WriteLine("   Result: {0}", replaceTest["Result"].ToString());
